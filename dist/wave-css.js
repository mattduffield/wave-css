...
if (!customElements.get("wc-article-skeleton")) {
  class WcArticleSkeleton extends WcBaseComponent {
    ...
    _createElement() {
      ...
      this.componentElement.className = "wc-article-skeleton max-w-full m-4 border border-solid text-bg-color-3 p-4 space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center";
      this.componentElement.innerHTML = `
        <div class="flex items-center justify-center w-full h-48 text-bg-color-3 rounded-md sm:w-96">
        ...
        <div class="w-full">
          <div class="h-2.5 text-bg-color-3 rounded-full w-48 mb-4"></div>
          <div class="h-2 text-bg-color-3 rounded-full max-w-[480px] mb-2.5"></div>
          <div class="h-2 text-bg-color-3 rounded-full mb-2.5"></div>
          <div class="h-2 text-bg-color-3 rounded-full max-w-[440px] mb-2.5"></div>
          <div class="h-2 text-bg-color-3 rounded-full max-w-[460px] mb-2.5"></div>
          <div class="h-2 text-bg-color-3 rounded-full max-w-[360px]"></div>
        </div>
...
if (!customElements.get("wc-card-skeleton")) {
  class WcCardSkeleton extends WcBaseComponent {
    ...
    _createElement() {
      ...
      this.componentElement.setAttribute("role", "status");
      this.componentElement.className = "wc-card-skeleton max-w-full m-4 p-4 border border-solid rounded-md shadow animate-pulse md:p-6";
      this.componentElement.innerHTML = `
        <div class="flex items-center justify-center h-48 mb-4 text-bg-color-3 rounded-md">
        ...
        <div class="h-2 text-bg-color-3 rounded-full mb-2.5"></div>
        <div class="h-2 text-bg-color-3 rounded-full mb-2.5"></div>
        <div class="h-2 text-bg-color-3 rounded-full"></div>
        <div class="flex items-center mt-4">
          <svg class="text-color-2 w-10 h-10 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div>
                <div class="h-2.5 text-bg-color-3 rounded-full w-32 mb-2"></div>
                <div class="w-48 h-2 text-bg-color-3 rounded-full"></div>
            </div>
        </div>
        <span class="sr-only">Loading...</span>
      `.trim();
