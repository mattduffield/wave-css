function De(a){return a.tagName.includes("-")}function Ae(){return"xxxx-xxxx-xxxx-xxxx".replace(/[x]/g,()=>(Math.random()*16|0).toString(16))}function k(a){return new Promise((n,e)=>{if(document.querySelector(`link[rel="stylesheet"][href="${a}"]`)){n();return}let t=document.createElement("link");t.rel="stylesheet",t.href=a,t.onload=()=>n(),t.onerror=i=>e(i),document.head.appendChild(t);let o=setInterval(()=>{getComputedStyle(document.body).getPropertyValue("display")&&(clearInterval(o),n())},50)})}function S(a){return new Promise((n,e)=>{if(document.querySelector(`script[src="${a}"]`)){n();return}let t=document.createElement("script");t.src=a,t.onload=n,t.onerror=e,document.head.appendChild(t)})}function _(a,n){return new Promise((e,t)=>{if(document.querySelector(`script[src="${a}"]`)){if(n&&window[n])e();else{let i=setInterval(()=>{window[n]&&(clearInterval(i),e())},50)}return}let o=document.createElement("script");o.src=a,o.onload=()=>{if(n&&!window[n]){let i=setInterval(()=>{window[n]&&(clearInterval(i),e())},50)}else e()},o.onerror=i=>{t(i)},document.head.appendChild(o)})}function A(a,n){return new Promise((e,t)=>{if(document.querySelector(`style#${a}`)){e();return}let o=document.createElement("style");o.id=a,o.textContent=n.trim(),o.onload=e,o.onerror=t,document.head.appendChild(o)})}function He(a){return new Promise((n,e)=>{if(document.querySelector(`link[href="${a}"]`)){n();return}let t=document.createElement("link");t.rel="stylesheet",t.href=a,t.onload=n,t.onerror=e,document.head.appendChild(t)})}function We(a,n){if(a.matches&&a.matches(n))return a;let e=a.querySelector(n);if(e)return e;let t=a.querySelectorAll("*");for(let o of t)if(o.shadowRoot){let i=this.locator(o.shadowRoot,n);if(i)return i}}function je(a,n){let e=[];a.matches&&a.matches(n)&&e.push(a),e.push(...a.querySelectorAll(n));let t=a.querySelectorAll("*");for(let o of t)o.shadowRoot&&e.push(...this.locatorAll(o.shadowRoot,n));return e}function Pe(a,n=3e3,e=100){return new Promise((t,o)=>{let i=Date.now(),s=()=>{let r=document.querySelector(a);r&&r.offsetParent!==null?t(r):Date.now()-i>n?o(new Error(`Timeout: Selector "${a}" not found or not visible after ${n}ms`)):setTimeout(s,e)};s()})}function Oe(a,n){let e=!1;return e=wc.linksLoaded[a]&&wc.scriptsLoaded[n],e}function $e(a=[],n=[],e=5e3,t=100){return new Promise((o,i)=>{let s=Date.now(),r=Array.isArray(a)?a:[a],l=Array.isArray(n)?n:[n],c=()=>{let d=r.length===0||r.every(m=>window.wc?.scriptsLoaded?.[m]===!0),u=l.length===0||l.every(m=>window.wc?.linksLoaded?.[m]===!0);d&&u?o():Date.now()-s>e?i(new Error(`Timeout: Dependencies not available after ${e}ms. Scripts: ${JSON.stringify(r)}, Links: ${JSON.stringify(l)}`)):setTimeout(c,t)};c()})}function Le(a=[],n=3e3){return new Promise((e,t)=>{let o=Date.now(),i=Array.isArray(a)?a:[a],s=()=>{i.every(l=>document.querySelector(l)!==null)?e():Date.now()-o>n?t(new Error(`Timeout: Not all selectors available after ${n}ms. Missing selectors: ${JSON.stringify(i)}`)):requestAnimationFrame(s)};s()})}function Re(a,n,e=3e3){return new Promise((t,o)=>{let i=Date.now(),s=()=>{a[n]?t():Date.now()-i>e?o(new Error(`Timeout: ${e}ms. Propery: ${n} not available on element.`)):requestAnimationFrame(s)};s()})}async function P(a){return new Promise(n=>setTimeout(n,a))}function Te(a){document.querySelector(a).classList.add("hidden")}function Ie(a){document.querySelector(a).classList.remove("hidden")}function qe(a,n){Te(a),Ie(n)}async function ze(a,n,e=3e3,t=500){await Le([a,n],e),await P(t),qe(a,n)}function Fe(a,n,e){try{fetch(a,{method:"GET"}).then(t=>t.text()).then(t=>{n&&n(t)})}catch(t){e&&e(t)}}function Ne(a){if(a){let n={animation:150,draggable:".preview-draggable",onEnd:function(e){let t={e,event:"onEnd",item:e.item,from:e.from,to:e.to,oldIndex:e.oldIndex,newIndex:e.newIndex};wc?.EventHub?.broadcast("sortable:on-end","","",t)}};if(typeof Sortable<"u"){let e=new Sortable(a,n);wc.EventHub.events[a]=e}}}function Je(a){wc?.EventHub?.events[a].destroy()}function Ue(a,n,e,t){let o=2;n=n-o,e=e-o;let i=t.editor,s=i.getValue(),r=new RegExp(`<wc-form[^>]*id=["']${a}["'][^>]*>([\\s\\S]*?)<\\/wc-form>`),l=s.match(r);if(l){let c=l[1],d=/<div[^>]*class=["'][^"']*preview-draggable[^"']*["'][^>]*>[\s\S]*?<\/div>/g,u=c.match(d)||[];if(u.length===0)return;if(n>=0&&n<u.length&&e>=0&&e<u.length){let g=u.splice(n,1)[0];u.splice(e,0,g)}let m=c.replace(d,()=>u.shift()),h=s.replace(c,m);i.setValue(h)}}function Ge(a){let n=-1;return a&&(n=document.querySelectorAll(a).length),n}function Ye(a,n){let e=document.querySelector(a);e&&(n?e.classList.add("htmx-request"):e.classList.remove("htmx-request"))}function Ke(a,n){let t=a.detail.elt.closest("form"),o=t.querySelector(n);if(console.log("-->Attempting to process JSON for selector: ",n,t),o)try{let r=function(l,c=""){for(let d in l)if(Object.prototype.hasOwnProperty.call(l,d)){let u=l[d],m=c?`${c}.${d}`:d;if(u!==null&&typeof u=="object"&&!Array.isArray(u))r(u,m);else if(Array.isArray(u))u.forEach((h,g)=>{if(typeof h=="object"&&h!==null)r(h,`${m}[${g}]`);else{let b=document.createElement("input");b.type="hidden",b.name=`${m}[${g}]`,b.value=h,b.setAttribute("data-json-field","true"),t.appendChild(b),console.log("-->Appending array primitive:",b)}});else{let h=document.createElement("input");h.type="hidden",h.name=m,h.value=u,h.setAttribute("data-json-field","true"),t.appendChild(h),console.log("-->Appending primitive:",h)}}};t.querySelectorAll('input[data-json-field="true"]').forEach(l=>l.remove());let s=JSON.parse(o.value);console.log("-->JSON contents: ",s),r(s,"json_data"),console.log("-->Processing complete for selector: ",n,t)}catch(i){console.error("Error parsing JSON:",i)}}function Me(a,n){if(a==null)return!1;if("const"in n)return a===n.const;if("enum"in n)return Array.isArray(n.enum)&&n.enum.includes(a);if("minimum"in n){let e=typeof a=="number"?a:parseFloat(a);if(isNaN(e)||e<n.minimum)return!1}if("maximum"in n){let e=typeof a=="number"?a:parseFloat(a);if(isNaN(e)||e>n.maximum)return!1}if("minLength"in n&&String(a).length<n.minLength||"maxLength"in n&&String(a).length>n.maxLength)return!1;if("pattern"in n){let e=new RegExp(n.pattern);if(typeof a!="string"||!e.test(a))return!1}return!0}function Be(a,n,e){let t="";if(a?(t=`[data-id="${a}"]`,n&&(t+=` ${n}`)):n&&(t=n),!t)return;let o=document.querySelector(t);if(o)return e&&e in o?o[e]:o.type==="checkbox"?o.checked:o.value}function $(a){let{effect:n,condition:e,tgtDataId:t,tgtSelector:o,tgtProperty:i}=a,{scope:s,schema:r,srcDataId:l,srcSelector:c,srcProperty:d,property:u}=e,m=Be(l,c,d),h=!1;r&&(h=Me(m,r));let g=`[data-id="${t}"]`;o&&(g+=` ${o}`);let b=document.querySelector(g);if(b)switch(n){case"COPY":b[i]=m;break;case"COPY-TOLOWER":b[i]=m.toString().toLowerCase();break;case"COPY-TOLOWER-UNDERSCORE":b[i]=m.toString().toLowerCase().replaceAll(" ","_");break;case"HIDE":b.style.display=h?"none":"";break;case"SHOW":b.style.display=h?"":"none";break;case"DISABLE":b.disabled=h;break;case"ENABLE":b.disabled=!h;break;case"REQUIRE":b.required=!h;break;case"UN-REQUIRE":b.required=h;break;default:console.warn("Unknown rule effect:",n)}}function Ze(a){Array.from(new Set(a.map(e=>e.condition.srcDataId))).forEach(e=>{document.querySelectorAll(`[data-id="${e}"]`).forEach(t=>{let o=Array.from(a).filter(i=>i.condition.srcDataId==e);t.addEventListener("change",()=>{o.forEach($)}),t.addEventListener("input",()=>{o.forEach($)})})}),a.forEach($)}function Ve(a){let n=[];function e(t){!t||typeof t!="object"||(t.rules&&n.push(...t.rules),Array.isArray(t.elements)&&t.elements.forEach(e))}return a.forEach(e),n}function Xe(a){let n=[];function e(t){let o=t.label||"",i=t.scope||"",s=i?`${o} (${i})`:o,r={dataId:t["data-id"],label:s};n.push(r),t.elements&&Array.isArray(t.elements)&&t.elements.forEach(l=>e(l))}return a.forEach(t=>e(t)),n}var p=class extends HTMLElement{constructor(){super(),this._wcId=Ae(),this.loadCSS=k.bind(this),this.loadScript=S.bind(this),this.loadLibrary=_.bind(this),this.loadStyle=A.bind(this),this.childComponent=null,this.childComponentSelector="",this._pendingAttributes={},this._isConnected=!1,this.componentElement=null,this.formElement=null}get wcId(){return this._wcId}connectedCallback(){this.childComponentSelector?(console.log("connectedCallback:waiting for ",this.childComponentSelector," to be loaded..."),this._waitForChildren(this.childComponentSelector).then(()=>{this._connectedCallback()})):this._connectedCallback()}_connectedCallback(){this._render(),this.dataset.wcId=this.wcId,this.childComponentName?this._waitForChild(()=>this[this.childComponentName]).then(()=>{this._isConnected=!0,this._applyPendingAttributes()}):(this._isConnected=!0,this._applyPendingAttributes())}disconnectedCallback(){}attributeChangedCallback(n,e,t){this._isConnected?this._handleAttributeChange(n,t):this._pendingAttributes[n]=t}_applyPendingAttributes(){Object.keys(this._pendingAttributes).forEach(n=>{let e=this._pendingAttributes[n];this._handleAttributeChange(n,e)}),this._pendingAttributes={}}_handleAttributeChange(n,e){if(n==="name")this._handleNameToIdLinkage(e);else if(n==="elt-class"){let t=this.querySelector("[form-element]");t&&t.setAttribute("class",e)}else n==="class"?e&&e.replace("contents","").split(" ").forEach(i=>{i&&(this.componentElement.classList.add(i),this.classList.remove(i))}):this.componentElement.setAttribute(n,e)}_handleNameToIdLinkage(n){n&&this.formElement&&!this.formElement.hasAttribute("id")&&(this.formElement.setAttribute("id",n),this.formElement.setAttribute("name",n),this.removeAttribute("name"))}_render(){this.classList.add("contents"),console.log("wc-base-component:_render")}async _waitForChild(n){return new Promise(e=>{let t=setInterval(()=>{n()&&(clearInterval(t),e())},50)})}async _waitForChildren(n){let e=Array.from(this.querySelectorAll(n));await Promise.all(e.map(t=>new Promise(o=>{t.isConnected?o():t.addEventListener("connected",o,{once:!0})})))}_applyStyle(){}_wireEvents(){}_unWireEvents(){}};var M=class extends p{static formAssociated=!0;constructor(){super(),this._internals=this.attachInternals(),this._value=""}get value(){return this._isCheckbox()?this.checked:this._value}set value(n){this._isCheckbox()?this.checked=n:(this._value=n,this._internals.setFormValue(this._value))}get required(){return this.hasAttribute("required")}set required(n){n?this.setAttribute("required",""):this.removeAttribute("required")}get checked(){return this.formElement?.checked||!1}set checked(n){this._isCheckbox()&&(this.formElement.checked=n,this._internals.setFormValue(n?"bool:True":"bool:False"))}get validity(){return this._internals.validity}get validationMessage(){return this._internals.validationMessage}get willValidate(){return this._internals.willValidate}checkValidity(){return this._internals.checkValidity()}reportValidity(){return this._internals.reportValidity()}_handleValidation(){let n="";if(n==="span")if(this.formElement?.validity.valid)this.componentElement.querySelector(".error-message")?.remove();else{let e=document.createElement("span");e.classList.add("error-message"),e.textContent=this.formElement?.validationMessage,this.componentElement.appendChild(e)}else if(n==="tooltip")if(this.formElement?.validity.valid)this.formElement?.removeAttribute("data-error"),this.formElement?.setAttribute("title",this.formElement?.getAttribute("data-has-title")),this.formElement?.removeAttribute("data-has-title");else{let e=this.formElement?.validationMessage;this.formElement?.setAttribute("data-error",e),this.formElement?.setAttribute("data-has-title",this.formElement?.getAttribute("title")||""),this.formElement?.setAttribute("title","")}this._internals.setValidity(this.formElement?.validity,this.formElement?.validationMessage)}connectedCallback(){super.connectedCallback(),this.formElement=this.querySelector("input, select, textarea"),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(n,e){n==="value"?this._isCheckbox()?this.checked=e!==null&&e!=="false"&&e!=="bool:False":(this.formElement&&(this.formElement?.setAttribute("value",e),"value"in this.formElement&&(this.formElement.value=e)),this.value=e):super._handleAttributeChange(n,e)}_handleInputChange(n){let{target:e}=n;if(this._isCheckbox()?(e.checked?this.formElement.value="bool:True":this.formElement.value="bool:False",this.checked=e.checked):this.value=e.value,this._isRange()){let t=this.querySelector("label"),o=this.getAttribute("lbl-label")||"";t&&o&&(t.textContent=`${o} (${e.value})`)}this._handleValidation()}_isCheckbox(){return this.formElement?.type==="checkbox"}_isRange(){return this.formElement?.type==="range"}_wireEvents(){super._wireEvents(),this.formElement&&(this.formElement.addEventListener("input",this._handleInputChange.bind(this)),this.formElement.addEventListener("change",this._handleInputChange.bind(this)))}_unWireEvents(){super._unWireEvents(),this.formElement&&(this.formElement.removeEventListener("input",this._handleInputChange.bind(this)),this.formElement.removeEventListener("change",this._handleInputChange.bind(this)))}};var R=class extends p{static get observedAttributes(){return["id","class","items","allow-many"]}constructor(){super(),this._items=[];let n=this.querySelector(".wc-accordion");n?this.componentElement=n:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-accordion"),this.appendChild(this.componentElement)),console.log("ctor:wc-accordion")}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents(),console.log("connectedCallback:wc-accordion")}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(n,e){n==="items"?(typeof e=="string"&&(this._items=JSON.parse(e)),this.removeAttribute("items")):n==="allow-many"||super._handleAttributeChange(n,e)}_render(){super._render();let n=this.querySelectorAll(".wc-accordion > *");n.length>0?(this.componentElement.innerHTML="",n.forEach(e=>this.componentElement.appendChild(e))):(this._moveDeclarativeOptions(),this.componentElement.innerHTML="",this._items.forEach(e=>{let t=this._createHeader(e.label,e.selected);this.componentElement.appendChild(t);let o=this._createPanel(e.content);this.componentElement.appendChild(o)})),this._setActive(),typeof htmx<"u"&&htmx.process(this),console.log("_render:wc-accordion")}_createHeader(n,e){let t=this.hasAttribute("allow-many"),o=document.createElement("button");return o.classList.add("accordion-header"),t?o.setAttribute("_",`on click
        toggle .active on me
      ...
      `),e&&o.classList.add("active"),o.textContent=n,o}_createPanel(n){let e=document.createElement("div");e.classList.add("accordion-panel");let t=document.createElement("p");return t.innerHTML=n,e.appendChild(t),e}_moveDeclarativeOptions(){let n=this.querySelectorAll("option");n.length>0&&(this._items=[]),n.forEach(e=>{let t={label:e.value,content:e.innerHTML.trim(),selected:e.hasAttribute("selected")||!1};this._items.push(t)}),Array.from(n).forEach(e=>e.remove())}_setActive(){setTimeout(()=>{this.querySelectorAll(".wc-accordion .accordion-header").forEach(e=>{if(e.classList.contains("active")){let t=e.nextElementSibling;t.style.maxHeight=t.scrollHeight+"px"}})},10)}_applyStyle(){let n=`
      wc-accordion {
        display: contents;
      }
    ...
    `.trim();this.loadStyle("wc-background-image-style",n)}_unWireEvents(){super._unWireEvents()}};customElements.define("wc-background-image",z);if(!customElements.get("wc-breadcrumb-item")){class a extends p{static get observedAttributes(){return["id","class"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb-item")}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"||super._handleAttributeChange(e,t)}_createElement(){this.componentElement.id="breadcrumb-item",this.componentElement.className="wc-breadcrumb-item flex flex-row px-2 gap-4",this.componentElement.innerHTML=`
      ...
      `.trim()}_unWireEvents(){super._unWireEvents()}}customElements.define("wc-breadcrumb-item",a)}if(!customElements.get("wc-breadcrumb")){class a extends p{static get observedAttributes(){return["id","class","doc-title"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this._createElement(),this.appendChild(this.componentElement)),setTimeout(()=>{let t=[],o=this.getAttribute("doc-title")||"",i=this.querySelectorAll("wc-breadcrumb-item");Array.from(i).forEach(r=>{let l=r.getAttribute("label");l&&t.push(l)});let s=t.join(" > ");s&&(o?document.title=s+" - "+o:document.title=s)},250)}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"||super._handleAttributeChange(e,t)}_getBreadcrumbItems(){let e=[{label:"",link:"/v/home"},{label:"Screens",link:"/v/screen_list/list"},{label:"screen",link:""}],t=[],o=this.querySelectorAll("wc-breadcrumb-item");return Array.from(o).forEach(i=>{let s=i.getAttribute("label")||"",r=i.getAttribute("link")||"";t.push({label:s,link:r})}),t}_createElement(){let e=[],t=this._getBreadcrumbItems();t.forEach((i,s)=>{s==0?e.push(`
            <a href="${i.link}"
              hx-get="${i.link}"
              hx-target="#viewport"
              hx-swap="innerHTML transition:true"
      ...
      `,e.querySelector("#closeButton").addEventListener("click",this._handleSettingsClose.bind(this),{once:!0}),e.querySelector("#apply-settings").addEventListener("click",this._handleSettingsApply.bind(this),{once:!0}),e.querySelector("#cancel-settings").addEventListener("click",this._handleSettingsClose.bind(this),{once:!0})}_handleSettingsApply(e){let t=this.querySelector(".settings-popover"),o=t.querySelector("#closeButton"),i=t.querySelector("#theme-select").value,s=t.querySelector("#mode-select").value,r=t.querySelector("#line-numbers").checked,l=t.querySelector("#line-wrapper").checked,c=t.querySelector("#fold-gutter").checked,d=t.querySelector("#tab-size").value,u=t.querySelector("#indent-unit").value;this.setAttribute("theme",i),this.setAttribute("mode",s),r?this.setAttribute("line-numbers",""):this.removeAttribute("line-numbers"),l?this.setAttribute("line-wrapper",""):this.removeAttribute("line-wrapper"),c?this.setAttribute("fold-gutter",""):this.removeAttribute("fold-gutter"),this.setAttribute("tab-size",d),this.setAttribute("indent-unit",u),this._handleSettingsClose(e)}_handleSettingsClose(e){e.preventDefault();let t=this.querySelector(".settings-popover");for(t.togglePopover();t.firstChild;)t.removeChild(t.firstChild)}get value(){return this.editor?.getValue()||""}set value(e){this.editor&&(this.editor.setValue(e),this._internals.setFormValue(e))}_applyStyle(){let e=`
...
`),l=[{pattern:/\b(function|var|let|const|return|if|else|endif|for|endfor|while|switch|case|break|continue|this|new|typeof|instanceof|class|async|await|in)\b/g,className:"cm-js-keyword"},{pattern:/\b(true|false|null|undefined)\b/g,className:"cm-js-atom"},{pattern:/\b\d+(\.\d+)?\b/g,className:"cm-js-number"},{pattern:/(["'`])(?:[^\\]|\\.)*?\1/g,className:"cm-js-string"},{pattern:/[+\-*/%=&|^<>!?:;,.]/g,className:"cm-js-operator"},{pattern:/=>/g,className:"cm-js-keyword"},{pattern:/\b\.[A-Za-z]+/g,className:"cm-js-property"}];r.forEach((c,d)=>{i.markText({line:t+d,ch:0},{line:t+d,ch:c.length},{className:"cm-wc-content"}),l.forEach(({pattern:u,className:m})=>{let h;for(u.lastIndex=0;(h=u.exec(c))!==null;){let g=h.index,b=g+h[0].length;i.markText({line:t+d,ch:g},{line:t+d,ch:b},{className:m})}})})}}customElements.define("wc-code-mirror",a)}var F=class extends p{static get observedAttributes(){return["id","class","gender","contact-name","contact-title"]}constructor(){super();let n=this.querySelector(".wc-contact-card");n?this.componentElement=n:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-contact-card"),this.appendChild(this.componentElement)),console.log("ctor:wc-contact-card")}async connectedCallback(){super.connectedCallback(),this._applyStyle(),console.log("connectedCallback:wc-contact-card")}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(n,e){if(n=="gender"){let t=this.querySelector("img");e=="male"?t.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"):t.setAttribute("src","https://www.w3schools.com/howto/img_avatar2.png")}else if(n=="contact-name"){let t=this.querySelector("div.contact-card-name");t.innerHTML=e}else if(n=="contact-title"){let t=this.querySelector("div.contact-card-title");t.innerHTML=e}else super._handleAttributeChange(n,e)}_render(){super._render(),this.querySelector(".wc-contact-card > *")||(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this),console.log("_render:wc-contact-card")}_createInnerElement(){Array.from(this.children).filter(s=>!s.matches("wc-contact-card")&&!s.matches(".wc-contact-card")).forEach(s=>this.componentElement.appendChild(s));let e=document.createElement("img");e.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"),e.setAttribute("alt","Person"),e.setAttribute("width","100%");let t=document.createElement("div");t.classList.add("contact-card-container");let o=document.createElement("div");o.classList.add("contact-card-name","text-2xl","font-bold"),o.innerHTML="John Doe";let i=document.createElement("div");i.classList.add("contact-card-title","text-lg"),i.innerHTML="Boss",t.appendChild(o),t.appendChild(i),this.componentElement.appendChild(e),this.componentElement.appendChild(t)}_applyStyle(){this.loadStyle("wc-contact-card-style",`
  ...
  <template id="rule-template">
    ...
    `)}_unWireEvents(){super._unWireEvents();let n=this.getAttribute("push-target")||"body",e=document.querySelector(n),t=this.hasAttribute("right-side");e&&(t?e.style.marginRight="0":e.style.marginLeft="0")}};customElements.define("wc-sidebar",Z);var V=class extends p{static get observedAttributes(){return["id","class","label","width","open","open-top","open-vertical-text","push","push-target","overlay","background-color","auto-height"]}constructor(){super(),this.hasAttribute("right-side")||this.setAttribute("left-side","");let n=this.querySelector(".wc-sidenav");if(n)this.componentElement=n;else{let e=this.hasAttribute("open");this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-sidenav","sidenav"),e&&this.componentElement.classList.add("open"),this.appendChild(this.componentElement)}console.log("ctor:wc-sidenav")}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents(),console.log("connectedCallback:wc-sidenav")}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(n,e){n==="label"||n==="auto-height"||n==="background-color"||n==="open-vertical-text"||n==="open-top"||n==="open"||n==="overlay"||n==="push-target"||n==="push"||n==="width"||super._handleAttributeChange(n,e)}_render(){super._render(),this.querySelector(".wc-sidenav > *")?(this.querySelector(".closebtn").addEventListener("click",this._closeNav.bind(this)),this.querySelector(".openbtn").addEventListener("click",this._openNav.bind(this))):(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this),console.log("_render:wc-sidenav")}_createInnerElement(){let n=this.querySelectorAll("wc-sidenav > *:not(.wc-sidenav");this.hasAttribute("auto-height")?this.componentElement.style.height="auto":this.componentElement.style.height="100%";let t=document.createElement("div");if(t.classList.add("overlay","hidden"),this.appendChild(t),this.hasAttribute("background-color")){let c=this.getAttribute("background-color");this.componentElement.style.setProperty("--background-color",c)}let o=this.getAttribute("label")||"Sidenav",i=document.createElement("button");i.classList.add("closebtn"),i.innerHTML="&times;",i.addEventListener("click",this._closeNav.bind(this)),this.componentElement.appendChild(i);let s=document.createElement("button");s.classList.add("openbtn"),s.style.top=this.getAttribute("open-top")||"0",s.addEventListener("click",this._openNav.bind(this));let r=document.createElement("span");r.textContent=o,s.appendChild(r),this.appendChild(s),n.forEach(c=>this.componentElement.appendChild(c));let l=this.getAttribute("push-target")||"#viewport";if(l){let c=document.querySelector(l);c&&c.style.setProperty("transition","margin-left 0.5s ease, margin-right 0.5s ease")}}_handleHelper(n,e){let{detail:t}=n,{selector:o}=t,i=Array.isArray(o);typeof o=="string"||i?document.querySelectorAll(o).forEach(r=>{r===this&&(e==="toggle"&&(this.querySelector(".wc-sidenav").classList.contains("open")?e=".closebtn":e=".openbtn"),r?.querySelector(e)?.click())}):o?.querySelector(e)?.click()}_handleOpen(n){this._handleHelper(n,".openbtn")}_handleClose(n){this._handleHelper(n,".closebtn")}_handleToggle(n){this._handleHelper(n,"toggle")}_openNav(n){let{target:e}=n,t=this.getAttribute("width")||"250px",o=this.getAttribute("push-target")||"#viewport",i=this.querySelector(".wc-sidenav");if(i.classList.add("open"),i.style.width=t,this.hasAttribute("overlay")){let s=this.querySelector(".overlay");s&&(s.classList.add("open"),s.classList.remove("hidden"))}if(this.hasAttribute("push")){let s=this.hasAttribute("right-side");if(o){let r=document.querySelector(o);r&&(s?r.style.marginRight=t:r.style.marginLeft=t)}}}_closeNav(n){let{target:e}=n,t=this.getAttribute("push-target")||"#viewport",o=e.closest(".wc-sidenav");if(o.classList.remove("open"),o.style.width="0",this.hasAttribute("overlay")){let i=this.querySelector(".overlay");i&&(i.classList.remove("open"),i.classList.add("hidden"))}if(this.hasAttribute("push")){let i=this.hasAttribute("right-side");if(t){let s=document.querySelector(t);s&&(i?s.style.marginRight="0":s.style.marginLeft="0")}}}_applyStyle(){this.loadStyle("wc-sidenav-style",`
      wc-sidenav {
        display: contents;
      }
