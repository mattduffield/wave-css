...
`),r=[{pattern:/\b(function|var|let|const|return|if|else|endif|for|endfor|while|switch|case|break|continue|this|new|typeof|instanceof|class|async|await|in)\b/g,className:"cm-js-keyword"},{pattern:/\b(true|false|null|undefined)\b/g,className:"cm-js-atom"},{pattern:/\b\d+(\.\d+)?\b/g,className:"cm-js-number"},{pattern:/(["'`])(?:[^\\]|\\.)*?\1/g,className:"cm-js-string"},{pattern:/[+\-*/%=&|^<>!?:;,.]/g,className:"cm-js-operator"},{pattern:/=>/g,className:"cm-js-keyword"},{pattern:/\b\.[A-Za-z]+/g,className:"cm-js-property"}];l.forEach((c,d)=>{i.markText({line:t+d,ch:0},{line:t+d,ch:c.length},{className:"cm-wc-content"}),r.forEach(({pattern:p,className:u})=>{let m;for(p.lastIndex=0;(m=p.exec(c))!==null;){let h=m.index,g=h+m[0].length;i.markText({line:t+d,ch:h},{line:t+d,ch:g},{className:u})}})})}}customElements.define("wc-code-mirror",a)}var F=class extends b{static get observedAttributes(){return["id","class","gender","contact-name","contact-title"]}constructor(){super();let o=this.querySelector(".wc-contact-card");o?this.componentElement=o:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-contact-card"),this.appendChild(this.componentElement)),console.log("ctor:wc-contact-card")}async connectedCallback(){super.connectedCallback(),this._applyStyle(),console.log("connectedCallback:wc-contact-card")}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(o,e){if(o=="gender"){let t=this.querySelector("img");e=="male"?t.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"):t.setAttribute("src","https://www.w3schools.com/howto/img_avatar2.png")}else if(o=="contact-name"){let t=this.querySelector("div.contact-card-name");t.innerHTML=e}else if(o=="contact-title"){let t=this.querySelector("div.contact-card-title");t.innerHTML=e}else super._handleAttributeChange(o,e)}_render(){super._render(),this.querySelector(".wc-contact-card > *")||(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this),console.log("_render:wc-contact-card")}_createInnerElement(){Array.from(this.children).filter(s=>!s.matches("wc-contact-card")&&!s.matches(".wc-contact-card")).forEach(s=>this.componentElement.appendChild(s));let e=document.createElement("img");e.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"),e.setAttribute("alt","Person"),e.setAttribute("width","100%");let t=document.createElement("div");t.classList.add("contact-card-container");let n=document.createElement("div");n.classList.add("contact-card-name","text-2xl","font-bold"),n.innerHTML="John Doe";let i=document.createElement("div");i.classList.add("contact-card-title","text-lg"),i.innerHTML="Boss",t.appendChild(n),t.appendChild(i),this.componentElement.appendChild(e),this.componentElement.appendChild(t)}_applyStyle(){this.loadStyle("wc-contact-card-style",`
    ...
    `.trim();await this.loadStyle("wc-dropdown-style",o)}_wireEvents(){super._wireEvents(),this.clickModes.includes(this.mode)&&(document.body.addEventListener("wc-dropdown:open",this._handleOpen.bind(this)),document.body.addEventListener("wc-dropdown:close",this._handleClose.bind(this)),document.body.addEventListener("wc-dropdown:toggle",this._handleToggle.bind(this)))}_unWireEvents(){if(super._unWireEvents(),this.clickModes.includes(this.mode)){document.body.removeEventListener("wc-dropdown:open",this._handleOpen.bind(this)),document.body.removeEventListener("wc-dropdown:close",this._handleClose.bind(this)),document.body.removeEventListener("wc-dropdown:toggle",this._handleToggle.bind(this)),this.querySelector(".dropbtn").removeEventListener("click",this._handleClick.bind(this)),window.removeEventListener("click",this._handleWindowClick.bind(this));let e=this.querySelector(".search");e&&e.removeEventListener("input",this._handleInput.bind(this))}}};customElements.define("wc-dropdown",J);var V=class extends b{static get observedAttributes(){return["id","class"]}constructor(){super();let o=this.querySelector(".wc-flip-box");o?this.componentElement=o:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-flip-box"),this.appendChild(this.componentElement)),console.log("ctor:wc-flip-box")}async connectedCallback(){super.connectedCallback(),this._applyStyle(),console.log("connectedCallback:wc-flip-box")}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_render(){if(super._render(),!this.querySelector(".flip-box-inner")){this.componentElement.innerHTML="";let e=this._createInnerElement();this.componentElement.appendChild(e)}typeof htmx<"u"&&htmx.process(this),console.log("_render:wc-flip-box")}_createInnerElement(){let o=document.createElement("div");o.classList.add("flip-box-inner");let e=this.querySelector('[slot="front"]'),t=this.querySelector('[slot="back"]');return e&&(e.classList.add("flip-box-front"),o.appendChild(e)),t&&(t.classList.add("flip-box-back"),o.appendChild(t)),this.componentElement.appendChild(o),o}_applyStyle(){let o=`
      ...
      .wc-flip-box .flip-box-back {
        ...
        color: var(--text-1);
        transform: rotateY(180deg);
      }`.trim();this.loadStyle("wc-flip-box-style",o)}_unWireEvents(){super._unWireEvents()}};customElements.define("wc-flip-box",V);if(!customElements.get("wc-icon")){class a extends b{static get observedAttributes(){return["name","icon-style","size","color","primary-color","secondary-color","secondary-opacity","swap-opacity","rotate","flip","base-path"]}static iconAliases={home:"house",search:"magnifying-glass",edit:"pen-to-square",save:"floppy-disk",undo:"arrow-rotate-left",redo:"arrow-rotate-right","sign-out":"right-from-bracket","sign-in":"right-to-bracket","sign-out-alt":"arrow-right-from-bracket","sign-in-alt":"arrow-right-to-bracket",settings:"gear",cog:"gear",cogs:"gears","trash-alt":"trash-can",delete:"trash",remove:"xmark",clear:"eraser",close:"xmark",times:"xmark","search-plus":"magnifying-glass-plus","search-minus":"magnifying-glass-minus","zoom-in":"magnifying-glass-plus","zoom-out":"magnifying-glass-minus","power-off":"power-off","log-out":"right-from-bracket","log-in":"right-to-bracket","shopping-cart":"cart-shopping","chart-bar":"chart-column","bar-chart":"chart-column","line-chart":"chart-line","area-chart":"chart-area","pie-chart":"chart-pie",refresh:"arrows-rotate",sync:"arrows-rotate",mail:"envelope",email:"envelope",warning:"triangle-exclamation","exclamation-triangle":"triangle-exclamation",error:"circle-xmark","times-circle":"circle-xmark",info:"circle-info","info-circle":"circle-info","question-circle":"circle-question",help:"circle-question",picture:"image",photo:"image"};constructor(){super(),this._iconRegistry=new Map,this._loadedIcons=new Map,this._basePath=this.getAttribute("base-path")||a.defaultBasePath||"/dist/assets/icons"}static get is(){return"wc-icon"}static defaultBasePath="/dist/assets/icons";static setBasePath(e){a.defaultBasePath=e,window.wc?.iconRegistry&&window.wc.iconRegistry.setBaseUrl(e)}async _render(){this.classList.remove("contents"),this._svg=document.createElementNS("http://www.w3.org/2000/svg","svg"),this._svg.setAttribute("viewBox","0 0 512 512"),this._svg.setAttribute("fill","currentColor"),this._group=document.createElementNS("http://www.w3.org/2000/svg","g"),this._svg.appendChild(this._group),this.appendChild(this._svg),this._applyStyles(),await this._loadIcon()}_handleAttributeChange(e,t,n){e==="name"||e==="icon-style"?this._loadIcon():e==="base-path"?(this._basePath=n||a.defaultBasePath,this._loadIcon()):this._applyStyles()}_applyStyles(){if(!this._svg)return;let e=this.getAttribute("size"),t=this.getAttribute("rotate"),n=this.getAttribute("flip"),i=this.getAttribute("icon-style")||"solid";if(e&&(this._svg.style.width=e,this._svg.style.height=e),t&&(this._svg.style.transform=`rotate(${t}deg)`),n==="horizontal"?this._svg.style.transform=(this._svg.style.transform||"")+" scaleX(-1)":n==="vertical"?this._svg.style.transform=(this._svg.style.transform||"")+" scaleY(-1)":n==="both"&&(this._svg.style.transform=(this._svg.style.transform||"")+" scale(-1)"),i.includes("duotone")){let s=this.getAttribute("primary-color")||this.getAttribute("color")||"currentColor",l=this.getAttribute("secondary-color")||this.getAttribute("color")||"currentColor",r=this.getAttribute("secondary-opacity")||"0.4",c=this.hasAttribute("swap-opacity");this.style.setProperty("--fa-primary-color",s),this.style.setProperty("--fa-secondary-color",l),this.style.setProperty("--fa-primary-opacity",c?r:"1"),this.style.setProperty("--fa-secondary-opacity",c?"1":r),this.style.removeProperty("--fa-color")}else{let s=this.getAttribute("color")||"currentColor";this.style.setProperty("--fa-color",s),this.style.removeProperty("--fa-primary-color"),this.style.removeProperty("--fa-secondary-color"),this.style.removeProperty("--fa-primary-opacity"),this.style.removeProperty("--fa-secondary-opacity")}}async _loadIcon(){let e=this.getAttribute("name");if(!e||!this._group)return;let t=a.iconAliases[e]||e,n=this.getAttribute("icon-style")||"solid",i=this.getAttribute("base-path")||this._basePath,s=`${n}/${t}`;try{let l=this._loadedIcons.get(s);if(!l&&(l=this._iconRegistry.get(s),!l)){let r=await fetch(`${i}/${n}/${t}.svg`);if(!r.ok){console.error(`Icon not found: ${s}`);return}let c=await r.text(),p=new DOMParser().parseFromString(c,"image/svg+xml"),u=p.querySelector("svg"),m=p.querySelectorAll("path"),h=u?.getAttribute("viewBox");h&&this._svg.setAttribute("viewBox",h),l={viewBox:h,paths:Array.from(m).map(g=>({d:g.getAttribute("d"),opacity:g.getAttribute("opacity"),class:g.getAttribute("class"),fill:g.getAttribute("fill")}))},this._loadedIcons.set(s,l)}this._group.innerHTML="",l.viewBox&&this._svg.setAttribute("viewBox",l.viewBox),l.paths.forEach(r=>{let c=document.createElementNS("http://www.w3.org/2000/svg","path");c.setAttribute("d",r.d),n.includes("duotone")?r.class&&r.class.includes("fa-secondary")?(c.classList.add("fa-secondary"),c.style.fill="var(--fa-secondary-color)",c.style.opacity="var(--fa-secondary-opacity)"):(c.classList.add("fa-primary"),c.style.fill="var(--fa-primary-color)",c.style.opacity="var(--fa-primary-opacity)"):(c.style.fill="var(--fa-color, currentColor)",r.opacity&&(c.style.opacity=r.opacity)),this._group.appendChild(c)})}catch(l){console.error(`Error loading icon ${s}:`,l)}}static registerIcon(e,t,n="solid"){a._globalRegistry||(a._globalRegistry=new Map);let i=`${n}/${e}`;a._globalRegistry.set(i,t)}static registerIcons(e,t="solid"){Object.entries(e).forEach(([n,i])=>{a.registerIcon(n,i,t)})}connectedCallback(){super.connectedCallback(),a._globalRegistry&&a._globalRegistry.forEach((e,t)=>{this._iconRegistry.set(t,e)})}}customElements.define(a.is,a)}var G=class extends b{static get observedAttributes(){return["id","class","url","caption","modal","hover-overlay","hover-mode"]}constructor(){super();let o=this.querySelector(".wc-image");o?this.componentElement=o:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-image"),this.appendChild(this.componentElement)),console.log("ctor:wc-image")}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents(),console.log("connectedCallback:wc-image")}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(o,e){o==="url"||o==="caption"||o==="modal"||super._handleAttributeChange(o,e)}_render(){super._render(),this.querySelector(".wc-image > *")?this.hasAttribute("modal")&&(this.querySelector(".img").addEventListener("click",this._showModal.bind(this)),this.querySelector(".overlay .closebtn").addEventListener("click",this._hideModal.bind(this))):(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this),console.log("_render:wc-image")}_createInnerElement(){let o=this.getAttribute("caption")||"",e=document.createElement("img");e.classList.add("img"),e.src=this.getAttribute("url")||"",e.alt=o;let t=document.createElement("div");if(t.textContent=o,t.classList.add("img-text"),this.componentElement.appendChild(e),this.componentElement.appendChild(t),this.hasAttribute("hover-overlay")){let r=this.getAttribute("hover-mode")||"bottom",c=document.createElement("div");c.classList.add("hover-overlay",r),this.querySelectorAll("wc-image > *:not(.wc-image").forEach(p=>c.appendChild(p)),this.componentElement.appendChild(c)}let n=document.createElement("div");n.classList.add("overlay","hidden");let i=document.createElement("button");i.classList.add("closebtn"),i.innerHTML="&times;",n.appendChild(i);let s=document.createElement("img");s.classList.add("overlay-img"),s.alt=o,n.appendChild(s);let l=document.createElement("div");l.textContent=o,l.classList.add("overlay-img-text"),n.appendChild(l),this.appendChild(n),this.hasAttribute("modal")&&(e.addEventListener("click",this._showModal.bind(this)),i.addEventListener("click",this._hideModal.bind(this)))}_handleHelper(o,e="show"){let{detail:t}=o,{selector:n}=t,i=Array.isArray(n);typeof n=="string"||i?document.querySelectorAll(n).forEach(l=>{l===this&&(e==="show"?this._showModal({target:this}):e==="hide"&&this._hideModal({target:this}))}):n===this&&(e==="show"?this._showModal({target:this}):e==="hide"&&this._hideModal({target:this}))}_handleShow(o){this._handleHelper(o,"show")}_handleHide(o){this._handleHelper(o,"hide")}_showModal(o){let{target:e}=o,t=this.querySelector(".overlay");if(t){let n=this.querySelector("img:not(.overlay-img)"),i=this.querySelector(".overlay-img");i.src=n.src,t.classList.remove("hidden"),t.classList.add("show")}}_hideModal(o){let{target:e}=o,t=this.querySelector(".overlay");t&&(t.classList.remove("show"),t.classList.add("hidden"))}_applyStyle(){let o=`
      wc-image {
        display: contents;
      }
      wc-image .wc-image {
