function qe(l){return l.tagName.includes("-")}function Ce(){return"xxxx-xxxx-xxxx-xxxx".replace(/[x]/g,()=>(Math.random()*16|0).toString(16))}function E(l){return new Promise((t,e)=>{if(document.querySelector(`link[rel="stylesheet"][href="${l}"]`)){t();return}let o=document.createElement("link");o.rel="stylesheet",o.href=l,o.onload=()=>t(),o.onerror=i=>e(i),document.head.appendChild(o);let n=setInterval(()=>{getComputedStyle(document.body).getPropertyValue("display")&&(clearInterval(n),t())},50)})}function x(l){return new Promise((t,e)=>{if(document.querySelector(`script[src="${l}"]`)){t();return}let o=document.createElement("script");o.src=l,o.onload=()=>{t()},o.onerror=n=>{e(n)},document.head.appendChild(o)})}function k(l,t){return new Promise((e,o)=>{if(document.querySelector(`script[src="${l}"]`)){if(t&&window[t])e();else{let i=setInterval(()=>{window[t]&&(clearInterval(i),e())},50)}return}let n=document.createElement("script");n.src=l,n.onload=()=>{if(t&&!window[t]){let i=setInterval(()=>{window[t]&&(clearInterval(i),e())},50)}else e()},n.onerror=i=>{o(i)},document.head.appendChild(n)})}function C(l,t){if(!document.getElementById(l)){let e=document.createElement("style");e.id=l,e.textContent=t.trim(),document.head.appendChild(e)}}function Me(l,t){if(l.matches&&l.matches(t))return l;let e=l.querySelector(t);if(e)return e;let o=l.querySelectorAll("*");for(let n of o)if(n.shadowRoot){let i=this.locator(n.shadowRoot,t);if(i)return i}}function Te(l,t){let e=[];l.matches&&l.matches(t)&&e.push(l),e.push(...l.querySelectorAll(t));let o=l.querySelectorAll("*");for(let n of o)n.shadowRoot&&e.push(...this.locatorAll(n.shadowRoot,t));return e}function He(l,t=3e3,e=100){return new Promise((o,n)=>{let i=Date.now(),s=()=>{let r=document.querySelector(l);r&&r.offsetParent!==null?o(r):Date.now()-i>t?n(new Error(`Timeout: Selector "${l}" not found or not visible after ${t}ms`)):setTimeout(s,e)};s()})}function Ie(l,t){let e=!1;return e=wc.linksLoaded[l]&&wc.scriptsLoaded[t],e}function ze(l=[],t=[],e=5e3,o=100){return new Promise((n,i)=>{let s=Date.now(),r=Array.isArray(l)?l:[l],a=Array.isArray(t)?t:[t],c=()=>{let d=r.length===0||r.every(b=>window.wc?.scriptsLoaded?.[b]===!0),u=a.length===0||a.every(b=>window.wc?.linksLoaded?.[b]===!0);d&&u?n():Date.now()-s>e?i(new Error(`Timeout: Dependencies not available after ${e}ms. Scripts: ${JSON.stringify(r)}, Links: ${JSON.stringify(a)}`)):setTimeout(c,o)};c()})}function _e(l=[],t=3e3){return new Promise((e,o)=>{let n=Date.now(),i=Array.isArray(l)?l:[l],s=()=>{i.every(a=>document.querySelector(a)!==null)?e():Date.now()-n>t?o(new Error(`Timeout: Not all selectors available after ${t}ms. Missing selectors: ${JSON.stringify(i)}`)):requestAnimationFrame(s)};s()})}function We(l,t,e=3e3){return new Promise((o,n)=>{let i=Date.now(),s=()=>{l[t]?o():Date.now()-i>e?n(new Error(`Timeout: ${e}ms. Propery: ${t} not available on element.`)):requestAnimationFrame(s)};s()})}async function j(l){return new Promise(t=>setTimeout(t,l))}function Ae(l){document.querySelector(l).classList.add("hidden")}function Se(l){document.querySelector(l).classList.remove("hidden")}function Le(l,t){Ae(l),Se(t)}async function je(l,t,e=3e3,o=500){await _e([l,t],e),await j(o),Le(l,t)}function $e(l,t,e){try{fetch(l,{method:"GET"}).then(o=>o.text()).then(o=>{t&&t(o)})}catch(o){e&&e(o)}}function Be(l){if(l){let t={animation:150,draggable:".preview-draggable",onEnd:function(e){let o={e,event:"onEnd",item:e.item,from:e.from,to:e.to,oldIndex:e.oldIndex,newIndex:e.newIndex};wc?.EventHub?.broadcast("sortable:on-end","","",o)}};if(typeof Sortable<"u"){let e=new Sortable(l,t);wc.EventHub.events[l]=e}}}function Pe(l){wc?.EventHub?.events[l].destroy()}function Fe(l,t,e,o){let n=2;t=t-n,e=e-n;let i=o.editor,s=i.getValue(),r=new RegExp(`<wc-form[^>]*id=["']${l}["'][^>]*>([\\s\\S]*?)<\\/wc-form>`),a=s.match(r);if(a){let c=a[1],d=/<div[^>]*class=["'][^"']*preview-draggable[^"']*["'][^>]*>[\s\S]*?<\/div>/g,u=c.match(d)||[];if(u.length===0)return;if(t>=0&&t<u.length&&e>=0&&e<u.length){let v=u.splice(t,1)[0];u.splice(e,0,v)}let b=c.replace(d,()=>u.shift()),w=s.replace(c,b);i.setValue(w)}}var h=class extends HTMLElement{constructor(){super(),this._wcId=Ce(),this.loadCSS=E.bind(this),this.loadScript=x.bind(this),this.loadLibrary=k.bind(this),this.loadStyle=C.bind(this),this.childComponent=null,this.childComponentSelector="",this._pendingAttributes={},this._isConnected=!1,this.componentElement=null,this.formElement=null}get wcId(){return this._wcId}connectedCallback(){this.childComponentSelector?(console.log("connectedCallback:waiting for ",this.childComponentSelector," to be loaded..."),this._waitForChildren(this.childComponentSelector).then(()=>{this._connectedCallback()})):this._connectedCallback()}_connectedCallback(){this._render(),this.dataset.wcId=this.wcId,this.childComponentName?this._waitForChild(()=>this[this.childComponentName]).then(()=>{this._isConnected=!0,this._applyPendingAttributes()}):(this._isConnected=!0,this._applyPendingAttributes())}disconnectedCallback(){}attributeChangedCallback(t,e,o){this._isConnected?this._handleAttributeChange(t,o):this._pendingAttributes[t]=o}_applyPendingAttributes(){Object.keys(this._pendingAttributes).forEach(t=>{let e=this._pendingAttributes[t];this._handleAttributeChange(t,e)}),this._pendingAttributes={}}_handleAttributeChange(t,e){if(t==="name")this._handleNameToIdLinkage(e);else if(t==="elt-class"){let o=this.querySelector("[form-element]");o&&o.setAttribute("class",e)}else t==="class"?e.replace("contents","").split(" ").forEach(i=>{i&&(this.componentElement.classList.add(i),this.classList.remove(i))}):this.componentElement.setAttribute(t,e)}_handleNameToIdLinkage(t){t&&this.formElement&&!this.formElement.hasAttribute("id")&&(this.formElement.setAttribute("id",t),this.formElement.setAttribute("name",t),this.removeAttribute("name"))}_render(){this.classList.add("contents"),console.log("wc-base-component:_render")}async _waitForChild(t){return new Promise(e=>{let o=setInterval(()=>{t()&&(clearInterval(o),e())},50)})}async _waitForChildren(t){let e=Array.from(this.querySelectorAll(t));await Promise.all(e.map(o=>new Promise(n=>{o.isConnected?n():o.addEventListener("connected",n,{once:!0})})))}_applyStyle(){}_wireEvents(){}_unWireEvents(){}};var _=class extends h{static formAssociated=!0;constructor(){super(),this._internals=this.attachInternals(),this._value=""}get value(){return this._isCheckbox()?this.checked:this._value}set value(t){this._isCheckbox()?this.checked=t:(this._value=t,this._internals.setFormValue(this._value))}get required(){return this.hasAttribute("required")}set required(t){t?this.setAttribute("required",""):this.removeAttribute("required")}get checked(){return this.formElement?.checked||!1}set checked(t){this._isCheckbox()&&(this.formElement.checked=t,this._internals.setFormValue(t?"bool:True":"bool:False"))}get validity(){return this._internals.validity}get validationMessage(){return this._internals.validationMessage}get willValidate(){return this._internals.willValidate}checkValidity(){return this._internals.checkValidity()}reportValidity(){return this._internals.reportValidity()}_handleValidation(){let t="";if(t==="span")if(this.formElement?.validity.valid)this.componentElement.querySelector(".error-message")?.remove();else{let e=document.createElement("span");e.classList.add("error-message"),e.textContent=this.formElement?.validationMessage,this.componentElement.appendChild(e)}else if(t==="tooltip")if(this.formElement?.validity.valid)this.formElement?.removeAttribute("data-error"),this.formElement?.setAttribute("title",this.formElement?.getAttribute("data-has-title")),this.formElement?.removeAttribute("data-has-title");else{let e=this.formElement?.validationMessage;this.formElement?.setAttribute("data-error",e),this.formElement?.setAttribute("data-has-title",this.formElement?.getAttribute("title")||""),this.formElement?.setAttribute("title","")}this._internals.setValidity(this.formElement?.validity,this.formElement?.validationMessage)}connectedCallback(){super.connectedCallback(),this.formElement=this.querySelector("input, select, textarea"),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(t,e){t==="value"?this._isCheckbox()?this.checked=e!==null&&e!=="false"&&e!=="bool:False":(this.formElement&&(this.formElement?.setAttribute("value",e),"value"in this.formElement&&(this.formElement.value=e)),this.value=e):super._handleAttributeChange(t,e)}_handleInputChange(t){let{target:e}=t;if(this._isCheckbox()?(e.checked?this.formElement.value="bool:True":this.formElement.value="bool:False",this.checked=e.checked):this.value=e.value,this._isRange()){let o=this.querySelector("label"),n=this.getAttribute("lbl-label")||"";o&&n&&(o.textContent=`${n} (${e.value})`)}this._handleValidation()}_isCheckbox(){return this.formElement?.type==="checkbox"}_isRange(){return this.formElement?.type==="range"}_wireEvents(){super._wireEvents(),this.formElement&&(this.formElement.addEventListener("input",this._handleInputChange.bind(this)),this.formElement.addEventListener("change",this._handleInputChange.bind(this)))}_unWireEvents(){super._unWireEvents(),this.formElement&&(this.formElement.removeEventListener("input",this._handleInputChange.bind(this)),this.formElement.removeEventListener("change",this._handleInputChange.bind(this)))}};var B=class extends h{static get observedAttributes(){return["id","class","items","allow-many"]}constructor(){super(),this._items=[];let t=this.querySelector(".wc-accordion");t?this.componentElement=t:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-accordion"),this.appendChild(this.componentElement)),console.log("ctor:wc-accordion")}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents(),console.log("connectedCallback:wc-accordion")}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(t,e){t==="items"?(typeof e=="string"&&(this._items=JSON.parse(e)),this.removeAttribute("items")):t==="allow-many"||super._handleAttributeChange(t,e)}_render(){super._render();let t=this.querySelectorAll(".wc-accordion > *");t.length>0?(this.componentElement.innerHTML="",t.forEach(e=>this.componentElement.appendChild(e))):(this._moveDeclarativeOptions(),this.componentElement.innerHTML="",this._items.forEach(e=>{let o=this._createHeader(e.label,e.selected);this.componentElement.appendChild(o);let n=this._createPanel(e.content);this.componentElement.appendChild(n)})),this._setActive(),typeof htmx<"u"&&htmx.process(this),console.log("_render:wc-accordion")}_createHeader(t,e){let o=this.hasAttribute("allow-many"),n=document.createElement("button");return n.classList.add("accordion-header"),o?n.setAttribute("_",`on click
    ...
    `.trim();this.loadStyle("wc-background-image-style",t)}_unWireEvents(){super._unWireEvents()}};customElements.define("wc-background-image",P);if(!customElements.get("wc-breadcrumb")){class l extends h{static get observedAttributes(){return["id","class"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this._createElement(),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,o){e==="items"||super._handleAttributeChange(e,o)}_getBreadcrumbItems(){let e=[{label:"",link:"/v/home"},{label:"Screens",link:"/v/screen_list/list"},{label:"screen",link:""}],o=[],n=this.querySelectorAll("wc-breadcrumb-item");return Array.from(n).forEach(i=>{let s=i.getAttribute("label")||"",r=i.getAttribute("link")||"";o.push({label:s,link:r})}),o}_createElement(){let e=[],o=this._getBreadcrumbItems();o.forEach((i,s)=>{s==0?e.push(`
      ...
      `.trim()}_unWireEvents(){super._unWireEvents()}}customElements.define("wc-breadcrumb",l)}if(!customElements.get("wc-breadcrumb-item")){class l extends h{static get observedAttributes(){return["id","class"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb-item")}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,o){e==="items"||super._handleAttributeChange(e,o)}_createElement(){this.componentElement.id="breadcrumb-item",this.componentElement.className="wc-breadcrumb-item flex flex-row px-2 gap-4",this.componentElement.innerHTML=`
        <a href="/v/home"
           hx-get="/v/home"
           hx-target="#viewport"
           hx-swap="innerHTML transition:true"
    ...
    `.trim();this.loadStyle("wc-div-style",t)}_unWireEvents(){super._unWireEvents()}};customElements.define("wc-div",F);var O=class extends h{static get observedAttributes(){return["id","class","label","mode","format"]}constructor(){super(),this.clickModes=["search","click"],this.mode=this.getAttribute("mode")||"click";let t=this.querySelector(".wc-dropdown");t?this.componentElement=t:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-dropdown",this.mode),this.appendChild(this.componentElement)),console.log("ctor:wc-dropdown")}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents(),console.log("connectedCallback:wc-dropdown")}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(t,e){t==="label"||super._handleAttributeChange(t,e)}_render(){if(super._render(),this.querySelector(".wc-dropdown > *")){let e=this.querySelector(".dropbtn");if(this.clickModes.includes(this.mode)){e.addEventListener("click",this._handleClick.bind(this)),window.addEventListener("click",this._handleWindowClick.bind(this));let o=this.querySelector(".search");o&&o.addEventListener("input",this._handleInput.bind(this))}}else this.componentElement.innerHTML="",this._createInnerElement();typeof htmx<"u"&&htmx.process(this),console.log("_render:wc-dropdown")}_createInnerElement(){let t=this.getAttribute("id")||"",e=this.getAttribute("position-area")||"bottom span-left",o=this.getAttribute("position-try-fallbacks")||"--bottom-right, --bottom-left, --top-right, --top-left, --right, --left",n=this.getAttribute("label")||"",i=this.getAttribute("format")||"standard",s=this.getAttribute("dropdown-height")||"",r=document.createElement("button");n&&i==="standard"?(r.classList.add("dropbtn"),r.textContent=n):i==="grid-round"?(r.classList.add("dropbtn"),r.classList.add("grid-round"),r.innerHTML=`
        ...
        `):i==="avatar"&&(r.classList.add("dropbtn"),r.classList.add("avatar"),r.innerHTML=`
          <svg class="h-4 w-4 align-middle pointer-events-none" fill="currentColor" viewBox="0 0 24 24">
            <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />
          </svg>
        `);let a=document.createElement("div");a.classList.add("dropdown");let c=document.createElement("div");if(c.classList.add("dropdown-content"),this.mode==="search"){let w=document.createElement("input");w.classList.add("search","component"),w.type="search",w.setAttribute("placeholder","Search..."),c.appendChild(w);let v="http://www.w3.org/2000/svg",g=document.createElementNS(v,"svg");g.setAttribute("xmlns",v),g.setAttribute("fill","none"),g.setAttribute("viewBox","0 0 24 24"),g.setAttribute("stroke-width","1.5"),g.setAttribute("stroke","currentColor"),g.classList.add("h-4","w-4","component");let y=document.createElementNS(v,"path");y.setAttribute("stroke-linecap","round"),y.setAttribute("stroke-linejoin","round"),y.setAttribute("d","m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z"),g.appendChild(y),c.appendChild(g),w.addEventListener("input",this._handleInput.bind(this))}this.querySelectorAll("*").forEach(w=>c.appendChild(w)),a.appendChild(c),a.append(r),this.componentElement.append(a),s&&(c.style.height=s,c.style.overflow="auto"),this.clickModes.includes(this.mode)&&(r.addEventListener("click",this._handleClick.bind(this)),window.addEventListener("click",this._handleWindowClick.bind(this)));let u=this.querySelector(".wc-dropdown");u.style.anchorName=`--${t}-anchor`;let b=this.querySelector(".wc-dropdown .dropdown-content");b.style.positionAnchor=`--${t}-anchor`,b.style.positionArea=e,b.style.positionTryFallbacks=o,b.style.minWidth=`${u.offsetWidth}px`}_handleHelper(t,e="open"){let{detail:o}=t,{selector:n}=o,i=".wc-dropdown",s=Array.isArray(n);if(typeof n=="string"||s)document.querySelectorAll(n).forEach(a=>{if(a===this){let c=a?.querySelector(i);e==="open"?c?.classList.add("show"):e==="close"?c?.classList.remove("show"):e==="toggle"&&c?.classList.toggle("show")}});else{let r=n?.querySelector(i);e==="open"?r?.classList.add("show"):e==="close"?r?.classList.remove("show"):e==="toggle"&&r?.classList.toggle("show")}}_handleOpen(t){this._handleHelper(t,"open")}_handleClose(t){this._handleHelper(t,"close")}_handleToggle(t){this._handleHelper(t,"toggle")}_handleClick(t){let{target:e}=t;e.closest(".wc-dropdown").classList.toggle("show")}_handleWindowClick(t){let{target:e}=t;if(e.matches(".dropbtn")||e.matches(".search"))return;this.querySelectorAll(".wc-dropdown").forEach(n=>n.classList.remove("show"))}_handleInput(t){let{target:e}=t,o=e.value.toLowerCase();this.querySelectorAll(".dropdown-content > *:not(.component)").forEach(i=>{i.textContent.toLowerCase().includes(o)?i.style.display="block":i.style.display="none"})}_applyStyle(){let t=`
      wc-dropdown {
        display: contents;
      }
    ...
    `.trim();this.loadStyle("wc-menu-style",t)}_wireEvents(){super._wireEvents(),document.body.addEventListener("wc-menu:click",this._handleOnClick.bind(this))}_unWireEvents(){super._unWireEvents(),document.body.removeEventListener("wc-menu:click",this._handleOnClick.bind(this)),this.querySelectorAll(".menu-link").forEach(o=>o.removeEventListener("click",this._handleClick.bind(this))),this.querySelector(".menu-toggle").removeEventListener("click",this._handleMenuToggle.bind(this))}};customElements.define("wc-menu",U);if(!customElements.get("wc-save-button")){class l extends h{static get observedAttributes(){return[]}constructor(){super(),this._items=[];let e=this.querySelector(".wc-save-button");if(e)this.componentElement=e;else{let o=this.getAttribute("id")||"",n=this.getAttribute("save-url")||"";this.componentElement=document.createElement("button"),this.componentElement.id=o,this.removeAttribute("id"),this.componentElement.textContent="Save",this.componentElement.classList.add("wc-save-button"),this.componentElement.setAttribute("hx-target","#viewport"),this.componentElement.setAttribute("hx-swap","innerHTML transition:true"),this.componentElement.setAttribute("hx-indicator","#content-loader"),this.componentElement.setAttribute("hx-post",n),this.removeAttribute("save-url"),this.componentElement.setAttribute("hx-push-url","true"),this.appendChild(this.componentElement)}console.log("ctor:wc-save-button")}async connectedCallback(){this._applyStyle(),this._wireEvents(),console.log("connectedCallback:wc-save-button")}disconnectedCallback(){this._unWireEvents()}_handleAttributeChange(e,o){super._handleAttributeChange(e,o)}_applyStyle(){let e=`
        wc-save-button {
          display: contents;
        }
        .wc-save-button {
      ...
      `.trim();this.loadStyle("wc-save-button-style",e)}_wireEvents(){super._wireEvents()}_unWireEvents(){super._unWireEvents()}}customElements.define("wc-save-button",l)}if(!customElements.get("wc-save-split-button")){class l extends h{static get observedAttributes(){return[]}constructor(){super(),this._items=[];let e=this.querySelector(".wc-save-split-button");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-save-split-button"),this.componentElement.setAttribute("hx-target","#viewport"),this.componentElement.setAttribute("hx-swap","innerHTML transition:true"),this.componentElement.setAttribute("hx-indicator","#content-loader"),this.componentElement.setAttribute("hx-push-url","true"),this.componentElement.setAttribute("hx-boost","true"),this.appendChild(this.componentElement),this._createElement()),console.log("ctor:wc-save-split-button")}async connectedCallback(){this._applyStyle(),this._wireEvents(),console.log("connectedCallback:wc-save-split-button")}disconnectedCallback(){this._unWireEvents()}_createElement(){let e=this.getAttribute("id")||"",o=this.getAttribute("method")||"post",n=this.getAttribute("save-url")||"",i=this.getAttribute("save-new-url")||"",s=this.getAttribute("save-return-url")||"",r=this.getAttribute("position-area")||"bottom span-left",a=this.getAttribute("position-try-fallbacks")||"--bottom-right, --bottom-left, --top-right, --top-left, --right, --left",c=`
      ...
      `.trim();this.loadStyle("wc-save-split-button-style",e)}_wireEvents(){super._wireEvents(),this.querySelector("button.save-btn").addEventListener("click",this._handleClick.bind(this)),this.querySelector("a.save-new-btn").addEventListener("click",this._handleClick.bind(this)),this.querySelector("a.save-return-btn").addEventListener("click",this._handleClick.bind(this))}_unWireEvents(){super._unWireEvents(),this.querySelector("button.save-btn").removeEventListener("click",this._handleClick.bind(this)),this.querySelector("a.save-new-btn").removeEventListener("click",this._handleClick.bind(this)),this.querySelector("a.save-return-btn").removeEventListener("click",this._handleClick.bind(this))}}customElements.define("wc-save-split-button",l)}if(!customElements.get("wc-split-button")){class l extends h{static get observedAttributes(){return["btn-id","btn-class","btn-label","split-class"]}constructor(){super(),this._items=[],this.parts=Array.from(this.children);let e=this.querySelector(".wc-split-button");if(e)this.componentElement=e;else{this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-split-button");let o=this.getAttribute("split-class");o&&o.split(" ").forEach(i=>this.componentElement.classList.add(i)),this.appendChild(this.componentElement),this._createElement()}console.log("ctor:wc-split-button")}async connectedCallback(){this._applyStyle(),this._wireEvents(),console.log("connectedCallback:wc-split-button")}disconnectedCallback(){this._unWireEvents()}_createElement(){let e=this.getAttribute("id")||"",o=this.getAttribute("label")||"",n=this.getAttribute("position-area")||"bottom span-right",i=this.getAttribute("position-try-fallbacks")||"--bottom-right, --bottom-left, --top-right, --top-left, --right, --left",s=`
  ...
  */
  ...
  .tabulator-edit-list-item.tabulator-edit-list-group-level-0:hover {
    ...
    `)}_handleThemeClick(t){let{target:e}=t,o=e.getAttribute("data-theme");this._setTheme(e,o),localStorage.setItem("theme",o.replace("theme-",""))}_setTheme(t,e){this.componentElement.querySelectorAll("button[data-theme]").forEach(n=>{n.classList.remove("selected"),n.innerHTML=""}),t.classList.add("selected"),t.innerHTML=`<svg class="selectmark h-4 w-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
      ...
      }`.trim();this.loadStyle("wc-timeline-style",t)}_unWireEvents(){super._unWireEvents()}_moveDeclarativeOptions(){let t=this.querySelectorAll("option");t.length>0&&(this._items=[]),t.forEach((e,o)=>{let n={label:e.value,content:e.textContent.trim()};this._items.push(n)}),Array.from(t).forEach(e=>e.remove())}};customElements.define("wc-timeline",Q);if(!customElements.get("wc-article-skeleton")){class l extends h{static get observedAttributes(){return["id","class"]}constructor(){super();let e=this.querySelector(".wc-article-skeleton");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this._createElement(),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,o){e==="items"||super._handleAttributeChange(e,o)}_createElement(){this.componentElement.id="article-skeleton",this.componentElement.setAttribute("role","status"),this.componentElement.className="wc-article-skeleton max-w-full m-4 border border-solid card-border-color p-4 space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center",this.componentElement.innerHTML=`
