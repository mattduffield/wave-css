...
`),l=[{pattern:/\b(function|var|let|const|return|if|else|endif|for|endfor|while|switch|case|break|continue|this|new|typeof|instanceof|class|async|await|in)\b/g,className:"cm-js-keyword"},{pattern:/\b(true|false|null|undefined)\b/g,className:"cm-js-atom"},{pattern:/\b\d+(\.\d+)?\b/g,className:"cm-js-number"},{pattern:/(["'`])(?:[^\\]|\\.)*?\1/g,className:"cm-js-string"},{pattern:/[+\-*/%=&|^<>!?:;,.]/g,className:"cm-js-operator"},{pattern:/=>/g,className:"cm-js-keyword"},{pattern:/\b\.[A-Za-z]+/g,className:"cm-js-property"}];r.forEach((c,d)=>{i.markText({line:o+d,ch:0},{line:o+d,ch:c.length},{className:"cm-wc-content"}),l.forEach(({pattern:h,className:m})=>{let u;for(h.lastIndex=0;(u=h.exec(c))!==null;){let f=u.index,g=f+u[0].length;i.markText({line:o+d,ch:f},{line:o+d,ch:g},{className:m})}})})}}customElements.define("wc-code-mirror",a)}var P=class extends p{static get observedAttributes(){return["id","class","gender","contact-name","contact-title"]}constructor(){super();let t=this.querySelector(".wc-contact-card");t?this.componentElement=t:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-contact-card"),this.appendChild(this.componentElement)),console.log("ctor:wc-contact-card")}async connectedCallback(){super.connectedCallback(),this._applyStyle(),console.log("connectedCallback:wc-contact-card")}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(t,e){if(t=="gender"){let o=this.querySelector("img");e=="male"?o.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"):o.setAttribute("src","https://www.w3schools.com/howto/img_avatar2.png")}else if(t=="contact-name"){let o=this.querySelector("div.contact-card-name");o.innerHTML=e}else if(t=="contact-title"){let o=this.querySelector("div.contact-card-title");o.innerHTML=e}else super._handleAttributeChange(t,e)}_render(){super._render(),this.querySelector(".wc-contact-card > *")||(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this),console.log("_render:wc-contact-card")}_createInnerElement(){Array.from(this.children).filter(s=>!s.matches("wc-contact-card")&&!s.matches(".wc-contact-card")).forEach(s=>this.componentElement.appendChild(s));let e=document.createElement("img");e.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"),e.setAttribute("alt","Person"),e.setAttribute("width","100%");let o=document.createElement("div");o.classList.add("contact-card-container");let n=document.createElement("div");n.classList.add("contact-card-name","text-2xl","font-bold"),n.innerHTML="John Doe";let i=document.createElement("div");i.classList.add("contact-card-title","text-lg"),i.innerHTML="Boss",o.appendChild(n),o.appendChild(i),this.componentElement.appendChild(e),this.componentElement.appendChild(o)}_applyStyle(){this.loadStyle("wc-contact-card-style",`
    ...
    `.trim();this.loadStyle("wc-menu-style",t)}_wireEvents(){super._wireEvents(),document.body.addEventListener("wc-menu:click",this._handleOnClick.bind(this))}_unWireEvents(){super._unWireEvents(),document.body.removeEventListener("wc-menu:click",this._handleOnClick.bind(this)),this.querySelectorAll(".menu-link").forEach(o=>o.removeEventListener("click",this._handleClick.bind(this))),this.querySelector(".menu-toggle").removeEventListener("click",this._handleMenuToggle.bind(this))}};customElements.define("wc-menu",K);if(!customElements.get("wc-save-button")){class a extends p{static get observedAttributes(){return[]}constructor(){super(),this._items=[];let e=this.querySelector(".wc-save-button");if(e)this.componentElement=e;else{let o=this.getAttribute("id")||"",n=this.getAttribute("save-url")||"";this.componentElement=document.createElement("button"),this.componentElement.id=o,this.removeAttribute("id"),this.componentElement.textContent="Save",this.componentElement.classList.add("wc-save-button"),this.componentElement.setAttribute("hx-target","#viewport"),this.componentElement.setAttribute("hx-swap","innerHTML transition:true"),this.componentElement.setAttribute("hx-indicator","#content-loader"),this.componentElement.setAttribute("hx-post",n),this.removeAttribute("save-url"),this.componentElement.setAttribute("hx-push-url","true"),this.appendChild(this.componentElement)}console.log("ctor:wc-save-button")}async connectedCallback(){this._applyStyle(),this._wireEvents(),console.log("connectedCallback:wc-save-button")}disconnectedCallback(){this._unWireEvents()}_handleAttributeChange(e,o){super._handleAttributeChange(e,o)}_applyStyle(){let e=`
      ...
      `.trim();this.componentElement.innerHTML=s;let r=this.querySelector(".wc-split-button");r.style.anchorName=`--${e}-anchor`;let l=this.querySelector(".dropdown-content");l.style.positionAnchor=`--${e}-anchor`,l.style.positionArea=n,l.style.positionTryFallbacks=i,l.style.minWidth="calc(100% - 20px",this.parts.forEach(h=>{l.appendChild(h)});let c=this.querySelector(`button#${e}`),d=this.getAttribute("onclick");if(d){let h=new Function(d);c.onclick=h,this.removeAttribute("onclick")}this.removeAttribute("id"),this.removeAttribute("label")}_handleAttributeChange(e,o){super._handleAttributeChange(e,o)}_applyStyle(){let e=`
        wc-split-button {
          display: contents;
        }
        .wc-split-button {
