function De(d){return d.tagName.includes("-")}function Se(){return"xxxx-xxxx-xxxx-xxxx".replace(/[x]/g,()=>(Math.random()*16|0).toString(16))}function k(d){return new Promise((o,e)=>{if(document.querySelector(`link[rel="stylesheet"][href="${d}"]`)){o();return}let t=document.createElement("link");t.rel="stylesheet",t.href=d,t.onload=()=>o(),t.onerror=n=>e(n),document.head.appendChild(t);let i=setInterval(()=>{getComputedStyle(document.body).getPropertyValue("display")&&(clearInterval(i),o())},50)})}function S(d){return new Promise((o,e)=>{if(document.querySelector(`script[src="${d}"]`)){o();return}let t=document.createElement("script");t.src=d,t.onload=o,t.onerror=e,document.head.appendChild(t)})}function A(d,o){return new Promise((e,t)=>{if(document.querySelector(`script[src="${d}"]`)){if(o&&window[o])e();else{let n=setInterval(()=>{window[o]&&(clearInterval(n),e())},50)}return}let i=document.createElement("script");i.src=d,i.onload=()=>{if(o&&!window[o]){let n=setInterval(()=>{window[o]&&(clearInterval(n),e())},50)}else e()},i.onerror=n=>{t(n)},document.head.appendChild(i)})}function L(d,o){return new Promise((e,t)=>{if(document.querySelector(`style#${d}`)){e();return}let i=document.createElement("style");i.id=d,i.textContent=o.trim(),i.onload=e,i.onerror=t,document.head.appendChild(i)})}function Be(d){return new Promise((o,e)=>{if(document.querySelector(`link[href="${d}"]`)){o();return}let t=document.createElement("link");t.rel="stylesheet",t.href=d,t.onload=o,t.onerror=e,document.head.appendChild(t)})}function Pe(d,o){if(d.matches&&d.matches(o))return d;let e=d.querySelector(o);if(e)return e;let t=d.querySelectorAll("*");for(let i of t)if(i.shadowRoot){let n=this.locator(i.shadowRoot,o);if(n)return n}}function He(d,o){let e=[];d.matches&&d.matches(o)&&e.push(d),e.push(...d.querySelectorAll(o));let t=d.querySelectorAll("*");for(let i of t)i.shadowRoot&&e.push(...this.locatorAll(i.shadowRoot,o));return e}function $e(d,o=3e3,e=100){return new Promise((t,i)=>{let n=Date.now(),s=()=>{let a=document.querySelector(d);a&&a.offsetParent!==null?t(a):Date.now()-n>o?i(new Error(`Timeout: Selector "${d}" not found or not visible after ${o}ms`)):setTimeout(s,e)};s()})}function We(d,o){let e=!1;return e=wc.linksLoaded[d]&&wc.scriptsLoaded[o],e}function ze(d=[],o=[],e=5e3,t=100){return new Promise((i,n)=>{let s=Date.now(),a=Array.isArray(d)?d:[d],r=Array.isArray(o)?o:[o],l=()=>{let c=a.length===0||a.every(u=>window.wc?.scriptsLoaded?.[u]===!0),p=r.length===0||r.every(u=>window.wc?.linksLoaded?.[u]===!0);c&&p?i():Date.now()-s>e?n(new Error(`Timeout: Dependencies not available after ${e}ms. Scripts: ${JSON.stringify(a)}, Links: ${JSON.stringify(r)}`)):setTimeout(l,t)};l()})}function Le(d=[],o=3e3){return new Promise((e,t)=>{let i=Date.now(),n=Array.isArray(d)?d:[d],s=()=>{n.every(r=>document.querySelector(r)!==null)?e():Date.now()-i>o?t(new Error(`Timeout: Not all selectors available after ${o}ms. Missing selectors: ${JSON.stringify(n)}`)):requestAnimationFrame(s)};s()})}function je(d,o,e=3e3){return new Promise((t,i)=>{let n=Date.now(),s=()=>{d[o]?t():Date.now()-n>e?i(new Error(`Timeout: ${e}ms. Propery: ${o} not available on element.`)):requestAnimationFrame(s)};s()})}async function W(d){return new Promise(o=>setTimeout(o,d))}function Ie(d){document.querySelector(d).classList.add("hidden")}function Te(d){document.querySelector(d).classList.remove("hidden")}function Me(d,o){Ie(d),Te(o)}async function Oe(d,o,e=3e3,t=500){await Le([d,o],e),await W(t),Me(d,o)}function Fe(d,o,e){try{fetch(d,{method:"GET"}).then(t=>t.text()).then(t=>{o&&o(t)})}catch(t){e&&e(t)}}function Ne(d){if(d){let o={animation:150,draggable:".preview-draggable",onEnd:function(e){let t={e,event:"onEnd",item:e.item,from:e.from,to:e.to,oldIndex:e.oldIndex,newIndex:e.newIndex};wc?.EventHub?.broadcast("sortable:on-end","","",t)}};if(typeof Sortable<"u"){let e=new Sortable(d,o);wc.EventHub.events[d]=e}}}function Ue(d){wc?.EventHub?.events[d].destroy()}function Ge(d,o,e,t){let i=2;o=o-i,e=e-i;let n=t.editor,s=n.getValue(),a=new RegExp(`<wc-form[^>]*id=["']${d}["'][^>]*>([\\s\\S]*?)<\\/wc-form>`),r=s.match(a);if(r){let l=r[1],c=/<div[^>]*class=["'][^"']*preview-draggable[^"']*["'][^>]*>[\s\S]*?<\/div>/g,p=l.match(c)||[];if(p.length===0)return;if(o>=0&&o<p.length&&e>=0&&e<p.length){let m=p.splice(o,1)[0];p.splice(e,0,m)}let u=l.replace(c,()=>p.shift()),h=s.replace(l,u);n.setValue(h)}}function Je(d){let o=-1;return d&&(o=document.querySelectorAll(d).length),o}function Xe(d,o){let e=document.querySelector(d);e&&(o?e.classList.add("htmx-request"):e.classList.remove("htmx-request"))}function Ve(d,o){let t=d.detail.elt.closest("form"),i=t.querySelector(o);if(console.log("-->Attempting to process JSON for selector: ",o,t),i)try{let a=function(r,l=""){for(let c in r)if(Object.prototype.hasOwnProperty.call(r,c)){let p=r[c],u=l?`${l}.${c}`:c;if(p!==null&&typeof p=="object"&&!Array.isArray(p))a(p,u);else if(Array.isArray(p))p.forEach((h,m)=>{if(typeof h=="object"&&h!==null)a(h,`${u}[${m}]`);else{let b=document.createElement("input");b.type="hidden",b.name=`${u}[${m}]`,b.value=h,b.setAttribute("data-json-field","true"),t.appendChild(b),console.log("-->Appending array primitive:",b)}});else{let h=document.createElement("input");h.type="hidden",h.name=u,h.value=p,h.setAttribute("data-json-field","true"),t.appendChild(h),console.log("-->Appending primitive:",h)}}};t.querySelectorAll('input[data-json-field="true"]').forEach(r=>r.remove());let s=JSON.parse(i.value);console.log("-->JSON contents: ",s),a(s,"json_data"),console.log("-->Processing complete for selector: ",o,t)}catch(n){console.error("Error parsing JSON:",n)}}function Re(d,o){if(d==null)return!1;if("const"in o)return d===o.const;if("enum"in o)return Array.isArray(o.enum)&&o.enum.includes(d);if("minimum"in o){let e=typeof d=="number"?d:parseFloat(d);if(isNaN(e)||e<o.minimum)return!1}if("maximum"in o){let e=typeof d=="number"?d:parseFloat(d);if(isNaN(e)||e>o.maximum)return!1}if("minLength"in o&&String(d).length<o.minLength||"maxLength"in o&&String(d).length>o.maxLength)return!1;if("pattern"in o){let e=new RegExp(o.pattern);if(typeof d!="string"||!e.test(d))return!1}return!0}function qe(d,o,e){let t="";if(d?(t=`[data-id="${d}"]`,o&&(t+=` ${o}`)):o&&(t=o),!t)return;let i=document.querySelector(t);if(i)return e&&e in i?i[e]:i.type==="checkbox"?i.checked:i.value}function j(d){let{effect:o,condition:e,tgtDataId:t,tgtSelector:i,tgtProperty:n}=d,{scope:s,schema:a,srcDataId:r,srcSelector:l,srcProperty:c,property:p}=e,u=qe(r,l,c);if(u==null)return;let h=!1;a&&(h=Re(u,a));let m="";t?(m=`[data-id="${t}"]`,i&&(m+=` ${i}`)):i&&(m=i);let b=document.querySelector(m);if(b)switch(o){case"COPY":b[n]=u;break;case"COPY-TOLOWER":b[n]=u.toString().toLowerCase();break;case"COPY-TOLOWER-UNDERSCORE":b[n]=u.toString().toLowerCase().replaceAll(" ","_");break;case"HIDE":b.style.display=h?"none":"";break;case"SHOW":b.style.display=h?"":"none";break;case"DISABLE":b.disabled=h;break;case"ENABLE":b.disabled=!h;break;case"REQUIRE":b.required=!h;break;case"UN-REQUIRE":b.required=h;break;default:console.warn("Unknown rule effect:",o)}}function Ke(d){Array.from(new Set(d.map(e=>e.condition.srcDataId))).forEach(e=>{document.querySelectorAll(`[data-id="${e}"]`).forEach(t=>{let i=Array.from(d).filter(n=>n.condition.srcDataId==e);t.addEventListener("change",()=>{i.forEach(j)}),t.addEventListener("input",()=>{i.forEach(j)})})}),d.forEach(j)}function Ye(d){let o=[];function e(t){!t||typeof t!="object"||(t.rules&&o.push(...t.rules),Array.isArray(t.elements)&&t.elements.forEach(e))}return d.forEach(e),o}function Ze(d){let o=[];function e(t){let i=t.label||"",n=t.scope||"",s=n?`${i} (${n})`:i,a={dataId:t["data-id"],label:s};o.push(a),t.elements&&Array.isArray(t.elements)&&t.elements.forEach(r=>e(r))}return d.forEach(t=>e(t)),o}var O=class{constructor(){this.icons=new Map,this.baseUrl="/dist/assets/icons"}setBaseUrl(o){this.baseUrl=o}register(o,e,t="solid"){let i=`${t}/${o}`,s=new DOMParser().parseFromString(e,"image/svg+xml"),a=s.querySelector("svg"),r=s.querySelectorAll("path"),l={viewBox:a?.getAttribute("viewBox")||"0 0 512 512",paths:Array.from(r).map(c=>({d:c.getAttribute("d"),opacity:c.getAttribute("opacity"),class:c.getAttribute("class"),fill:c.getAttribute("fill")}))};this.icons.set(i,l),window.customElements.get("wc-icon")&&window.customElements.get("wc-icon").registerIcon(o,l,t)}registerBatch(o,e="solid"){Object.entries(o).forEach(([t,i])=>{this.register(t,i,e)})}async loadFromJson(o,e="solid"){try{let i=await(await fetch(o)).json();this.registerBatch(i,e)}catch(t){console.error(`Failed to load icons from ${o}:`,t)}}async preload(o,e="solid"){let t=o.map(async i=>{let n=`${e}/${i}`;if(!this.icons.has(n))try{let s=await fetch(`${this.baseUrl}/${e}/${i}.svg`);if(s.ok){let a=await s.text();this.register(i,a,e)}}catch(s){console.error(`Failed to preload icon ${n}:`,s)}});await Promise.all(t)}get(o,e="solid"){return this.icons.get(`${e}/${o}`)}has(o,e="solid"){return this.icons.has(`${e}/${o}`)}getAll(){return new Map(this.icons)}clear(){this.icons.clear()}},Ae=new O;typeof window<"u"&&(window.wc=window.wc||{},window.wc.iconRegistry=Ae);var F=window.WcIconConfig||{},I={iconBaseUrl:F.iconBaseUrl||"/dist/assets/icons",bundleBaseUrl:F.bundleBaseUrl||"/dist/assets/icon-bundles",preloadBundles:F.preloadBundles||[],setIconBaseUrl(d){this.iconBaseUrl=d.replace(/\/$/,"")},setBundleBaseUrl(d){this.bundleBaseUrl=d.replace(/\/$/,"")},setBaseUrl(d){let o=d.replace(/\/$/,"");this.iconBaseUrl=`${o}/icons`,this.bundleBaseUrl=`${o}/icon-bundles`},setPreloadBundles(d){this.preloadBundles=d}};window.WcIconConfig||(window.WcIconConfig=I);var g=class extends HTMLElement{constructor(){super(),this._wcId=Se(),this.loadCSS=k.bind(this),this.loadScript=S.bind(this),this.loadLibrary=A.bind(this),this.loadStyle=L.bind(this),this.childComponent=null,this.childComponentSelector="",this._pendingAttributes={},this._isConnected=!1,this.componentElement=null,this.formElement=null}get wcId(){return this._wcId}connectedCallback(){this.childComponentSelector?this._waitForChildren(this.childComponentSelector).then(()=>{this._connectedCallback()}):this._connectedCallback()}_connectedCallback(){this._render(),this.dataset.wcId=this.wcId,this.childComponentName?this._waitForChild(()=>this[this.childComponentName]).then(()=>{this._isConnected=!0,this._applyPendingAttributes()}):(this._isConnected=!0,this._applyPendingAttributes())}disconnectedCallback(){}attributeChangedCallback(o,e,t){this._isConnected?this._handleAttributeChange(o,t,e):this._pendingAttributes[o]=t}_applyPendingAttributes(){Object.keys(this._pendingAttributes).forEach(o=>{let e=this._pendingAttributes[o];this._handleAttributeChange(o,e,null)}),this._pendingAttributes={}}_handleAttributeChange(o,e,t){if(o==="name")this._handleNameToIdLinkage(e);else if(o==="elt-class"){let i=this.querySelector("[form-element]");i&&i.setAttribute("class",e)}else o==="class"?e&&e.replace("contents","").split(" ").forEach(s=>{s&&(this.componentElement.classList.add(s),this.classList.remove(s))}):this.componentElement.setAttribute(o,e)}_handleNameToIdLinkage(o){o&&this.formElement&&!this.formElement.hasAttribute("id")&&(this.formElement.setAttribute("id",o),this.formElement.setAttribute("name",o),this.removeAttribute("name"))}_render(){this.classList.add("contents")}async _waitForChild(o){return new Promise(e=>{let t=setInterval(()=>{o()&&(clearInterval(t),e())},50)})}async _waitForChildren(o){let e=Array.from(this.querySelectorAll(o));await Promise.all(e.map(t=>new Promise(i=>{t.isConnected?i():t.addEventListener("connected",i,{once:!0})})))}_applyStyle(){}_wireEvents(){}_unWireEvents(){}};var q=class extends g{static formAssociated=!0;constructor(){super(),this._internals=this.attachInternals(),this._value=""}get value(){return this._isCheckbox()?this.checked:this._value}set value(o){this._isCheckbox()?this.checked=o:(this._value=o,this._internals.setFormValue(this._value))}get required(){return this.hasAttribute("required")}set required(o){o?this.setAttribute("required",""):this.removeAttribute("required")}get checked(){return this.formElement?.checked||!1}set checked(o){this._isCheckbox()&&(this.formElement.checked=o,this._internals.setFormValue(o?"bool:True":"bool:False"))}get validity(){return this._internals.validity}get validationMessage(){return this._internals.validationMessage}get willValidate(){return this._internals.willValidate}checkValidity(){return this._internals.checkValidity()}reportValidity(){return this._internals.reportValidity()}_handleValidation(){let o="";if(o==="span")if(this.formElement?.validity.valid)this.componentElement.querySelector(".error-message")?.remove();else{let e=document.createElement("span");e.classList.add("error-message"),e.textContent=this.formElement?.validationMessage,this.componentElement.appendChild(e)}else if(o==="tooltip")if(this.formElement?.validity.valid)this.formElement?.removeAttribute("data-error"),this.formElement?.setAttribute("title",this.formElement?.getAttribute("data-has-title")),this.formElement?.removeAttribute("data-has-title");else{let e=this.formElement?.validationMessage;this.formElement?.setAttribute("data-error",e),this.formElement?.setAttribute("data-has-title",this.formElement?.getAttribute("title")||""),this.formElement?.setAttribute("title","")}this._internals.setValidity(this.formElement?.validity,this.formElement?.validationMessage)}connectedCallback(){super.connectedCallback(),this.formElement=this.querySelector("input, select, textarea"),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(o,e){o==="value"?this._isCheckbox()?this.checked=e!==null&&e!=="false"&&e!=="bool:False":(this.formElement&&(this.formElement?.setAttribute("value",e),"value"in this.formElement&&(this.formElement.value=e)),this.value=e):super._handleAttributeChange(o,e)}_handleInputChange(o){let{target:e}=o;if(this._isCheckbox()?(e.checked?this.formElement.value="bool:True":this.formElement.value="bool:False",this.checked=e.checked):this.value=e.value,this._isRange()){let t=this.querySelector("label"),i=this.getAttribute("lbl-label")||"";t&&i&&(t.textContent=`${i} (${e.value})`)}this._handleValidation()}_isCheckbox(){return this.formElement?.type==="checkbox"}_isRange(){return this.formElement?.type==="range"}_wireEvents(){super._wireEvents(),this.formElement&&(this.formElement.addEventListener("input",this._handleInputChange.bind(this)),this.formElement.addEventListener("change",this._handleInputChange.bind(this)))}_unWireEvents(){super._unWireEvents(),this.formElement&&(this.formElement.removeEventListener("input",this._handleInputChange.bind(this)),this.formElement.removeEventListener("change",this._handleInputChange.bind(this)))}};if(!customElements.get("wc-accordion")){class d extends g{static get observedAttributes(){return["id","class","items","allow-many"]}constructor(){super(),this._items=[];let e=this.querySelector(".wc-accordion");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-accordion"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"?(typeof t=="string"&&(this._items=JSON.parse(t)),this.removeAttribute("items")):e==="allow-many"||super._handleAttributeChange(e,t)}_render(){super._render();let e=this.querySelectorAll(".wc-accordion > *");e.length>0?(this.componentElement.innerHTML="",e.forEach(t=>this.componentElement.appendChild(t))):(this._moveDeclarativeOptions(),this.componentElement.innerHTML="",this._items.forEach(t=>{let i=this._createHeader(t.label,t.selected);this.componentElement.appendChild(i);let n=this._createPanel(t.content);this.componentElement.appendChild(n)})),this._setActive(),typeof htmx<"u"&&htmx.process(this)}_createHeader(e,t){let i=this.hasAttribute("allow-many"),n=document.createElement("button");return n.classList.add("accordion-header"),t&&n.classList.add("accordion-active"),i?n.setAttribute("_",`on click
    ...
    `.trim();this.loadStyle("wc-background-image-style",o)}_unWireEvents(){super._unWireEvents()}};customElements.define("wc-background-image",N);if(!customElements.get("wc-breadcrumb-item")){class d extends g{static get observedAttributes(){return["id","class"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb-item")}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"||super._handleAttributeChange(e,t)}_createElement(){this.componentElement.id="breadcrumb-item",this.componentElement.className="wc-breadcrumb-item flex flex-row px-2 gap-4",this.componentElement.innerHTML=`
        <a href="/v/home"
           hx-get="/v/home"
           hx-target="#viewport"
      ...
      `.trim()}_unWireEvents(){super._unWireEvents()}}customElements.define("wc-breadcrumb-item",d)}if(!customElements.get("wc-breadcrumb")){class d extends g{static get observedAttributes(){return["id","class","doc-title"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this._createElement(),this.appendChild(this.componentElement)),setTimeout(()=>{let t=[],i=this.getAttribute("doc-title")||"",n=this.querySelectorAll("wc-breadcrumb-item");Array.from(n).forEach(a=>{let r=a.getAttribute("label");r&&t.push(r)});let s=t.join(" > ");s&&(i?document.title=s+" - "+i:document.title=s)},250)}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"||super._handleAttributeChange(e,t)}_getBreadcrumbItems(){let e=[{label:"",link:"/v/home"},{label:"Screens",link:"/v/screen_list/list"},{label:"screen",link:""}],t=[],i=this.querySelectorAll("wc-breadcrumb-item");return Array.from(i).forEach(n=>{let s=n.getAttribute("label")||"",a=n.getAttribute("link")||"";t.push({label:s,link:a})}),t}_createElement(){let e=[],t=this._getBreadcrumbItems();t.forEach((n,s)=>{s==0?e.push(`
            <a href="${n.link}"
              hx-get="${n.link}"
              hx-target="#viewport"
              hx-swap="innerHTML transition:true"
...
`),r=[{pattern:/\b(function|var|let|const|return|if|else|endif|for|endfor|while|switch|case|break|continue|this|new|typeof|instanceof|class|async|await|in)\b/g,className:"cm-js-keyword"},{pattern:/\b(true|false|null|undefined)\b/g,className:"cm-js-atom"},{pattern:/\b\d+(\.\d+)?\b/g,className:"cm-js-number"},{pattern:/(["'`])(?:[^\\]|\\.)*?\1/g,className:"cm-js-string"},{pattern:/[+\-*/%=&|^<>!?:;,.]/g,className:"cm-js-operator"},{pattern:/=>/g,className:"cm-js-keyword"},{pattern:/\b\.[A-Za-z]+/g,className:"cm-js-property"}];a.forEach((l,c)=>{n.markText({line:t+c,ch:0},{line:t+c,ch:l.length},{className:"cm-wc-content"}),r.forEach(({pattern:p,className:u})=>{let h;for(p.lastIndex=0;(h=p.exec(l))!==null;){let m=h.index,b=m+h[0].length;n.markText({line:t+c,ch:m},{line:t+c,ch:b},{className:u})}})})}}customElements.define("wc-code-mirror",d)}var U=class extends g{static get observedAttributes(){return["id","class","gender","contact-name","contact-title"]}constructor(){super();let o=this.querySelector(".wc-contact-card");o?this.componentElement=o:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-contact-card"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(o,e){if(o=="gender"){let t=this.querySelector("img");e=="male"?t.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"):t.setAttribute("src","https://www.w3schools.com/howto/img_avatar2.png")}else if(o=="contact-name"){let t=this.querySelector("div.contact-card-name");t.innerHTML=e}else if(o=="contact-title"){let t=this.querySelector("div.contact-card-title");t.innerHTML=e}else super._handleAttributeChange(o,e)}_render(){super._render(),this.querySelector(".wc-contact-card > *")||(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this)}_createInnerElement(){Array.from(this.children).filter(s=>!s.matches("wc-contact-card")&&!s.matches(".wc-contact-card")).forEach(s=>this.componentElement.appendChild(s));let e=document.createElement("img");e.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"),e.setAttribute("alt","Person"),e.setAttribute("width","100%");let t=document.createElement("div");t.classList.add("contact-card-container");let i=document.createElement("div");i.classList.add("contact-card-name","text-2xl","font-bold"),i.innerHTML="John Doe";let n=document.createElement("div");n.classList.add("contact-card-title","text-lg"),n.innerHTML="Boss",t.appendChild(i),t.appendChild(n),this.componentElement.appendChild(e),this.componentElement.appendChild(t)}_applyStyle(){this.loadStyle("wc-contact-card-style",`
    ...
    `.trim();this.loadStyle("wc-div-style",o)}_unWireEvents(){super._unWireEvents()}};customElements.define("wc-div",J);if(!customElements.get("wc-dropdown-item")){class d extends HTMLElement{constructor(){super(),this.classList.add("contents")}connectedCallback(){}}customElements.define("wc-dropdown-item",d)}var X=class extends g{static get observedAttributes(){return["id","class","label","mode","format","dropdown-class"]}constructor(){super(),this.childComponentSelector="a,hr,wc-input",this.clickModes=["search","click"],this.mode=this.getAttribute("mode")||"click";let o=this.querySelector(".wc-dropdown");o?this.componentElement=o:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-dropdown",this.mode),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),await this._applyStyle(),this.classList.add("contents"),this.classList.remove("hidden"),this.componentElement.classList.remove("hidden"),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(o,e){o==="label"||(o==="dropdown-class"?this._updateDropdownClass(e):super._handleAttributeChange(o,e))}_render(){if(super._render(),this.querySelector(".wc-dropdown > *")){let e=this.querySelector(".dropbtn");if(this.clickModes.includes(this.mode)){e.addEventListener("click",this._handleClick.bind(this)),window.addEventListener("click",this._handleWindowClick.bind(this));let t=this.querySelector(".search");t&&t.addEventListener("input",this._handleInput.bind(this))}}else this.componentElement.innerHTML="",this._createInnerElement();typeof htmx<"u"&&htmx.process(this)}_createInnerElement(){let o=Array.from(this.children).filter(m=>!m.matches("wc-dropdown")&&!m.matches(".wc-dropdown")),e=this.getAttribute("id")||"",t=this.getAttribute("position-area")||"bottom span-left",i=this.getAttribute("position-try-fallbacks")||"--bottom-right, --bottom-left, --top-right, --top-left, --right, --left",n=this.getAttribute("label")||"",s=this.getAttribute("format")||"standard",a=this.getAttribute("dropdown-height")||"",r=document.createElement("button");n&&s==="standard"?(r.classList.add("dropbtn"),r.textContent=n):s==="grid-round"?(r.classList.add("dropbtn"),r.classList.add("grid-round"),r.innerHTML=`
        ...
        `);let l=document.createElement("div");l.classList.add("dropdown");let c=this.getAttribute("dropdown-class");c&&l.classList.add(...c.split(" ").filter(m=>m));let p=document.createElement("div");if(p.classList.add("dropdown-content","text-sm"),this.mode==="search"){let m=document.createElement("input");m.classList.add("search","component"),m.type="search",m.setAttribute("placeholder","Search..."),p.appendChild(m);let b="http://www.w3.org/2000/svg",f=document.createElementNS(b,"svg");f.setAttribute("xmlns",b),f.setAttribute("fill","none"),f.setAttribute("viewBox","0 0 24 24"),f.setAttribute("stroke-width","1.5"),f.setAttribute("stroke","currentColor"),f.classList.add("search-svg","h-4","w-4","component");let v=document.createElementNS(b,"path");v.setAttribute("stroke-linecap","round"),v.setAttribute("stroke-linejoin","round"),v.setAttribute("d","m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z"),f.appendChild(v),p.appendChild(f),m.addEventListener("input",this._handleInput.bind(this))}o.forEach(m=>p.appendChild(m)),l.appendChild(p),l.append(r),this.componentElement.append(l),a&&(p.style.height=a,p.style.overflow="auto"),this.clickModes.includes(this.mode)&&(r.addEventListener("click",this._handleClick.bind(this)),window.addEventListener("click",this._handleWindowClick.bind(this)));let u=this.querySelector(".wc-dropdown");u.style.anchorName=`--${e}-anchor`;let h=this.querySelector(".wc-dropdown .dropdown-content");h.style.positionAnchor=`--${e}-anchor`,h.style.positionArea=t,h.style.positionTryFallbacks=i,h.style.minWidth=`${u.offsetWidth}px`}_handleHelper(o,e="open"){let{detail:t}=o,{selector:i}=t,n=".wc-dropdown",s=Array.isArray(i);if(typeof i=="string"||s)document.querySelectorAll(i).forEach(r=>{if(r===this){let l=r?.querySelector(n);e==="open"?l?.classList.add("show"):e==="close"?l?.classList.remove("show"):e==="toggle"&&l?.classList.toggle("show")}});else{let a=i?.querySelector(n);e==="open"?a?.classList.add("show"):e==="close"?a?.classList.remove("show"):e==="toggle"&&a?.classList.toggle("show")}}_handleOpen(o){this._handleHelper(o,"open")}_handleClose(o){this._handleHelper(o,"close")}_handleToggle(o){this._handleHelper(o,"toggle")}_handleClick(o){let{target:e}=o;e.closest(".wc-dropdown").classList.toggle("show")}_handleWindowClick(o){let{target:e}=o;if(e.matches(".dropbtn")||e.matches(".search")||e.closest(".halt-event"))return;this.querySelectorAll(".wc-dropdown").forEach(n=>n.classList.remove("show"))}_handleInput(o){let{target:e}=o,t=e.value.toLowerCase();this.querySelectorAll(".dropdown-content > *:not(.component)").forEach(n=>{n.textContent.toLowerCase().includes(t)?n.style.display="block":n.style.display="none"})}_updateDropdownClass(o){let e=this.querySelector(".dropdown");e&&(e.className="dropdown",o&&e.classList.add(...o.split(" ").filter(t=>t)))}async _applyStyle(){let o=`
      wc-dropdown {
        /* display: contents; */
      }
  ...
  <template id="rule-template">
    ...
    <swal-param name="allowOutsideClick" value="false" />
      ...
      `.trim();this.componentElement.innerHTML=s;let a=this.querySelector(".wc-split-button");a.style.anchorName=`--${e}-anchor`;let r=this.querySelector(".dropdown-content");r.style.positionAnchor=`--${e}-anchor`,r.style.positionArea=i,r.style.positionTryFallbacks=n,r.style.minWidth="calc(100% - 20px",this.parts.forEach(p=>{r.appendChild(p)});let l=this.querySelector(`button#${e}`),c=this.getAttribute("onclick");if(c){let p=new Function(c);l.onclick=p,this.removeAttribute("onclick")}this.removeAttribute("id"),this.removeAttribute("label")}_handleAttributeChange(e,t){super._handleAttributeChange(e,t)}_applyStyle(){let e=`
        wc-split-button {
          display: contents;
        }
        .wc-split-button {
  ...
  `.trim();this.loadStyle("wc-slideshow-style",e)}_wireEvents(){super._wireEvents(),!this.hasAttribute("data-wired")&&(this.setAttribute("data-wired",!0),setTimeout(()=>{let t=this.querySelector(".prev"),i=this.querySelector(".next"),n=this.querySelector(".play"),s=this.querySelector(".pause");t.addEventListener("click",this._prevSlide.bind(this)),i.addEventListener("click",this._nextSlide.bind(this)),n.addEventListener("click",this._handleStart.bind(this)),s.addEventListener("click",this._handleStop.bind(this)),this._startSlideshow()},50),document.addEventListener("visibilitychange",this._handleVisibilityChange.bind(this)),document.body.addEventListener("wc-slideshow:next",this._handleNext.bind(this)),document.body.addEventListener("wc-slideshow:prev",this._handlePrev.bind(this)),document.body.addEventListener("wc-slideshow:start",this._handleStart.bind(this)),document.body.addEventListener("wc-slideshow:stop",this._handleStop.bind(this)))}_unWireEvents(){super._unWireEvents(),document.removeEventListener("visibilitychange",this._handleVisibilityChange.bind(this)),document.body.removeEventListener("wc-slideshow:next",this._handleNext.bind(this)),document.body.removeEventListener("wc-slideshow:prev",this._handlePrev.bind(this)),document.body.removeEventListener("wc-slideshow:start",this._handleStart.bind(this)),document.body.removeEventListener("wc-slideshow:stop",this._handleStop.bind(this));let e=this.querySelector(".prev"),t=this.querySelector(".next"),i=this.querySelector(".play"),n=this.querySelector(".pause");e?.removeEventListener("click",this._prevSlide.bind(this)),t?.removeEventListener("click",this._nextSlide.bind(this)),i?.removeEventListener("click",this._handleStart.bind(this)),n?.removeEventListener("click",this._handleStop.bind(this))}}customElements.define("wc-slideshow",d)}var Q=class extends g{static get observedAttributes(){return["id","class","label","active"]}constructor(){super();let o=this.querySelector(".wc-tab-item");o?this.componentElement=o:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-tab-item"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(o,e){o==="test"||super._handleAttributeChange(o,e)}_render(){super._render(),this.querySelector(".wc-tab-item > *")||(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this)}_createInnerElement(){Array.from(this.children).filter(e=>!e.matches("wc-tab-item")&&!e.matches(".wc-tab-item")).forEach(e=>{this.componentElement.appendChild(e)})}_applyStyle(){let o=`
    ...
    `.trim();this.loadStyle("wc-tab-item-style",o)}_unWireEvents(){super._unWireEvents()}};customElements.define("wc-tab-item",Q);var ee=class extends g{static get observedAttributes(){return["id","class","animate","vertical"]}constructor(){super(),this.childComponentSelector="wc-tab-item";let o=this.querySelector(".wc-tab");o?this.componentElement=o:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-tab"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(o,e){o==="animate"||o==="vertical"||super._handleAttributeChange(o,e)}_render(){super._render(),this.querySelector(".wc-tab > *")?this.querySelectorAll(".tab-link").forEach(t=>t.addEventListener("click",this._handleClick.bind(this))):(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this),setTimeout(()=>{location.hash.slice(1).split("+").forEach(t=>{this.querySelector(`button[data-label="${decodeURI(t)}"]`)?.click()})},100)}_createInnerElement(){let o=document.createElement("div");o.classList.add("tab-nav");let e=document.createElement("div");e.classList.add("tab-body");let t=Array.from(this.children).filter(i=>!i.matches("wc-tab")&&!i.matches(".wc-tab"));t.forEach((i,n)=>{let s=i.querySelector(".wc-tab-item"),a=document.createElement("button");a.type="button",a.classList.add("tab-link"),a.addEventListener("click",this._handleClick.bind(this)),s?.classList.contains("active")&&a.classList.add("active"),a.textContent=i.getAttribute("label")||`Label ${n+1}`,a.dataset.label=i.getAttribute("label")||`Label ${n+1}`,o.appendChild(a)}),t.forEach(i=>{e.appendChild(i)}),this.componentElement.appendChild(o),this.componentElement.appendChild(e)}_handleHelper(o,e="click"){let{detail:t}=o,{selector:i,subSelector:n}=t,s=Array.isArray(i);typeof i=="string"||s?document.querySelectorAll(i).forEach(r=>{r===this&&e==="click"&&this.querySelector(n)?.click()}):i===this&&e==="click"&&this.querySelector(n)?.click()}_handleOnClick(o){this._handleHelper(o,"click")}_handleClick(o){o.stopPropagation(),o.preventDefault();let{target:e}=o;e.closest(".wc-tab").querySelectorAll(".active").forEach(l=>{l.closest("wc-tab")==this&&l.classList.remove("active")}),e.classList.add("active");let n=e.textContent,s=this.querySelector(`.wc-tab-item[label='${n}']`);s.classList.add("active");let a={detail:{label:n}},r=new CustomEvent("tabchange",a);s.dispatchEvent(r),location.hash=this._buildActiveTabStringFromRoot(e)}_buildActiveTabStringFromRoot(o){function e(s){let a=s.closest("wc-tab"),r=a;for(;a;){let l=a.parentElement?.closest("wc-tab");if(!l){r=a;break}a=l}return r}function t(s){let a=[],r=s.querySelector(":scope > .wc-tab > .tab-nav");if(r){let c=Array.from(r.querySelectorAll(":scope > button.active"));for(let p of c)a.push(p.textContent.trim())}let l=Array.from(s.querySelectorAll(":scope > .wc-tab > .tab-body > wc-tab-item > .wc-tab-item.active > wc-tab"));for(let c of l)a=a.concat(t(c));return a}let i=e(o);return i?t(i).join("+"):""}_applyStyle(){let o=`
      wc-tab {
        display: contents;
      }
      wc-tab .wc-tab {
