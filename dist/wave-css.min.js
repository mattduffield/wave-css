function je(d){return d.tagName.includes("-")}function Pe(){return"xxxx-xxxx-xxxx-xxxx".replace(/[x]/g,()=>(Math.random()*16|0).toString(16))}function I(d){return new Promise((i,e)=>{if(document.querySelector(`link[rel="stylesheet"][href="${d}"]`)){i();return}let t=document.createElement("link");t.rel="stylesheet",t.href=d,t.onload=()=>i(),t.onerror=n=>e(n),document.head.appendChild(t);let o=setInterval(()=>{getComputedStyle(document.body).getPropertyValue("display")&&(clearInterval(o),i())},50)})}function T(d){return new Promise((i,e)=>{if(document.querySelector(`script[src="${d}"]`)){i();return}let t=document.createElement("script");t.src=d,t.onload=i,t.onerror=e,document.head.appendChild(t)})}function M(d,i){return new Promise((e,t)=>{if(document.querySelector(`script[src="${d}"]`)){if(i&&window[i])e();else{let n=setInterval(()=>{window[i]&&(clearInterval(n),e())},50)}return}let o=document.createElement("script");o.src=d,o.onload=()=>{if(i&&!window[i]){let n=setInterval(()=>{window[i]&&(clearInterval(n),e())},50)}else e()},o.onerror=n=>{t(n)},document.head.appendChild(o)})}function S(d,i){return new Promise((e,t)=>{if(document.querySelector(`style#${d}`)){e();return}let o=document.createElement("style");o.id=d,o.textContent=i.trim(),o.onload=e,o.onerror=t,document.head.appendChild(o)})}function Ne(d){return new Promise((i,e)=>{if(document.querySelector(`link[href="${d}"]`)){i();return}let t=document.createElement("link");t.rel="stylesheet",t.href=d,t.onload=i,t.onerror=e,document.head.appendChild(t)})}function Ue(d,i){if(d.matches&&d.matches(i))return d;let e=d.querySelector(i);if(e)return e;let t=d.querySelectorAll("*");for(let o of t)if(o.shadowRoot){let n=this.locator(o.shadowRoot,i);if(n)return n}}function Ge(d,i){let e=[];d.matches&&d.matches(i)&&e.push(d),e.push(...d.querySelectorAll(i));let t=d.querySelectorAll("*");for(let o of t)o.shadowRoot&&e.push(...this.locatorAll(o.shadowRoot,i));return e}function Ve(d,i=3e3,e=100){return new Promise((t,o)=>{let n=Date.now(),s=()=>{let r=document.querySelector(d);r&&r.offsetParent!==null?t(r):Date.now()-n>i?o(new Error(`Timeout: Selector "${d}" not found or not visible after ${i}ms`)):setTimeout(s,e)};s()})}function Je(d,i){let e=!1;return e=wc.linksLoaded[d]&&wc.scriptsLoaded[i],e}function Xe(d=[],i=[],e=5e3,t=100){return new Promise((o,n)=>{let s=Date.now(),r=Array.isArray(d)?d:[d],a=Array.isArray(i)?i:[i],l=()=>{let c=r.length===0||r.every(p=>window.wc?.scriptsLoaded?.[p]===!0),u=a.length===0||a.every(p=>window.wc?.linksLoaded?.[p]===!0);c&&u?o():Date.now()-s>e?n(new Error(`Timeout: Dependencies not available after ${e}ms. Scripts: ${JSON.stringify(r)}, Links: ${JSON.stringify(a)}`)):setTimeout(l,t)};l()})}function He(d=[],i=3e3){return new Promise((e,t)=>{let o=Date.now(),n=Array.isArray(d)?d:[d],s=()=>{n.every(a=>document.querySelector(a)!==null)?e():Date.now()-o>i?t(new Error(`Timeout: Not all selectors available after ${i}ms. Missing selectors: ${JSON.stringify(n)}`)):requestAnimationFrame(s)};s()})}function Ke(d,i,e=3e3){return new Promise((t,o)=>{let n=Date.now(),s=()=>{d[i]?t():Date.now()-n>e?o(new Error(`Timeout: ${e}ms. Propery: ${i} not available on element.`)):requestAnimationFrame(s)};s()})}async function B(d){return new Promise(i=>setTimeout(i,d))}function $e(d){document.querySelector(d).classList.add("hidden")}function ze(d){document.querySelector(d).classList.remove("hidden")}function We(d,i){$e(d),ze(i)}async function Ye(d,i,e=3e3,t=500){await He([d,i],e),await B(t),We(d,i)}function Ze(d,i,e){try{fetch(d,{method:"GET"}).then(t=>t.text()).then(t=>{i&&i(t)})}catch(t){e&&e(t)}}function Qe(d){if(d){let i={animation:150,draggable:".preview-draggable",onEnd:function(e){let t={e,event:"onEnd",item:e.item,from:e.from,to:e.to,oldIndex:e.oldIndex,newIndex:e.newIndex};wc?.EventHub?.broadcast("sortable:on-end","","",t)}};if(typeof Sortable<"u"){let e=new Sortable(d,i);wc.EventHub.events[d]=e}}}function et(d){wc?.EventHub?.events[d].destroy()}function tt(d,i,e,t){let o=2;i=i-o,e=e-o;let n=t.editor,s=n.getValue(),r=new RegExp(`<wc-form[^>]*id=["']${d}["'][^>]*>([\\s\\S]*?)<\\/wc-form>`),a=s.match(r);if(a){let l=a[1],c=/<div[^>]*class=["'][^"']*preview-draggable[^"']*["'][^>]*>[\s\S]*?<\/div>/g,u=l.match(c)||[];if(u.length===0)return;if(i>=0&&i<u.length&&e>=0&&e<u.length){let h=u.splice(i,1)[0];u.splice(e,0,h)}let p=l.replace(c,()=>u.shift()),m=s.replace(l,p);n.setValue(m)}}function it(d){let i=-1;return d&&(i=document.querySelectorAll(d).length),i}function ot(d,i){let e=document.querySelector(d);e&&(i?e.classList.add("htmx-request"):e.classList.remove("htmx-request"))}function nt(d,i){let t=d.detail.elt.closest("form"),o=t.querySelector(i);if(console.log("-->Attempting to process JSON for selector: ",i,t),o)try{let r=function(a,l=""){for(let c in a)if(Object.prototype.hasOwnProperty.call(a,c)){let u=a[c],p=l?`${l}.${c}`:c;if(u!==null&&typeof u=="object"&&!Array.isArray(u))r(u,p);else if(Array.isArray(u))u.forEach((m,h)=>{if(typeof m=="object"&&m!==null)r(m,`${p}[${h}]`);else{let b=document.createElement("input");b.type="hidden",b.name=`${p}[${h}]`,b.value=m,b.setAttribute("data-json-field","true"),t.appendChild(b),console.log("-->Appending array primitive:",b)}});else{let m=document.createElement("input");m.type="hidden",m.name=p,m.value=u,m.setAttribute("data-json-field","true"),t.appendChild(m),console.log("-->Appending primitive:",m)}}};t.querySelectorAll('input[data-json-field="true"]').forEach(a=>a.remove());let s=JSON.parse(o.value);console.log("-->JSON contents: ",s),r(s,"json_data"),console.log("-->Processing complete for selector: ",i,t)}catch(n){console.error("Error parsing JSON:",n)}}function Oe(d,i){if(d==null)return!1;if("const"in i)return d===i.const;if("enum"in i)return Array.isArray(i.enum)&&i.enum.includes(d);if("minimum"in i){let e=typeof d=="number"?d:parseFloat(d);if(isNaN(e)||e<i.minimum)return!1}if("maximum"in i){let e=typeof d=="number"?d:parseFloat(d);if(isNaN(e)||e>i.maximum)return!1}if("minLength"in i&&String(d).length<i.minLength||"maxLength"in i&&String(d).length>i.maxLength)return!1;if("pattern"in i){let e=new RegExp(i.pattern);if(typeof d!="string"||!e.test(d))return!1}return!0}function Fe(d,i,e){let t="";if(d?(t=`[data-id="${d}"]`,i&&(t+=` ${i}`)):i&&(t=i),!t)return;let o=document.querySelector(t);if(o)return e&&e in o?o[e]:o.type==="checkbox"?o.checked:o.value}function K(d){let{effect:i,condition:e,tgtDataId:t,tgtSelector:o,tgtProperty:n}=d,{scope:s,schema:r,srcDataId:a,srcSelector:l,srcProperty:c,property:u}=e,p=Fe(a,l,c);if(p==null)return;let m=!1;r&&(m=Oe(p,r));let h="";t?(h=`[data-id="${t}"]`,o&&(h+=` ${o}`)):o&&(h=o);let b=document.querySelector(h);if(b)switch(i){case"COPY":b[n]=p;break;case"COPY-TOLOWER":b[n]=p.toString().toLowerCase();break;case"COPY-TOLOWER-UNDERSCORE":b[n]=p.toString().toLowerCase().replaceAll(" ","_");break;case"HIDE":b.style.display=m?"none":"";break;case"SHOW":b.style.display=m?"":"none";break;case"DISABLE":b.disabled=m;break;case"ENABLE":b.disabled=!m;break;case"REQUIRE":b.required=!m;break;case"UN-REQUIRE":b.required=m;break;default:console.warn("Unknown rule effect:",i)}}function st(d){Array.from(new Set(d.map(e=>e.condition.srcDataId))).forEach(e=>{document.querySelectorAll(`[data-id="${e}"]`).forEach(t=>{let o=Array.from(d).filter(n=>n.condition.srcDataId==e);t.addEventListener("change",()=>{o.forEach(K)}),t.addEventListener("input",()=>{o.forEach(K)})})}),d.forEach(K)}function rt(d){let i=[];function e(t){!t||typeof t!="object"||(t.rules&&i.push(...t.rules),Array.isArray(t.elements)&&t.elements.forEach(e))}return d.forEach(e),i}function at(d){let i=[];function e(t){let o=t.label||"",n=t.scope||"",s=n?`${o} (${n})`:o,r={dataId:t["data-id"],label:s};i.push(r),t.elements&&Array.isArray(t.elements)&&t.elements.forEach(a=>e(a))}return d.forEach(t=>e(t)),i}var Y=class{constructor(){this.icons=new Map,this.baseUrl="/dist/assets/icons"}setBaseUrl(i){this.baseUrl=i}register(i,e,t="solid"){let o=`${t}/${i}`,s=new DOMParser().parseFromString(e,"image/svg+xml"),r=s.querySelector("svg"),a=s.querySelectorAll("path"),l={viewBox:r?.getAttribute("viewBox")||"0 0 512 512",paths:Array.from(a).map(c=>({d:c.getAttribute("d"),opacity:c.getAttribute("opacity"),class:c.getAttribute("class"),fill:c.getAttribute("fill")}))};this.icons.set(o,l),window.customElements.get("wc-icon")&&window.customElements.get("wc-icon").registerIcon(i,l,t)}registerBatch(i,e="solid"){Object.entries(i).forEach(([t,o])=>{this.register(t,o,e)})}async loadFromJson(i,e="solid"){try{let o=await(await fetch(i)).json();this.registerBatch(o,e)}catch(t){console.error(`Failed to load icons from ${i}:`,t)}}async preload(i,e="solid"){let t=i.map(async o=>{let n=`${e}/${o}`;if(!this.icons.has(n))try{let s=await fetch(`${this.baseUrl}/${e}/${o}.svg`);if(s.ok){let r=await s.text();this.register(o,r,e)}}catch(s){console.error(`Failed to preload icon ${n}:`,s)}});await Promise.all(t)}get(i,e="solid"){return this.icons.get(`${e}/${i}`)}has(i,e="solid"){return this.icons.has(`${e}/${i}`)}getAll(){return new Map(this.icons)}clear(){this.icons.clear()}},Be=new Y;typeof window<"u"&&(window.wc=window.wc||{},window.wc.iconRegistry=Be);var Z=class{constructor(){this._debug=!1,this._dependencies=new Map,this._registeredDependencies=new Set,this._readyPromise=null,this._readyResolve=null,this._readyReject=null,this._dependencyConfigs={IMask:{url:"https://cdnjs.cloudflare.com/ajax/libs/imask/7.6.1/imask.min.js",globalName:"IMask",timeout:1e4},CodeMirror:{urls:["https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.65.5/codemirror.min.css","https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.65.5/codemirror.min.js"],globalName:"CodeMirror",timeout:15e3},Tabulator:{urls:["https://unpkg.com/tabulator-tables@6.3.0/dist/js/tabulator.min.js","https://unpkg.com/tabulator-tables@6.3.0/dist/css/tabulator.min.css"],globalName:"Tabulator",timeout:15e3}},this._initializeReadyPromise()}_log(...i){this._debug&&console.log("[WcDependencyManager]",...i)}setDebug(i){this._debug=i}_initializeReadyPromise(){this._readyPromise=new Promise((i,e)=>{this._readyResolve=i,this._readyReject=e})}register(i){this._registeredDependencies.add(i)}async load(i,e=null){if(this._dependencies.has(i))return this._dependencies.get(i);let t=e||this._dependencyConfigs[i];if(!t){let n=new Error(`Unknown dependency: ${i}. Please provide a configuration.`);return console.error(n),Promise.reject(n)}let o=this._loadDependency(i,t);return this._dependencies.set(i,o),o}async _loadDependency(i,e){if(e.globalName&&window[e.globalName])return this._log(`\u2713 ${i} already loaded`),window[e.globalName];this._log(`\u23F3 Loading ${i}...`);let t=Array.isArray(e.urls)?e.urls:[e.url],o=e.timeout||1e4;try{let n=t.map(s=>this._loadResource(s,o));if(await Promise.all(n),e.globalName&&!window[e.globalName])throw new Error(`${i} loaded but ${e.globalName} not found on window`);return this._log(`\u2713 ${i} loaded successfully`),this._checkIfReady(),e.globalName?window[e.globalName]:!0}catch(n){throw console.error(`\u2717 Failed to load ${i}:`,n),this._dependencies.delete(i),n}}_loadResource(i,e){return new Promise((t,o)=>{let n=setTimeout(()=>{o(new Error(`Timeout loading ${i} after ${e}ms`))},e);if(i.endsWith(".css")){let r=document.createElement("link");r.rel="stylesheet",r.href=i,r.onload=()=>{clearTimeout(n),t()},r.onerror=()=>{clearTimeout(n),o(new Error(`Failed to load CSS: ${i}`))},document.head.appendChild(r)}else{let r=document.createElement("script");r.src=i,r.onload=()=>{clearTimeout(n),t()},r.onerror=()=>{clearTimeout(n),o(new Error(`Failed to load script: ${i}`))},document.head.appendChild(r)}})}_checkIfReady(){if(this._registeredDependencies.size===0)return;if(Array.from(this._registeredDependencies).every(e=>{let t=this._dependencies.get(e),o=this._dependencyConfigs[e];return o&&o.globalName&&window[o.globalName]})&&this._readyResolve){this._log("\u2713 All Wave CSS dependencies ready!"),this._readyResolve(),this._readyResolve=null;let e=0,t=(o="unknown")=>{e++,this._log(`Dispatching wc:ready event #${e} (source: ${o})`),document.dispatchEvent(new CustomEvent("wc:ready",{detail:{dependencies:Array.from(this._registeredDependencies),dispatchCount:e,source:o}}))};this._log("Current document.readyState:",document.readyState),document.readyState==="loading"?(this._log("Waiting for DOMContentLoaded before dispatching wc:ready"),document.addEventListener("DOMContentLoaded",()=>{t("DOMContentLoaded"),setTimeout(()=>t("DOMContentLoaded+50ms"),50),setTimeout(()=>t("DOMContentLoaded+150ms"),150)},{once:!0})):document.readyState==="interactive"?(this._log("DOM interactive, dispatching wc:ready with retries"),setTimeout(()=>t("interactive+0ms"),0),setTimeout(()=>t("interactive+100ms"),100),setTimeout(()=>t("interactive+200ms"),200)):(this._log("DOM complete, dispatching wc:ready with retries"),setTimeout(()=>t("complete+0ms"),0),setTimeout(()=>t("complete+50ms"),50),setTimeout(()=>t("complete+150ms"),150)),window.addEventListener("load",()=>{this._log("window.load fired, dispatching wc:ready"),t("window.load"),setTimeout(()=>t("window.load+100ms"),100)},{once:!0})}}get ready(){return this._readyPromise}get isReady(){return this._registeredDependencies.size===0?!1:Array.from(this._registeredDependencies).every(i=>{let e=this._dependencyConfigs[i];return e&&e.globalName&&window[e.globalName]})}triggerReadyForElement(i){this.isReady&&i.dispatchEvent(new CustomEvent("wc:ready",{bubbles:!1,detail:{dependencies:Array.from(this._registeredDependencies)}}))}isLoaded(i){let e=this._dependencyConfigs[i];return e?e.globalName?!!window[e.globalName]:this._dependencies.has(i):!1}getStatus(){let i={};for(let[e,t]of Object.entries(this._dependencyConfigs))i[e]={registered:this._registeredDependencies.has(e),loaded:this.isLoaded(e),globalAvailable:t.globalName?!!window[t.globalName]:null};return i}addDependency(i,e){this._dependencyConfigs[i]=e}},k=new Z;window.wc||(window.wc={});window.wc.DependencyManager=k;window.wc.ready=k.ready;typeof window<"u"&&document.addEventListener("htmx:afterSettle",d=>{if(k.isReady){let i=d.detail.target;k._log("HTMX afterSettle - dependencies ready, dispatching wc:ready to new content"),k._log("Target element:",i),setTimeout(()=>{k._log("Dispatching wc:ready after hyperscript initialization delay"),i.dispatchEvent(new CustomEvent("wc:ready",{bubbles:!0,detail:{dependencies:Array.from(k._registeredDependencies)}}));let e=i.querySelectorAll("*");k._log(`Dispatching wc:ready to ${e.length} child elements`),e.forEach((t,o)=>{t.dispatchEvent(new CustomEvent("wc:ready",{bubbles:!1,detail:{dependencies:Array.from(k._registeredDependencies)}})),k._debug&&t.tagName==="WC-INPUT"&&t.getAttribute("type")==="tel"&&k._log(`Dispatched wc:ready to phone input [${o}]:`,t.getAttribute("name"))})},100)}else k._log("HTMX afterSettle - dependencies not ready yet")});var Q=window.WcIconConfig||{},D={iconBaseUrl:Q.iconBaseUrl||"/dist/assets/icons",bundleBaseUrl:Q.bundleBaseUrl||"/dist/assets/icon-bundles",preloadBundles:Q.preloadBundles||[],setIconBaseUrl(d){this.iconBaseUrl=d.replace(/\/$/,"")},setBundleBaseUrl(d){this.bundleBaseUrl=d.replace(/\/$/,"")},setBaseUrl(d){let i=d.replace(/\/$/,"");this.iconBaseUrl=`${i}/icons`,this.bundleBaseUrl=`${i}/icon-bundles`},setPreloadBundles(d){this.preloadBundles=d}};window.WcIconConfig||(window.WcIconConfig=D);var g=class extends HTMLElement{constructor(){super(),this._wcId=Pe(),this.loadCSS=I.bind(this),this.loadScript=T.bind(this),this.loadLibrary=M.bind(this),this.loadStyle=S.bind(this),this.childComponent=null,this.childComponentSelector="",this._pendingAttributes={},this._isConnected=!1,this.componentElement=null,this.formElement=null}get wcId(){return this._wcId}connectedCallback(){this.childComponentSelector?this._waitForChildren(this.childComponentSelector).then(()=>{this._connectedCallback()}):this._connectedCallback()}_connectedCallback(){this._render(),this.dataset.wcId=this.wcId,this.childComponentName?this._waitForChild(()=>this[this.childComponentName]).then(()=>{this._isConnected=!0,this._applyPendingAttributes()}):(this._isConnected=!0,this._applyPendingAttributes())}disconnectedCallback(){}attributeChangedCallback(i,e,t){this._isConnected?this._handleAttributeChange(i,t,e):this._pendingAttributes[i]=t}_applyPendingAttributes(){Object.keys(this._pendingAttributes).forEach(i=>{let e=this._pendingAttributes[i];this._handleAttributeChange(i,e,null)}),this._pendingAttributes={}}_handleAttributeChange(i,e,t){if(i==="name")this._handleNameToIdLinkage(e);else if(i==="elt-class"){let o=this.querySelector("[form-element]");o&&o.setAttribute("class",e)}else i==="class"?e&&e.replace("contents","").split(" ").forEach(s=>{s&&(this.componentElement.classList.add(s),this.classList.remove(s))}):this.componentElement.setAttribute(i,e)}_handleNameToIdLinkage(i){i&&this.formElement&&!this.formElement.hasAttribute("id")&&(this.formElement.setAttribute("id",i),this.formElement.setAttribute("name",i),this.removeAttribute("name"))}_render(){this.classList.add("contents")}async _waitForChild(i){return new Promise(e=>{let t=setInterval(()=>{i()&&(clearInterval(t),e())},50)})}async _waitForChildren(i){let e=Array.from(this.querySelectorAll(i));await Promise.all(e.map(t=>new Promise(o=>{t.isConnected?o():t.addEventListener("connected",o,{once:!0})})))}_applyStyle(){}_wireEvents(){}_unWireEvents(){}};var q=class extends g{static formAssociated=!0;constructor(){super(),this._internals=this.attachInternals(),this._value=""}get value(){if(this._isCheckbox())return this.checked;if(this._isRadio()){let i=this.querySelector('input[type="radio"]:checked');return i?i.value:this._value}else return this._value}set value(i){this._isCheckbox()?this.checked=i:this._isRadio()?(this.querySelectorAll('input[type="radio"]').forEach(t=>{t.value===i?t.checked=!0:t.checked=!1}),this._value=i,this._internals.setFormValue(i)):(this._value=i,this._internals.setFormValue(this._value))}get required(){return this.hasAttribute("required")}set required(i){i?this.setAttribute("required",""):this.removeAttribute("required")}get checked(){return this.formElement?.checked||!1}set checked(i){this._isCheckbox()&&(this.formElement.checked=i,this._internals.setFormValue(i?"bool:True":"bool:False"))}get validity(){return this._internals.validity}get validationMessage(){return this._internals.validationMessage}get willValidate(){return this._internals.willValidate}checkValidity(){return this._internals.checkValidity()}reportValidity(){return this._internals.reportValidity()}_handleValidation(){let i="";if(i==="span")if(this.formElement?.validity.valid)this.componentElement.querySelector(".error-message")?.remove();else{let e=document.createElement("span");e.classList.add("error-message"),e.textContent=this.formElement?.validationMessage,this.componentElement.appendChild(e)}else if(i==="tooltip")if(this.formElement?.validity.valid)this.formElement?.removeAttribute("data-error"),this.formElement?.setAttribute("title",this.formElement?.getAttribute("data-has-title")),this.formElement?.removeAttribute("data-has-title");else{let e=this.formElement?.validationMessage;this.formElement?.setAttribute("data-error",e),this.formElement?.setAttribute("data-has-title",this.formElement?.getAttribute("title")||""),this.formElement?.setAttribute("title","")}this._internals.setValidity(this.formElement?.validity,this.formElement?.validationMessage)}connectedCallback(){super.connectedCallback(),this.formElement=this.querySelector("input, select, textarea"),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(i,e){i==="value"?this._isCheckbox()?this.checked=e!==null&&e!=="false"&&e!=="bool:False":(this.formElement&&(this.formElement?.setAttribute("value",e),"value"in this.formElement&&(this.formElement.value=e)),this.value=e):super._handleAttributeChange(i,e)}_handleInputChange(i){let{target:e}=i;if(this._isCheckbox()?(e.checked?this.formElement.value="bool:True":this.formElement.value="bool:False",this.checked=e.checked):this.value=e.value,this._isRange()){let t=this.querySelector("label"),o=this.getAttribute("lbl-label")||"";t&&o&&(t.textContent=`${o} (${e.value})`)}this._handleValidation()}_isCheckbox(){return this.formElement?.type==="checkbox"}_isRadio(){return this.getAttribute("type")==="radio"||this.formElement?.type==="radio"}_isRange(){return this.formElement?.type==="range"}_wireEvents(){super._wireEvents(),this.formElement&&(this.formElement.addEventListener("input",this._handleInputChange.bind(this)),this.formElement.addEventListener("change",this._handleInputChange.bind(this)))}_unWireEvents(){super._unWireEvents(),this.formElement&&(this.formElement.removeEventListener("input",this._handleInputChange.bind(this)),this.formElement.removeEventListener("change",this._handleInputChange.bind(this)))}};if(!customElements.get("wc-accordion")){class d extends g{static get observedAttributes(){return["id","class","items","allow-many"]}constructor(){super(),this._items=[];let e=this.querySelector(".wc-accordion");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-accordion"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"?(typeof t=="string"&&(this._items=JSON.parse(t)),this.removeAttribute("items")):e==="allow-many"||super._handleAttributeChange(e,t)}_render(){super._render();let e=this.querySelectorAll(".wc-accordion > *");e.length>0?(this.componentElement.innerHTML="",e.forEach(t=>this.componentElement.appendChild(t))):(this._moveDeclarativeOptions(),this.componentElement.innerHTML="",this._items.forEach(t=>{let o=this._createHeader(t.label,t.selected);this.componentElement.appendChild(o);let n=this._createPanel(t.content);this.componentElement.appendChild(n)})),this._setActive(),typeof htmx<"u"&&htmx.process(this)}_createHeader(e,t){let o=this.hasAttribute("allow-many"),n=document.createElement("button");return n.type="button",n.classList.add("accordion-header"),t&&n.classList.add("accordion-active"),o?n.setAttribute("_",`on click
    ...
    `.trim();this.loadStyle("wc-background-image-style",i)}_unWireEvents(){super._unWireEvents()}};customElements.define("wc-background-image",ee);if(!customElements.get("wc-breadcrumb-item")){class d extends g{static get observedAttributes(){return["id","class"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb-item")}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"||super._handleAttributeChange(e,t)}_createElement(){this.componentElement.id="breadcrumb-item",this.componentElement.className="wc-breadcrumb-item flex flex-row px-2 gap-4",this.componentElement.innerHTML=`
        <a href="/v/home"
           hx-get="/v/home"
           hx-target="#viewport"
      ...
      `.trim()}_unWireEvents(){super._unWireEvents()}}customElements.define("wc-breadcrumb-item",d)}if(!customElements.get("wc-breadcrumb")){class d extends g{static get observedAttributes(){return["id","class","doc-title"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this._createElement(),this.appendChild(this.componentElement)),setTimeout(()=>{let t=[],o=this.getAttribute("doc-title")||"",n=this.querySelectorAll("wc-breadcrumb-item");Array.from(n).forEach(r=>{let a=r.getAttribute("label");a&&t.push(a)});let s=t.join(" > ");s&&(o?document.title=s+" - "+o:document.title=s)},250)}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"||super._handleAttributeChange(e,t)}_getBreadcrumbItems(){let e=[{label:"",link:"/v/home"},{label:"Screens",link:"/v/screen_list/list"},{label:"screen",link:""}],t=[],o=this.querySelectorAll("wc-breadcrumb-item");return Array.from(o).forEach(n=>{let s=n.getAttribute("label")||"",r=n.getAttribute("link")||"";t.push({label:s,link:r})}),t}_createElement(){let e=[],t=this._getBreadcrumbItems();t.forEach((n,s)=>{s==0?e.push(`
            <a href="${n.link}"
              hx-get="${n.link}"
              hx-target="#viewport"
              hx-swap="innerHTML transition:true"
      ...
      `,e.querySelector("#closeButton").addEventListener("click",this._handleSettingsClose.bind(this),{once:!0}),e.querySelector("#apply-settings").addEventListener("click",this._handleSettingsApply.bind(this),{once:!0}),e.querySelector("#cancel-settings").addEventListener("click",this._handleSettingsClose.bind(this),{once:!0})}_handleSettingsApply(e){let t=this.querySelector(".settings-popover"),o=t.querySelector("#closeButton"),n=t.querySelector("#theme-select").value,s=t.querySelector("#mode-select").value,r=t.querySelector("#line-numbers").checked,a=t.querySelector("#line-wrapper").checked,l=t.querySelector("#fold-gutter").checked,c=t.querySelector("#tab-size").value,u=t.querySelector("#indent-unit").value;this.setAttribute("theme",n),this.setAttribute("mode",s),r?this.setAttribute("line-numbers",""):this.removeAttribute("line-numbers"),a?this.setAttribute("line-wrapper",""):this.removeAttribute("line-wrapper"),l?this.setAttribute("fold-gutter",""):this.removeAttribute("fold-gutter"),this.setAttribute("tab-size",c),this.setAttribute("indent-unit",u),this._handleSettingsClose(e)}_handleSettingsClose(e){e.preventDefault();let t=this.querySelector(".settings-popover");for(t.togglePopover();t.firstChild;)t.removeChild(t.firstChild)}get value(){return this.editor?.getValue()||""}set value(e){this.editor&&(this.editor.setValue(e),this._internals.setFormValue(e))}_applyStyle(){let e=`
