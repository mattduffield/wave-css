...
`),r=[{pattern:/\b(function|var|let|const|return|if|else|endif|for|endfor|while|switch|case|break|continue|this|new|typeof|instanceof|class|async|await|in)\b/g,className:"cm-js-keyword"},{pattern:/\b(true|false|null|undefined)\b/g,className:"cm-js-atom"},{pattern:/\b\d+(\.\d+)?\b/g,className:"cm-js-number"},{pattern:/(["'`])(?:[^\\]|\\.)*?\1/g,className:"cm-js-string"},{pattern:/[+\-*/%=&|^<>!?:;,.]/g,className:"cm-js-operator"},{pattern:/=>/g,className:"cm-js-keyword"},{pattern:/\b\.[A-Za-z]+/g,className:"cm-js-property"}];a.forEach((l,c)=>{n.markText({line:t+c,ch:0},{line:t+c,ch:l.length},{className:"cm-wc-content"}),r.forEach(({pattern:p,className:h})=>{let u;for(p.lastIndex=0;(u=p.exec(l))!==null;){let m=u.index,b=m+u[0].length;n.markText({line:t+c,ch:m},{line:t+c,ch:b},{className:h})}})})}}customElements.define("wc-code-mirror",d)}var G=class extends g{static get observedAttributes(){return["id","class","gender","contact-name","contact-title"]}constructor(){super();let i=this.querySelector(".wc-contact-card");i?this.componentElement=i:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-contact-card"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(i,e){if(i=="gender"){let t=this.querySelector("img");e=="male"?t.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"):t.setAttribute("src","https://www.w3schools.com/howto/img_avatar2.png")}else if(i=="contact-name"){let t=this.querySelector("div.contact-card-name");t.innerHTML=e}else if(i=="contact-title"){let t=this.querySelector("div.contact-card-title");t.innerHTML=e}else super._handleAttributeChange(i,e)}_render(){super._render(),this.querySelector(".wc-contact-card > *")||(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this)}_createInnerElement(){Array.from(this.children).filter(s=>!s.matches("wc-contact-card")&&!s.matches(".wc-contact-card")).forEach(s=>this.componentElement.appendChild(s));let e=document.createElement("img");e.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"),e.setAttribute("alt","Person"),e.setAttribute("width","100%");let t=document.createElement("div");t.classList.add("contact-card-container");let o=document.createElement("div");o.classList.add("contact-card-name","text-2xl","font-bold"),o.innerHTML="John Doe";let n=document.createElement("div");n.classList.add("contact-card-title","text-lg"),n.innerHTML="Boss",t.appendChild(o),t.appendChild(n),this.componentElement.appendChild(e),this.componentElement.appendChild(t)}_applyStyle(){this.loadStyle("wc-contact-card-style",`
    ...
    `.trim();await this.loadStyle("wc-dropdown-style",i)}_wireEvents(){super._wireEvents(),this.clickModes.includes(this.mode)&&(document.body.addEventListener("wc-dropdown:open",this._handleOpen.bind(this)),document.body.addEventListener("wc-dropdown:close",this._handleClose.bind(this)),document.body.addEventListener("wc-dropdown:toggle",this._handleToggle.bind(this))),this._boundReposition=this._repositionOnScroll.bind(this),window.addEventListener("scroll",this._boundReposition,{passive:!0}),window.addEventListener("resize",this._boundReposition,{passive:!0})}_unWireEvents(){if(super._unWireEvents(),this.clickModes.includes(this.mode)){document.body.removeEventListener("wc-dropdown:open",this._handleOpen.bind(this)),document.body.removeEventListener("wc-dropdown:close",this._handleClose.bind(this)),document.body.removeEventListener("wc-dropdown:toggle",this._handleToggle.bind(this)),this.querySelector(".dropbtn").removeEventListener("click",this._handleClick.bind(this)),window.removeEventListener("click",this._handleWindowClick.bind(this));let e=this.querySelector(".search");e&&e.removeEventListener("input",this._handleInput.bind(this))}this._boundReposition&&(window.removeEventListener("scroll",this._boundReposition),window.removeEventListener("resize",this._boundReposition),this._boundReposition=null)}};customElements.define("wc-dropdown",X);var K=class extends g{static get observedAttributes(){return["id","class"]}constructor(){super();let i=this.querySelector(".wc-flip-box");i?this.componentElement=i:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-flip-box"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_render(){if(super._render(),!this.querySelector(".flip-box-inner")){this.componentElement.innerHTML="";let e=this._createInnerElement();this.componentElement.appendChild(e)}typeof htmx<"u"&&htmx.process(this)}_createInnerElement(){let i=document.createElement("div");i.classList.add("flip-box-inner");let e=this.querySelector('[slot="front"]'),t=this.querySelector('[slot="back"]');return e&&(e.classList.add("flip-box-front"),i.appendChild(e)),t&&(t.classList.add("flip-box-back"),i.appendChild(t)),this.componentElement.appendChild(i),i}_applyStyle(){let i=`
      ...
      .wc-flip-box .flip-box-back {
        ...
        color: var(--text-1);
        transform: rotateY(180deg);
      }`.trim();this.loadStyle("wc-flip-box-style",i)}_unWireEvents(){super._unWireEvents()}};customElements.define("wc-flip-box",K);console.log("\u{1F5FA}\uFE0F wc-google-map.js loaded - Version 2.0 with HTMX fix");var Y=class d extends g{static get observedAttributes(){return["api-key","lat","lng","address","title","zoom","map-type","center-lat","center-lng","draggable","scrollwheel","disable-default-ui","class","elt-class"]}static isGoogleMapsLoaded=!1;static googleMapsLoadPromise=null;constructor(){super(),this.map=null,this.markers=[],this.infoWindows=[],this.mapElement=null,this.initRetries=0,this.maxInitRetries=10;let i=this.querySelector(".wc-google-map");i?this.componentElement=i:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-google-map"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle();try{await this._ensureGoogleMapsLoaded(),await new Promise(i=>setTimeout(i,100)),await this._initializeMap(),this._setupResizeHandling()}catch(i){console.error("wc-google-map: Error initializing map:",i),this._showError("Failed to load Google Maps. Please check your API key.")}}disconnectedCallback(){super.disconnectedCallback(),this._cleanup()}_handleAttributeChange(i,e){i==="api-key"?this.map&&this._initializeMap():["lat","lng","address","title"].includes(i)?this.map&&this._updateSinglePin():["zoom","map-type","center-lat","center-lng"].includes(i)?this.map&&this._updateMapConfig():super._handleAttributeChange(i,e)}_render(){super._render(),this.mapElement||(this.mapElement=document.createElement("div"),this.mapElement.classList.add("map-container"),this.componentElement.innerHTML="",this.componentElement.appendChild(this.mapElement))}async _ensureGoogleMapsLoaded(){if(window.google&&window.google.maps)return d.isGoogleMapsLoaded=!0,Promise.resolve();if(d.googleMapsLoadPromise)return d.googleMapsLoadPromise;let i=this.getAttribute("api-key");return i?(d.googleMapsLoadPromise=new Promise((e,t)=>{let o=document.createElement("script");o.src=`https://maps.googleapis.com/maps/api/js?key=${i}&libraries=marker&v=weekly`,o.async=!0,o.defer=!0,o.onload=()=>{d.isGoogleMapsLoaded=!0,e()},o.onerror=()=>{t(new Error("Failed to load Google Maps API"))},document.head.appendChild(o)}),d.googleMapsLoadPromise):(console.error("wc-google-map: api-key attribute is required"),Promise.reject("API key is required"))}async _initializeMap(){if(!window.google||!window.google.maps){console.error("wc-google-map: Google Maps API not loaded");return}if(!this.mapElement){console.error("wc-google-map: Map container element not found");return}let i={width:this.mapElement.offsetWidth,height:this.mapElement.offsetHeight,clientWidth:this.mapElement.clientWidth,clientHeight:this.mapElement.clientHeight};if(console.log("wc-google-map: Initializing map..."),console.log("wc-google-map: Container dimensions:",i),i.width===0||i.height===0)if(this.initRetries<this.maxInitRetries){this.initRetries++,console.warn(`wc-google-map: Container has no dimensions, retrying in 200ms... (attempt ${this.initRetries}/${this.maxInitRetries})`),setTimeout(()=>this._initializeMap(),200);return}else{console.error("wc-google-map: Max retries reached, container still has no dimensions"),this._showError("Map container has no dimensions. Please check your layout.");return}this.initRetries=0;let e=parseInt(this.getAttribute("zoom"))||12,t=this.getAttribute("map-type")||"roadmap",o=this.hasAttribute("draggable")?this.getAttribute("draggable")!=="false":!0,n=this.hasAttribute("scrollwheel")?this.getAttribute("scrollwheel")!=="false":!0,s=this.hasAttribute("disable-default-ui"),a={lat:0,lng:0},r=this.getAttribute("center-lat"),l=this.getAttribute("center-lng");if(r&&l)a={lat:parseFloat(r),lng:parseFloat(l)};else{let p=this._getPins();p.length>0&&(a={lat:p[0].lat,lng:p[0].lng})}let c={center:a,zoom:e,mapTypeId:t,draggable:o,scrollwheel:n,disableDefaultUI:s};try{this.map=new google.maps.Map(this.mapElement,c),console.log("wc-google-map: Map created successfully",this.map),this.dispatchEvent(new CustomEvent("map-loaded",{detail:{map:this.map},bubbles:!0})),this._addMapEventListeners(),this._addPins(),console.log("wc-google-map: Initialization complete")}catch(p){console.error("wc-google-map: Error creating map:",p),this._showError("Error creating map: "+p.message)}}_getPins(){let i=[],e=this.getAttribute("lat"),t=this.getAttribute("lng");return e&&t&&i.push({lat:parseFloat(e),lng:parseFloat(t),address:this.getAttribute("address")||"",title:this.getAttribute("title")||this.getAttribute("address")||"Location"}),this.querySelectorAll("option").forEach(n=>{let s=n.getAttribute("data-lat"),a=n.getAttribute("data-lng");s&&a&&i.push({lat:parseFloat(s),lng:parseFloat(a),address:n.getAttribute("data-address")||"",title:n.getAttribute("data-title")||n.getAttribute("data-address")||"Location"})}),i}_addPins(){if(!this.map)return;this._clearMarkers();let i=this._getPins();if(console.log("wc-google-map: Adding pins:",i.length,i),i.length===0){console.warn("wc-google-map: No pins to add");return}if(i.forEach((e,t)=>{let o=new google.maps.Marker({position:{lat:e.lat,lng:e.lng},map:this.map,title:e.title});this.markers.push(o);let n=new google.maps.InfoWindow({content:`<div class="map-info-window">
          ${e.title?`<strong>${e.title}</strong><br>`:""}
          ${e.address||""}
        </div>`});this.infoWindows.push(n),o.addListener("click",()=>{this.infoWindows.forEach(s=>s.close()),n.open(this.map,o),this.dispatchEvent(new CustomEvent("pin-clicked",{detail:{pin:e,marker:o,index:t},bubbles:!0}))})}),i.length>1){let e=new google.maps.LatLngBounds;i.forEach(t=>{e.extend({lat:t.lat,lng:t.lng})}),this.map.fitBounds(e)}}_clearMarkers(){this.markers.forEach(i=>i.setMap(null)),this.markers=[],this.infoWindows.forEach(i=>i.close()),this.infoWindows=[]}_updateSinglePin(){this._addPins()}_updateMapConfig(){if(!this.map)return;let i=parseInt(this.getAttribute("zoom")),e=this.getAttribute("map-type"),t=this.getAttribute("center-lat"),o=this.getAttribute("center-lng");i&&!isNaN(i)&&this.map.setZoom(i),e&&this.map.setMapTypeId(e),t&&o&&this.map.setCenter({lat:parseFloat(t),lng:parseFloat(o)})}_addMapEventListeners(){this.map&&(this.map.addListener("click",i=>{this.dispatchEvent(new CustomEvent("map-clicked",{detail:{lat:i.latLng.lat(),lng:i.latLng.lng(),event:i},bubbles:!0}))}),this.map.addListener("center_changed",()=>{let i=this.map.getCenter();this.dispatchEvent(new CustomEvent("center-changed",{detail:{lat:i.lat(),lng:i.lng()},bubbles:!0}))}),this.map.addListener("zoom_changed",()=>{this.dispatchEvent(new CustomEvent("zoom-changed",{detail:{zoom:this.map.getZoom()},bubbles:!0}))}),this.map.addListener("bounds_changed",()=>{let i=this.map.getBounds();i&&this.dispatchEvent(new CustomEvent("bounds-changed",{detail:{bounds:i},bubbles:!0}))}),this.map.addListener("dragstart",()=>{this.dispatchEvent(new CustomEvent("drag-start",{bubbles:!0}))}),this.map.addListener("drag",()=>{this.dispatchEvent(new CustomEvent("dragging",{bubbles:!0}))}),this.map.addListener("dragend",()=>{this.dispatchEvent(new CustomEvent("drag-end",{bubbles:!0}))}))}addPin(i,e,t,o){let n=document.createElement("option");n.setAttribute("data-lat",i),n.setAttribute("data-lng",e),n.setAttribute("data-address",t||""),n.setAttribute("data-title",o||t||"Location"),this.appendChild(n),this.map&&this._addPins()}clearPins(){this.querySelectorAll("option").forEach(i=>i.remove()),this.removeAttribute("lat"),this.removeAttribute("lng"),this.removeAttribute("address"),this.removeAttribute("title"),this._clearMarkers()}getMap(){return this.map}getMarkers(){return this.markers}_cleanup(){this._clearMarkers(),this.map=null,this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null)}_setupResizeHandling(){this.map&&(typeof ResizeObserver<"u"&&(this.resizeObserver=new ResizeObserver(()=>{this._handleResize()}),this.resizeObserver.observe(this.mapElement)),document.body.addEventListener("htmx:afterSettle",()=>{setTimeout(()=>this._handleResize(),50)}),typeof IntersectionObserver<"u"&&new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&t.intersectionRatio>0&&this._handleResize()})}).observe(this))}_handleResize(){if(!this.map)return;let i=this.mapElement.offsetWidth,e=this.mapElement.offsetHeight;if(i>0&&e>0){google.maps.event.trigger(this.map,"resize");let t=this.map.getCenter();t&&this.map.setCenter(t),console.log("wc-google-map: Map resized",{width:i,height:e})}}_showError(i){this.mapElement&&(this.mapElement.innerHTML=`
