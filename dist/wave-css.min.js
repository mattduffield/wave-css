function je(u){return u.tagName.includes("-")}function Pe(){return"xxxx-xxxx-xxxx-xxxx".replace(/[x]/g,()=>(Math.random()*16|0).toString(16))}function I(u){return new Promise((i,e)=>{if(document.querySelector(`link[rel="stylesheet"][href="${u}"]`)){i();return}let t=document.createElement("link");t.rel="stylesheet",t.href=u,t.onload=()=>i(),t.onerror=n=>e(n),document.head.appendChild(t);let o=setInterval(()=>{getComputedStyle(document.body).getPropertyValue("display")&&(clearInterval(o),i())},50)})}function T(u){return new Promise((i,e)=>{if(document.querySelector(`script[src="${u}"]`)){i();return}let t=document.createElement("script");t.src=u,t.onload=i,t.onerror=e,document.head.appendChild(t)})}function M(u,i){return new Promise((e,t)=>{if(document.querySelector(`script[src="${u}"]`)){if(i&&window[i])e();else{let n=setInterval(()=>{window[i]&&(clearInterval(n),e())},50)}return}let o=document.createElement("script");o.src=u,o.onload=()=>{if(i&&!window[i]){let n=setInterval(()=>{window[i]&&(clearInterval(n),e())},50)}else e()},o.onerror=n=>{t(n)},document.head.appendChild(o)})}function S(u,i){return new Promise((e,t)=>{if(document.querySelector(`style#${u}`)){e();return}let o=document.createElement("style");o.id=u,o.textContent=i.trim(),o.onload=e,o.onerror=t,document.head.appendChild(o)})}function Ne(u){return new Promise((i,e)=>{if(document.querySelector(`link[href="${u}"]`)){i();return}let t=document.createElement("link");t.rel="stylesheet",t.href=u,t.onload=i,t.onerror=e,document.head.appendChild(t)})}function Ue(u,i){if(u.matches&&u.matches(i))return u;let e=u.querySelector(i);if(e)return e;let t=u.querySelectorAll("*");for(let o of t)if(o.shadowRoot){let n=this.locator(o.shadowRoot,i);if(n)return n}}function Ge(u,i){let e=[];u.matches&&u.matches(i)&&e.push(u),e.push(...u.querySelectorAll(i));let t=u.querySelectorAll("*");for(let o of t)o.shadowRoot&&e.push(...this.locatorAll(o.shadowRoot,i));return e}function Ve(u,i=3e3,e=100){return new Promise((t,o)=>{let n=Date.now(),s=()=>{let a=document.querySelector(u);a&&a.offsetParent!==null?t(a):Date.now()-n>i?o(new Error(`Timeout: Selector "${u}" not found or not visible after ${i}ms`)):setTimeout(s,e)};s()})}function Je(u,i){let e=!1;return e=wc.linksLoaded[u]&&wc.scriptsLoaded[i],e}function Xe(u=[],i=[],e=5e3,t=100){return new Promise((o,n)=>{let s=Date.now(),a=Array.isArray(u)?u:[u],r=Array.isArray(i)?i:[i],l=()=>{let c=a.length===0||a.every(h=>window.wc?.scriptsLoaded?.[h]===!0),d=r.length===0||r.every(h=>window.wc?.linksLoaded?.[h]===!0);c&&d?o():Date.now()-s>e?n(new Error(`Timeout: Dependencies not available after ${e}ms. Scripts: ${JSON.stringify(a)}, Links: ${JSON.stringify(r)}`)):setTimeout(l,t)};l()})}function $e(u=[],i=3e3){return new Promise((e,t)=>{let o=Date.now(),n=Array.isArray(u)?u:[u],s=()=>{n.every(r=>document.querySelector(r)!==null)?e():Date.now()-o>i?t(new Error(`Timeout: Not all selectors available after ${i}ms. Missing selectors: ${JSON.stringify(n)}`)):requestAnimationFrame(s)};s()})}function Ke(u,i,e=3e3){return new Promise((t,o)=>{let n=Date.now(),s=()=>{u[i]?t():Date.now()-n>e?o(new Error(`Timeout: ${e}ms. Propery: ${i} not available on element.`)):requestAnimationFrame(s)};s()})}async function B(u){return new Promise(i=>setTimeout(i,u))}function He(u){document.querySelector(u).classList.add("hidden")}function ze(u){document.querySelector(u).classList.remove("hidden")}function We(u,i){He(u),ze(i)}async function Ye(u,i,e=3e3,t=500){await $e([u,i],e),await B(t),We(u,i)}function Ze(u,i,e){try{fetch(u,{method:"GET"}).then(t=>t.text()).then(t=>{i&&i(t)})}catch(t){e&&e(t)}}function Qe(u){if(u){let i={animation:150,draggable:".preview-draggable",onEnd:function(e){let t={e,event:"onEnd",item:e.item,from:e.from,to:e.to,oldIndex:e.oldIndex,newIndex:e.newIndex};wc?.EventHub?.broadcast("sortable:on-end","","",t)}};if(typeof Sortable<"u"){let e=new Sortable(u,i);wc.EventHub.events[u]=e}}}function et(u){wc?.EventHub?.events[u].destroy()}function tt(u,i,e,t){let o=2;i=i-o,e=e-o;let n=t.editor,s=n.getValue(),a=new RegExp(`<wc-form[^>]*id=["']${u}["'][^>]*>([\\s\\S]*?)<\\/wc-form>`),r=s.match(a);if(r){let l=r[1],c=/<div[^>]*class=["'][^"']*preview-draggable[^"']*["'][^>]*>[\s\S]*?<\/div>/g,d=l.match(c)||[];if(d.length===0)return;if(i>=0&&i<d.length&&e>=0&&e<d.length){let p=d.splice(i,1)[0];d.splice(e,0,p)}let h=l.replace(c,()=>d.shift()),m=s.replace(l,h);n.setValue(m)}}function it(u){let i=-1;return u&&(i=document.querySelectorAll(u).length),i}function ot(u,i){let e=document.querySelector(u);e&&(i?e.classList.add("htmx-request"):e.classList.remove("htmx-request"))}function nt(u,i){let t=u.detail.elt.closest("form"),o=t.querySelector(i);if(console.log("-->Attempting to process JSON for selector: ",i,t),o)try{let a=function(r,l=""){for(let c in r)if(Object.prototype.hasOwnProperty.call(r,c)){let d=r[c],h=l?`${l}.${c}`:c;if(d!==null&&typeof d=="object"&&!Array.isArray(d))a(d,h);else if(Array.isArray(d))d.forEach((m,p)=>{if(typeof m=="object"&&m!==null)a(m,`${h}[${p}]`);else{let b=document.createElement("input");b.type="hidden",b.name=`${h}[${p}]`,b.value=m,b.setAttribute("data-json-field","true"),t.appendChild(b),console.log("-->Appending array primitive:",b)}});else{let m=document.createElement("input");m.type="hidden",m.name=h,m.value=d,m.setAttribute("data-json-field","true"),t.appendChild(m),console.log("-->Appending primitive:",m)}}};t.querySelectorAll('input[data-json-field="true"]').forEach(r=>r.remove());let s=JSON.parse(o.value);console.log("-->JSON contents: ",s),a(s,"json_data"),console.log("-->Processing complete for selector: ",i,t)}catch(n){console.error("Error parsing JSON:",n)}}function Oe(u,i){if(u==null)return!1;if("const"in i)return u===i.const;if("enum"in i)return Array.isArray(i.enum)&&i.enum.includes(u);if("minimum"in i){let e=typeof u=="number"?u:parseFloat(u);if(isNaN(e)||e<i.minimum)return!1}if("maximum"in i){let e=typeof u=="number"?u:parseFloat(u);if(isNaN(e)||e>i.maximum)return!1}if("minLength"in i&&String(u).length<i.minLength||"maxLength"in i&&String(u).length>i.maxLength)return!1;if("pattern"in i){let e=new RegExp(i.pattern);if(typeof u!="string"||!e.test(u))return!1}return!0}function Fe(u,i,e){let t="";if(u?(t=`[data-id="${u}"]`,i&&(t+=` ${i}`)):i&&(t=i),!t)return;let o=document.querySelector(t);if(o)return e&&e in o?o[e]:o.type==="checkbox"?o.checked:o.value}function K(u){let{effect:i,condition:e,tgtDataId:t,tgtSelector:o,tgtProperty:n}=u,{scope:s,schema:a,srcDataId:r,srcSelector:l,srcProperty:c,property:d}=e,h=Fe(r,l,c);if(h==null)return;let m=!1;a&&(m=Oe(h,a));let p="";t?(p=`[data-id="${t}"]`,o&&(p+=` ${o}`)):o&&(p=o);let b=document.querySelector(p);if(b)switch(i){case"COPY":b[n]=h;break;case"COPY-TOLOWER":b[n]=h.toString().toLowerCase();break;case"COPY-TOLOWER-UNDERSCORE":b[n]=h.toString().toLowerCase().replaceAll(" ","_");break;case"HIDE":b.style.display=m?"none":"";break;case"SHOW":b.style.display=m?"":"none";break;case"DISABLE":b.disabled=m;break;case"ENABLE":b.disabled=!m;break;case"REQUIRE":b.required=!m;break;case"UN-REQUIRE":b.required=m;break;default:console.warn("Unknown rule effect:",i)}}function st(u){Array.from(new Set(u.map(e=>e.condition.srcDataId))).forEach(e=>{document.querySelectorAll(`[data-id="${e}"]`).forEach(t=>{let o=Array.from(u).filter(n=>n.condition.srcDataId==e);t.addEventListener("change",()=>{o.forEach(K)}),t.addEventListener("input",()=>{o.forEach(K)})})}),u.forEach(K)}function at(u){let i=[];function e(t){!t||typeof t!="object"||(t.rules&&i.push(...t.rules),Array.isArray(t.elements)&&t.elements.forEach(e))}return u.forEach(e),i}function rt(u){let i=[];function e(t){let o=t.label||"",n=t.scope||"",s=n?`${o} (${n})`:o,a={dataId:t["data-id"],label:s};i.push(a),t.elements&&Array.isArray(t.elements)&&t.elements.forEach(r=>e(r))}return u.forEach(t=>e(t)),i}var Y=class{constructor(){this.icons=new Map,this.baseUrl="/dist/assets/icons"}setBaseUrl(i){this.baseUrl=i}register(i,e,t="solid"){let o=`${t}/${i}`,s=new DOMParser().parseFromString(e,"image/svg+xml"),a=s.querySelector("svg"),r=s.querySelectorAll("path"),l={viewBox:a?.getAttribute("viewBox")||"0 0 512 512",paths:Array.from(r).map(c=>({d:c.getAttribute("d"),opacity:c.getAttribute("opacity"),class:c.getAttribute("class"),fill:c.getAttribute("fill")}))};this.icons.set(o,l),window.customElements.get("wc-icon")&&window.customElements.get("wc-icon").registerIcon(i,l,t)}registerBatch(i,e="solid"){Object.entries(i).forEach(([t,o])=>{this.register(t,o,e)})}async loadFromJson(i,e="solid"){try{let o=await(await fetch(i)).json();this.registerBatch(o,e)}catch(t){console.error(`Failed to load icons from ${i}:`,t)}}async preload(i,e="solid"){let t=i.map(async o=>{let n=`${e}/${o}`;if(!this.icons.has(n))try{let s=await fetch(`${this.baseUrl}/${e}/${o}.svg`);if(s.ok){let a=await s.text();this.register(o,a,e)}}catch(s){console.error(`Failed to preload icon ${n}:`,s)}});await Promise.all(t)}get(i,e="solid"){return this.icons.get(`${e}/${i}`)}has(i,e="solid"){return this.icons.has(`${e}/${i}`)}getAll(){return new Map(this.icons)}clear(){this.icons.clear()}},Be=new Y;typeof window<"u"&&(window.wc=window.wc||{},window.wc.iconRegistry=Be);var Z=class{constructor(){this._debug=!1,this._dependencies=new Map,this._registeredDependencies=new Set,this._readyPromise=null,this._readyResolve=null,this._readyReject=null,this._dependencyConfigs={IMask:{url:"https://cdnjs.cloudflare.com/ajax/libs/imask/7.6.1/imask.min.js",globalName:"IMask",timeout:1e4},CodeMirror:{urls:["https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.65.5/codemirror.min.css","https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.65.5/codemirror.min.js"],globalName:"CodeMirror",timeout:15e3},Tabulator:{urls:["https://unpkg.com/tabulator-tables@6.3.0/dist/js/tabulator.min.js","https://unpkg.com/tabulator-tables@6.3.0/dist/css/tabulator.min.css"],globalName:"Tabulator",timeout:15e3}},this._initializeReadyPromise()}_log(...i){this._debug&&console.log("[WcDependencyManager]",...i)}setDebug(i){this._debug=i}_initializeReadyPromise(){this._readyPromise=new Promise((i,e)=>{this._readyResolve=i,this._readyReject=e})}register(i){this._registeredDependencies.add(i)}async load(i,e=null){if(this._dependencies.has(i))return this._dependencies.get(i);let t=e||this._dependencyConfigs[i];if(!t){let n=new Error(`Unknown dependency: ${i}. Please provide a configuration.`);return console.error(n),Promise.reject(n)}let o=this._loadDependency(i,t);return this._dependencies.set(i,o),o}async _loadDependency(i,e){if(e.globalName&&window[e.globalName])return this._log(`\u2713 ${i} already loaded`),window[e.globalName];this._log(`\u23F3 Loading ${i}...`);let t=Array.isArray(e.urls)?e.urls:[e.url],o=e.timeout||1e4;try{let n=t.map(s=>this._loadResource(s,o));if(await Promise.all(n),e.globalName&&!window[e.globalName])throw new Error(`${i} loaded but ${e.globalName} not found on window`);return this._log(`\u2713 ${i} loaded successfully`),this._checkIfReady(),e.globalName?window[e.globalName]:!0}catch(n){throw console.error(`\u2717 Failed to load ${i}:`,n),this._dependencies.delete(i),n}}_loadResource(i,e){return new Promise((t,o)=>{let n=setTimeout(()=>{o(new Error(`Timeout loading ${i} after ${e}ms`))},e);if(i.endsWith(".css")){let a=document.createElement("link");a.rel="stylesheet",a.href=i,a.onload=()=>{clearTimeout(n),t()},a.onerror=()=>{clearTimeout(n),o(new Error(`Failed to load CSS: ${i}`))},document.head.appendChild(a)}else{let a=document.createElement("script");a.src=i,a.onload=()=>{clearTimeout(n),t()},a.onerror=()=>{clearTimeout(n),o(new Error(`Failed to load script: ${i}`))},document.head.appendChild(a)}})}_checkIfReady(){if(this._registeredDependencies.size===0)return;if(Array.from(this._registeredDependencies).every(e=>{let t=this._dependencies.get(e),o=this._dependencyConfigs[e];return o&&o.globalName&&window[o.globalName]})&&this._readyResolve){this._log("\u2713 All Wave CSS dependencies ready!"),this._readyResolve(),this._readyResolve=null;let e=0,t=(o="unknown")=>{e++,this._log(`Dispatching wc:ready event #${e} (source: ${o})`),document.dispatchEvent(new CustomEvent("wc:ready",{detail:{dependencies:Array.from(this._registeredDependencies),dispatchCount:e,source:o}}))};this._log("Current document.readyState:",document.readyState),document.readyState==="loading"?(this._log("Waiting for DOMContentLoaded before dispatching wc:ready"),document.addEventListener("DOMContentLoaded",()=>{t("DOMContentLoaded"),setTimeout(()=>t("DOMContentLoaded+50ms"),50),setTimeout(()=>t("DOMContentLoaded+150ms"),150)},{once:!0})):document.readyState==="interactive"?(this._log("DOM interactive, dispatching wc:ready with retries"),setTimeout(()=>t("interactive+0ms"),0),setTimeout(()=>t("interactive+100ms"),100),setTimeout(()=>t("interactive+200ms"),200)):(this._log("DOM complete, dispatching wc:ready with retries"),setTimeout(()=>t("complete+0ms"),0),setTimeout(()=>t("complete+50ms"),50),setTimeout(()=>t("complete+150ms"),150)),window.addEventListener("load",()=>{this._log("window.load fired, dispatching wc:ready"),t("window.load"),setTimeout(()=>t("window.load+100ms"),100)},{once:!0})}}get ready(){return this._readyPromise}get isReady(){return this._registeredDependencies.size===0?!1:Array.from(this._registeredDependencies).every(i=>{let e=this._dependencyConfigs[i];return e&&e.globalName&&window[e.globalName]})}triggerReadyForElement(i){this.isReady&&i.dispatchEvent(new CustomEvent("wc:ready",{bubbles:!1,detail:{dependencies:Array.from(this._registeredDependencies)}}))}isLoaded(i){let e=this._dependencyConfigs[i];return e?e.globalName?!!window[e.globalName]:this._dependencies.has(i):!1}getStatus(){let i={};for(let[e,t]of Object.entries(this._dependencyConfigs))i[e]={registered:this._registeredDependencies.has(e),loaded:this.isLoaded(e),globalAvailable:t.globalName?!!window[t.globalName]:null};return i}addDependency(i,e){this._dependencyConfigs[i]=e}},k=new Z;window.wc||(window.wc={});window.wc.DependencyManager=k;window.wc.ready=k.ready;typeof window<"u"&&document.addEventListener("htmx:afterSettle",u=>{if(k.isReady){let i=u.detail.target;k._log("HTMX afterSettle - dependencies ready, dispatching wc:ready to new content"),k._log("Target element:",i),setTimeout(()=>{k._log("Dispatching wc:ready after hyperscript initialization delay"),i.dispatchEvent(new CustomEvent("wc:ready",{bubbles:!0,detail:{dependencies:Array.from(k._registeredDependencies)}}));let e=i.querySelectorAll("*");k._log(`Dispatching wc:ready to ${e.length} child elements`),e.forEach((t,o)=>{t.dispatchEvent(new CustomEvent("wc:ready",{bubbles:!1,detail:{dependencies:Array.from(k._registeredDependencies)}})),k._debug&&t.tagName==="WC-INPUT"&&t.getAttribute("type")==="tel"&&k._log(`Dispatched wc:ready to phone input [${o}]:`,t.getAttribute("name"))})},100)}else k._log("HTMX afterSettle - dependencies not ready yet")});var Q=window.WcIconConfig||{},D={iconBaseUrl:Q.iconBaseUrl||"/dist/assets/icons",bundleBaseUrl:Q.bundleBaseUrl||"/dist/assets/icon-bundles",preloadBundles:Q.preloadBundles||[],setIconBaseUrl(u){this.iconBaseUrl=u.replace(/\/$/,"")},setBundleBaseUrl(u){this.bundleBaseUrl=u.replace(/\/$/,"")},setBaseUrl(u){let i=u.replace(/\/$/,"");this.iconBaseUrl=`${i}/icons`,this.bundleBaseUrl=`${i}/icon-bundles`},setPreloadBundles(u){this.preloadBundles=u}};window.WcIconConfig||(window.WcIconConfig=D);var f=class extends HTMLElement{constructor(){super(),this._wcId=Pe(),this.loadCSS=I.bind(this),this.loadScript=T.bind(this),this.loadLibrary=M.bind(this),this.loadStyle=S.bind(this),this.childComponent=null,this.childComponentSelector="",this._pendingAttributes={},this._isConnected=!1,this.componentElement=null,this.formElement=null}get wcId(){return this._wcId}connectedCallback(){this.childComponentSelector?this._waitForChildren(this.childComponentSelector).then(()=>{this._connectedCallback()}):this._connectedCallback()}_connectedCallback(){this._render(),this.dataset.wcId=this.wcId,this.childComponentName?this._waitForChild(()=>this[this.childComponentName]).then(()=>{this._isConnected=!0,this._applyPendingAttributes()}):(this._isConnected=!0,this._applyPendingAttributes())}disconnectedCallback(){}attributeChangedCallback(i,e,t){this._isConnected?this._handleAttributeChange(i,t,e):this._pendingAttributes[i]=t}_applyPendingAttributes(){Object.keys(this._pendingAttributes).forEach(i=>{let e=this._pendingAttributes[i];this._handleAttributeChange(i,e,null)}),this._pendingAttributes={}}_handleAttributeChange(i,e,t){if(i==="name")this._handleNameToIdLinkage(e);else if(i==="elt-class"){let o=this.querySelector("[form-element]");o&&o.setAttribute("class",e)}else i==="class"?e&&e.replace("contents","").split(" ").forEach(s=>{s&&(this.componentElement.classList.add(s),this.classList.remove(s))}):this.componentElement.setAttribute(i,e)}_handleNameToIdLinkage(i){i&&this.formElement&&!this.formElement.hasAttribute("id")&&(this.formElement.setAttribute("id",i),this.formElement.setAttribute("name",i),this.removeAttribute("name"))}_render(){this.classList.add("contents")}async _waitForChild(i){return new Promise(e=>{let t=setInterval(()=>{i()&&(clearInterval(t),e())},50)})}async _waitForChildren(i){let e=Array.from(this.querySelectorAll(i));await Promise.all(e.map(t=>new Promise(o=>{t.isConnected?o():t.addEventListener("connected",o,{once:!0})})))}_applyStyle(){}_wireEvents(){}_unWireEvents(){}};var q=class extends f{static formAssociated=!0;constructor(){super(),this._internals=this.attachInternals(),this._value=""}get value(){if(this._isCheckbox())return this.checked;if(this._isRadio()){let i=this.querySelector('input[type="radio"]:checked');return i?i.value:this._value}else return this._value}set value(i){this._isCheckbox()?this.checked=i:this._isRadio()?(this.querySelectorAll('input[type="radio"]').forEach(t=>{t.value===i?t.checked=!0:t.checked=!1}),this._value=i,this._internals.setFormValue(i)):(this._value=i,this._internals.setFormValue(this._value))}get required(){return this.hasAttribute("required")}set required(i){i?this.setAttribute("required",""):this.removeAttribute("required")}get checked(){return this.formElement?.checked||!1}set checked(i){this._isCheckbox()&&(this.formElement.checked=i,this._internals.setFormValue(i?"bool:True":"bool:False"))}get validity(){return this._internals.validity}get validationMessage(){return this._internals.validationMessage}get willValidate(){return this._internals.willValidate}checkValidity(){return this._internals.checkValidity()}reportValidity(){return this._internals.reportValidity()}_handleValidation(){let i="";if(i==="span")if(this.formElement?.validity.valid)this.componentElement.querySelector(".error-message")?.remove();else{let e=document.createElement("span");e.classList.add("error-message"),e.textContent=this.formElement?.validationMessage,this.componentElement.appendChild(e)}else if(i==="tooltip")if(this.formElement?.validity.valid)this.formElement?.removeAttribute("data-error"),this.formElement?.setAttribute("title",this.formElement?.getAttribute("data-has-title")),this.formElement?.removeAttribute("data-has-title");else{let e=this.formElement?.validationMessage;this.formElement?.setAttribute("data-error",e),this.formElement?.setAttribute("data-has-title",this.formElement?.getAttribute("title")||""),this.formElement?.setAttribute("title","")}this._internals.setValidity(this.formElement?.validity,this.formElement?.validationMessage)}connectedCallback(){super.connectedCallback(),this.formElement=this.querySelector("input, select, textarea"),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(i,e){i==="value"?this._isCheckbox()?this.checked=e!==null&&e!=="false"&&e!=="bool:False":(this.formElement&&(this.formElement?.setAttribute("value",e),"value"in this.formElement&&(this.formElement.value=e)),this.value=e):super._handleAttributeChange(i,e)}_handleInputChange(i){let{target:e}=i;if(this._isCheckbox()?(e.checked?this.formElement.value="bool:True":this.formElement.value="bool:False",this.checked=e.checked):this.value=e.value,this._isRange()){let t=this.querySelector("label"),o=this.getAttribute("lbl-label")||"";t&&o&&(t.textContent=`${o} (${e.value})`)}this._handleValidation()}_isCheckbox(){return this.formElement?.type==="checkbox"}_isRadio(){return this.getAttribute("type")==="radio"||this.formElement?.type==="radio"}_isRange(){return this.formElement?.type==="range"}_wireEvents(){super._wireEvents(),this.formElement&&(this.formElement.addEventListener("input",this._handleInputChange.bind(this)),this.formElement.addEventListener("change",this._handleInputChange.bind(this)))}_unWireEvents(){super._unWireEvents(),this.formElement&&(this.formElement.removeEventListener("input",this._handleInputChange.bind(this)),this.formElement.removeEventListener("change",this._handleInputChange.bind(this)))}};if(!customElements.get("wc-accordion")){class u extends f{static get observedAttributes(){return["id","class","items","allow-many"]}constructor(){super(),this._items=[];let e=this.querySelector(".wc-accordion");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-accordion"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"?(typeof t=="string"&&(this._items=JSON.parse(t)),this.removeAttribute("items")):e==="allow-many"||super._handleAttributeChange(e,t)}_render(){super._render();let e=this.querySelectorAll(".wc-accordion > *");e.length>0?(this.componentElement.innerHTML="",e.forEach(t=>this.componentElement.appendChild(t))):(this._moveDeclarativeOptions(),this.componentElement.innerHTML="",this._items.forEach(t=>{let o=this._createHeader(t.label,t.selected);this.componentElement.appendChild(o);let n=this._createPanel(t.content);this.componentElement.appendChild(n)})),this._setActive(),typeof htmx<"u"&&htmx.process(this)}_createHeader(e,t){let o=this.hasAttribute("allow-many"),n=document.createElement("button");return n.type="button",n.classList.add("accordion-header"),t&&n.classList.add("accordion-active"),o?n.setAttribute("_",`on click
    ...
    `.trim();this.loadStyle("wc-background-image-style",i)}_unWireEvents(){super._unWireEvents()}};customElements.define("wc-background-image",ee);if(!customElements.get("wc-breadcrumb-item")){class u extends f{static get observedAttributes(){return["id","class"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb-item")}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"||super._handleAttributeChange(e,t)}_createElement(){this.componentElement.id="breadcrumb-item",this.componentElement.className="wc-breadcrumb-item flex flex-row px-2 gap-4",this.componentElement.innerHTML=`
      ...
      `.trim()}_unWireEvents(){super._unWireEvents()}}customElements.define("wc-breadcrumb-item",u)}if(!customElements.get("wc-breadcrumb")){class u extends f{static get observedAttributes(){return["id","class","doc-title"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this._createElement(),this.appendChild(this.componentElement)),setTimeout(()=>{let t=[],o=this.getAttribute("doc-title")||"",n=this.querySelectorAll("wc-breadcrumb-item");Array.from(n).forEach(a=>{let r=a.getAttribute("label");r&&t.push(r)});let s=t.join(" > ");s&&(o?document.title=s+" - "+o:document.title=s)},250)}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"||super._handleAttributeChange(e,t)}_getBreadcrumbItems(){let e=[{label:"",link:"/v/home"},{label:"Screens",link:"/v/screen_list/list"},{label:"screen",link:""}],t=[],o=this.querySelectorAll("wc-breadcrumb-item");return Array.from(o).forEach(n=>{let s=n.getAttribute("label")||"",a=n.getAttribute("link")||"";t.push({label:s,link:a})}),t}_createElement(){let e=[],t=this._getBreadcrumbItems();t.forEach((n,s)=>{s==0?e.push(`
            <a href="${n.link}"
              hx-get="${n.link}"
              hx-target="#viewport"
              hx-swap="innerHTML transition:true"
      ...
      `,e.querySelector("#closeButton").addEventListener("click",this._handleSettingsClose.bind(this),{once:!0}),e.querySelector("#apply-settings").addEventListener("click",this._handleSettingsApply.bind(this),{once:!0}),e.querySelector("#cancel-settings").addEventListener("click",this._handleSettingsClose.bind(this),{once:!0})}_handleSettingsApply(e){let t=this.querySelector(".settings-popover"),o=t.querySelector("#closeButton"),n=t.querySelector("#theme-select").value,s=t.querySelector("#mode-select").value,a=t.querySelector("#line-numbers").checked,r=t.querySelector("#line-wrapper").checked,l=t.querySelector("#fold-gutter").checked,c=t.querySelector("#tab-size").value,d=t.querySelector("#indent-unit").value;this.setAttribute("theme",n),this.setAttribute("mode",s),a?this.setAttribute("line-numbers",""):this.removeAttribute("line-numbers"),r?this.setAttribute("line-wrapper",""):this.removeAttribute("line-wrapper"),l?this.setAttribute("fold-gutter",""):this.removeAttribute("fold-gutter"),this.setAttribute("tab-size",c),this.setAttribute("indent-unit",d),this._handleSettingsClose(e)}_handleSettingsClose(e){e.preventDefault();let t=this.querySelector(".settings-popover");for(t.togglePopover();t.firstChild;)t.removeChild(t.firstChild)}get value(){return this.editor?.getValue()||""}set value(e){this.editor&&(this.editor.setValue(e),this._internals.setFormValue(e))}_applyStyle(){let e=`
...
`),o=!1,n="",s=[],a=-1,r=-1;for(let l=0;l<t.length;l++){let c=t[l].trim();if(o){if(c.match(new RegExp(`</${n}>`))){if(r=l,o=!1,a!==-1&&r!==-1){let h=t.slice(a+1,r).join(`
`);this.highlightJavaScript(h,a+1,r)}a=-1,r=-1,n=""}}else{let d=c.match(/<(wc-[a-zA-Z0-9-]+)(?:\s|>)/i);d&&(n=d[1],o=!0,a=l)}}};setTimeout(()=>{e(),this.editor.on("change",()=>{clearTimeout(this._highlightTimeout),this._highlightTimeout=setTimeout(()=>{e()},500)})},100)}highlightJavaScript(e,t,o){let n=this.editor.getDoc();n.findMarks({line:t,ch:0},{line:o,ch:0}).forEach(l=>l.clear());let a=e.split(`
`),r=[{pattern:/\b(function|var|let|const|return|if|else|endif|for|endfor|while|switch|case|break|continue|this|new|typeof|instanceof|class|async|await|in)\b/g,className:"cm-js-keyword"},{pattern:/\b(true|false|null|undefined)\b/g,className:"cm-js-atom"},{pattern:/\b\d+(\.\d+)?\b/g,className:"cm-js-number"},{pattern:/(["'`])(?:[^\\]|\\.)*?\1/g,className:"cm-js-string"},{pattern:/[+\-*/%=&|^<>!?:;,.]/g,className:"cm-js-operator"},{pattern:/=>/g,className:"cm-js-keyword"},{pattern:/\b\.[A-Za-z]+/g,className:"cm-js-property"}];a.forEach((l,c)=>{n.markText({line:t+c,ch:0},{line:t+c,ch:l.length},{className:"cm-wc-content"}),r.forEach(({pattern:d,className:h})=>{let m;for(d.lastIndex=0;(m=d.exec(l))!==null;){let p=m.index,b=p+m[0].length;n.markText({line:t+c,ch:p},{line:t+c,ch:b},{className:h})}})})}}customElements.define("wc-code-mirror",u)}var te=class extends f{static get observedAttributes(){return["id","class","gender","contact-name","contact-title"]}constructor(){super();let i=this.querySelector(".wc-contact-card");i?this.componentElement=i:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-contact-card"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(i,e){if(i=="gender"){let t=this.querySelector("img");e=="male"?t.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"):t.setAttribute("src","https://www.w3schools.com/howto/img_avatar2.png")}else if(i=="contact-name"){let t=this.querySelector("div.contact-card-name");t.innerHTML=e}else if(i=="contact-title"){let t=this.querySelector("div.contact-card-title");t.innerHTML=e}else super._handleAttributeChange(i,e)}_render(){super._render(),this.querySelector(".wc-contact-card > *")||(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this)}_createInnerElement(){Array.from(this.children).filter(s=>!s.matches("wc-contact-card")&&!s.matches(".wc-contact-card")).forEach(s=>this.componentElement.appendChild(s));let e=document.createElement("img");e.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"),e.setAttribute("alt","Person"),e.setAttribute("width","100%");let t=document.createElement("div");t.classList.add("contact-card-container");let o=document.createElement("div");o.classList.add("contact-card-name","text-2xl","font-bold"),o.innerHTML="John Doe";let n=document.createElement("div");n.classList.add("contact-card-title","text-lg"),n.innerHTML="Boss",t.appendChild(o),t.appendChild(n),this.componentElement.appendChild(e),this.componentElement.appendChild(t)}_applyStyle(){this.loadStyle("wc-contact-card-style",`
  ...
  <template id="rule-template">
    ...
    <swal-param name="allowOutsideClick" value="false" />
      ...
      `.trim();this.componentElement.innerHTML=s;let a=this.querySelector(".wc-split-button");a.style.anchorName=`--${e}-anchor`;let r=this.querySelector(".dropdown-content");r.style.positionAnchor=`--${e}-anchor`,r.style.positionArea=o,r.style.positionTryFallbacks=n,r.style.minWidth="calc(100% - 20px",this.parts.forEach(d=>{r.appendChild(d)});let l=this.querySelector(`button#${e}`),c=this.getAttribute("onclick");if(c){let d=new Function(c);l.onclick=d,this.removeAttribute("onclick")}this.removeAttribute("id"),this.removeAttribute("label")}_handleAttributeChange(e,t){super._handleAttributeChange(e,t)}_applyStyle(){let e=`
        wc-split-button {
          display: contents;
        }
        .wc-split-button {
  ...
  `.trim();this.loadStyle("wc-slideshow-style",e)}_wireEvents(){super._wireEvents(),!this.hasAttribute("data-wired")&&(this.setAttribute("data-wired",!0),setTimeout(()=>{let t=this.querySelector(".prev"),o=this.querySelector(".next"),n=this.querySelector(".play"),s=this.querySelector(".pause");t.addEventListener("click",this._prevSlide.bind(this)),o.addEventListener("click",this._nextSlide.bind(this)),n.addEventListener("click",this._handleStart.bind(this)),s.addEventListener("click",this._handleStop.bind(this)),this._startSlideshow()},50),document.addEventListener("visibilitychange",this._handleVisibilityChange.bind(this)),document.body.addEventListener("wc-slideshow:next",this._handleNext.bind(this)),document.body.addEventListener("wc-slideshow:prev",this._handlePrev.bind(this)),document.body.addEventListener("wc-slideshow:start",this._handleStart.bind(this)),document.body.addEventListener("wc-slideshow:stop",this._handleStop.bind(this)))}_unWireEvents(){super._unWireEvents(),document.removeEventListener("visibilitychange",this._handleVisibilityChange.bind(this)),document.body.removeEventListener("wc-slideshow:next",this._handleNext.bind(this)),document.body.removeEventListener("wc-slideshow:prev",this._handlePrev.bind(this)),document.body.removeEventListener("wc-slideshow:start",this._handleStart.bind(this)),document.body.removeEventListener("wc-slideshow:stop",this._handleStop.bind(this));let e=this.querySelector(".prev"),t=this.querySelector(".next"),o=this.querySelector(".play"),n=this.querySelector(".pause");e?.removeEventListener("click",this._prevSlide.bind(this)),t?.removeEventListener("click",this._nextSlide.bind(this)),o?.removeEventListener("click",this._handleStart.bind(this)),n?.removeEventListener("click",this._handleStop.bind(this))}}customElements.define("wc-slideshow",u)}var ue=class extends f{static get observedAttributes(){return["id","class","label","active"]}constructor(){super();let i=this.querySelector(".wc-tab-item");i?this.componentElement=i:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-tab-item"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}activate(){let i=this.getAttribute("label");if(!i)return;let e=this.closest("wc-tab");if(!e)return;let t=e.querySelector(`button.tab-link[data-label="${i}"]`);t&&t.click()}_handleAttributeChange(i,e){i==="label"?this._updateButtonLabel(e):i==="test"||super._handleAttributeChange(i,e)}_updateButtonLabel(i){let e=this.closest("wc-tab");if(!e)return;let o=Array.from(e.querySelectorAll(":scope > .wc-tab > .tab-body > wc-tab-item")).indexOf(this);if(o===-1)return;let s=e.querySelectorAll(":scope > .wc-tab > .tab-nav > button.tab-link")[o];s&&i&&(s.textContent=i,s.dataset.label=i)}_render(){super._render(),this.querySelector(".wc-tab-item > *")||(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this)}_createInnerElement(){Array.from(this.children).filter(e=>!e.matches("wc-tab-item")&&!e.matches(".wc-tab-item")).forEach(e=>{this.componentElement.appendChild(e)})}_applyStyle(){let i=`
    ...
    `.trim();this.loadStyle("wc-tab-item-style",i)}_wireEvents(){super._wireEvents(),this.addEventListener("click",this._handleClick.bind(this))}_unWireEvents(){super._unWireEvents(),this.removeEventListener("click",this._handleClick.bind(this))}_handleClick(i){(i.target===this||i.target===this.componentElement)&&this.activate()}};customElements.define("wc-tab-item",ue);var he=class extends f{static get observedAttributes(){return["id","class","animate","vertical","contrast"]}constructor(){super(),this.childComponentSelector="wc-tab-item",this.nestingLevel=0;let i=this.parentElement;for(;i;){let t=i.closest("wc-tab");if(t)this.nestingLevel++,i=t.parentElement;else break}let e=this.querySelector(".wc-tab");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-tab"),this.appendChild(this.componentElement)),this._updateContrast(this.getAttribute("contrast"))}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(i,e){i==="animate"||i==="vertical"||(i==="contrast"?this._updateContrast(e):super._handleAttributeChange(i,e))}_updateContrast(i){this.removeAttribute("data-contrast"),this.removeAttribute("data-nesting-level"),i&&i!=="auto"?this.setAttribute("data-contrast",i):this.nestingLevel>0&&this.setAttribute("data-nesting-level",this.nestingLevel)}_render(){super._render(),this.querySelector(".wc-tab > *")?this.querySelectorAll(".tab-link").forEach(t=>t.addEventListener("click",this._handleClick.bind(this))):(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this),this._restoreTabsWhenReady()}_createInnerElement(){let i=document.createElement("div");i.classList.add("tab-nav");let e=document.createElement("div");e.classList.add("tab-body");let t=Array.from(this.children).filter(o=>!o.matches("wc-tab")&&!o.matches(".wc-tab"));t.forEach((o,n)=>{let s=o.querySelector(".wc-tab-item"),a=document.createElement("button");a.type="button",a.classList.add("tab-link"),a.addEventListener("click",this._handleClick.bind(this)),s?.classList.contains("active")&&a.classList.add("active"),a.textContent=o.getAttribute("label")||`Label ${n+1}`,a.dataset.label=o.getAttribute("label")||`Label ${n+1}`,i.appendChild(a)}),t.forEach(o=>{e.appendChild(o)}),this.componentElement.appendChild(i),this.componentElement.appendChild(e)}_handleHelper(i,e="click"){let{detail:t}=i,{selector:o,subSelector:n}=t,s=Array.isArray(o);typeof o=="string"||s?document.querySelectorAll(o).forEach(r=>{r===this&&e==="click"&&this.querySelector(n)?.click()}):o===this&&e==="click"&&this.querySelector(n)?.click()}_handleOnClick(i){this._handleHelper(i,"click")}_handleClick(i){i.stopPropagation(),i.preventDefault();let{target:e}=i;e.closest(".wc-tab").querySelectorAll(".active").forEach(c=>{c.closest("wc-tab")==this&&c.classList.remove("active")}),e.classList.add("active");let n=e.dataset.label||e.textContent,s=this.querySelectorAll(":scope > .wc-tab > .tab-nav > button.tab-link"),a=Array.from(s).indexOf(e),l=this.querySelectorAll(":scope > .wc-tab > .tab-body > wc-tab-item")[a];if(l){l.classList.add("active");let c={detail:{label:n},bubbles:!0,composed:!0},d=new CustomEvent("tabchange",c);l.dispatchEvent(d);let h=l.querySelector(":scope > .wc-tab-item");if(h){let m=new CustomEvent("tabchange",c);h.dispatchEvent(m)}}location.hash=this._buildActiveTabStringFromRoot(e)}_buildActiveTabStringFromRoot(i){function e(s){let a=s.closest("wc-tab"),r=a;for(;a;){let l=a.parentElement?.closest("wc-tab");if(!l){r=a;break}a=l}return r}function t(s){let a=[],r=s.querySelector(":scope > .wc-tab > .tab-nav");if(r){let c=Array.from(r.querySelectorAll(":scope > button.active"));for(let d of c)a.push(d.textContent.trim())}let l=Array.from(s.querySelectorAll(":scope > .wc-tab > .tab-body > wc-tab-item > .wc-tab-item.active > wc-tab"));for(let c of l)a=a.concat(t(c));return a}let o=e(i);return o?t(o).join("+"):""}async _restoreTabsWhenReady(){try{let e=Array.from(this.querySelectorAll("*")).filter(t=>t.tagName.toLowerCase().startsWith("wc-"));await Promise.all(e.map(t=>new Promise(o=>{if(t._isConnected||t.isConnected)o();else{let n=setInterval(()=>{(t._isConnected||t.isConnected)&&(clearInterval(n),o())},50);setTimeout(()=>{clearInterval(n),o()},500)}}))),setTimeout(()=>{this._restoreTabsFromHash()},250)}catch(i){console.warn("Error waiting for components:",i),this._restoreTabsFromHash()}}_restoreTabsFromHash(){let i=location.hash.slice(1).split("+"),e=!1;if(i.forEach(t=>{let o=this.querySelector(`button[data-label="${decodeURI(t)}"]`);o&&(o.click(),e=!0)}),!e){let t=this.querySelector(":scope > .wc-tab > .tab-body");if(t){let o=Array.from(t.children).filter(n=>n.tagName.toLowerCase()==="wc-tab-item"&&(n.classList.contains("active")||n.querySelector(":scope > .wc-tab-item.active")));if(o.length>0){let n=o[0].getAttribute("label");this.querySelector(`button[data-label="${n}"]`)?.click()}else{let n=this.querySelector(".tab-nav > .tab-link:first-child");n&&!this.querySelector(".tab-nav > .tab-link.active")&&n.click()}}}}_applyStyle(){let i=`
      wc-tab {
        display: contents;
      }
      wc-tab .wc-tab {
