...
`),r=[{pattern:/\b(function|var|let|const|return|if|else|endif|for|endfor|while|switch|case|break|continue|this|new|typeof|instanceof|class|async|await|in)\b/g,className:"cm-js-keyword"},{pattern:/\b(true|false|null|undefined)\b/g,className:"cm-js-atom"},{pattern:/\b\d+(\.\d+)?\b/g,className:"cm-js-number"},{pattern:/(["'`])(?:[^\\]|\\.)*?\1/g,className:"cm-js-string"},{pattern:/[+\-*/%=&|^<>!?:;,.]/g,className:"cm-js-operator"},{pattern:/=>/g,className:"cm-js-keyword"},{pattern:/\b\.[A-Za-z]+/g,className:"cm-js-property"}];a.forEach((l,c)=>{n.markText({line:t+c,ch:0},{line:t+c,ch:l.length},{className:"cm-wc-content"}),r.forEach(({pattern:p,className:u})=>{let h;for(p.lastIndex=0;(h=p.exec(l))!==null;){let m=h.index,b=m+h[0].length;n.markText({line:t+c,ch:m},{line:t+c,ch:b},{className:u})}})})}}customElements.define("wc-code-mirror",d)}var V=class extends g{static get observedAttributes(){return["id","class","gender","contact-name","contact-title"]}constructor(){super();let i=this.querySelector(".wc-contact-card");i?this.componentElement=i:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-contact-card"),this.appendChild(this.componentElement))}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(i,e){if(i=="gender"){let t=this.querySelector("img");e=="male"?t.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"):t.setAttribute("src","https://www.w3schools.com/howto/img_avatar2.png")}else if(i=="contact-name"){let t=this.querySelector("div.contact-card-name");t.innerHTML=e}else if(i=="contact-title"){let t=this.querySelector("div.contact-card-title");t.innerHTML=e}else super._handleAttributeChange(i,e)}_render(){super._render(),this.querySelector(".wc-contact-card > *")||(this.componentElement.innerHTML="",this._createInnerElement()),typeof htmx<"u"&&htmx.process(this)}_createInnerElement(){Array.from(this.children).filter(s=>!s.matches("wc-contact-card")&&!s.matches(".wc-contact-card")).forEach(s=>this.componentElement.appendChild(s));let e=document.createElement("img");e.setAttribute("src","https://www.w3schools.com/howto/img_avatar.png"),e.setAttribute("alt","Person"),e.setAttribute("width","100%");let t=document.createElement("div");t.classList.add("contact-card-container");let o=document.createElement("div");o.classList.add("contact-card-name","text-2xl","font-bold"),o.innerHTML="John Doe";let n=document.createElement("div");n.classList.add("contact-card-title","text-lg"),n.innerHTML="Boss",t.appendChild(o),t.appendChild(n),this.componentElement.appendChild(e),this.componentElement.appendChild(t)}_applyStyle(){this.loadStyle("wc-contact-card-style",`
    ...
    `.trim();this.loadStyle("wc-google-map-style",i)}};customElements.define("wc-google-map",Q);var O=class d extends T{static get is(){return"wc-google-address"}static get observedAttributes(){return["name","id","class","value","placeholder","lbl-label","lbl-class","elt-class","disabled","readonly","required","autocomplete","api-key","address-group","target-map","countries","types","fields","onchange","oninput","onblur","onfocus","tooltip","tooltip-position"]}static isGooglePlacesLoaded=!1;static googlePlacesLoadPromise=null;constructor(){super(),this.passThruAttributes=["name","id","value","placeholder","autocomplete"],this.passThruEmptyAttributes=["disabled","readonly","required"],this.ignoreAttributes=["class","lbl-class","lbl-label","elt-class","api-key","address-group","target-map","countries","types","fields"],this.eventAttributes=["onchange","oninput","onblur","onfocus"];let i=this.querySelector(".wc-google-address");i?this.componentElement=i:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-google-address","relative"),this.appendChild(this.componentElement)),this.autocompleteService=null,this.placesService=null,this.sessionToken=null,this.selectedPlace=null}async connectedCallback(){super.connectedCallback(),this._applyStyle();let i=this.getAttribute("api-key");if(!i){console.error("wc-google-address: api-key attribute is required");return}await this._loadGooglePlacesAPI(i),this._initializeAutocomplete()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents(),this.autocompleteService&&(this.autocompleteService=null),this.placesService&&(this.placesService=null)}async _loadGooglePlacesAPI(i){return window.google?.maps?window.google.maps.places?(d.isGooglePlacesLoaded=!0,Promise.resolve()):(console.warn("wc-google-address: Google Maps API is loaded but places library is missing. You may need to include libraries=places in the initial load."),Promise.resolve()):d.isGooglePlacesLoaded?Promise.resolve():d.googlePlacesLoadPromise?d.googlePlacesLoadPromise:document.querySelector('script[src*="maps.googleapis.com"]')?(console.log("wc-google-address: Google Maps script already exists, waiting for it to load..."),d.googlePlacesLoadPromise=new Promise(t=>{let o=setInterval(()=>{window.google?.maps&&(clearInterval(o),d.isGooglePlacesLoaded=!0,t())},100)}),d.googlePlacesLoadPromise):(d.googlePlacesLoadPromise=new Promise((t,o)=>{let n=document.createElement("script");n.src=`https://maps.googleapis.com/maps/api/js?key=${i}&libraries=places,marker&v=weekly`,n.async=!0,n.defer=!0,n.onload=()=>{d.isGooglePlacesLoaded=!0,console.log("\u2705 Google Places API loaded successfully"),t()},n.onerror=()=>{let s=new Error("Failed to load Google Places API");console.error("\u274C",s),o(s)},document.head.appendChild(n)}),d.googlePlacesLoadPromise)}_initializeAutocomplete(){if(!window.google?.maps?.places){console.error("wc-google-address: Google Places API not loaded");return}this.sessionToken=new google.maps.places.AutocompleteSessionToken,this.autocompleteService=new google.maps.places.AutocompleteService;let i=document.createElement("div");this.placesService=new google.maps.places.PlacesService(i),this._wireAutocompleteEvents()}_wireAutocompleteEvents(){if(!this.formElement)return;let i=this.querySelector(".address-suggestions");i||(i=document.createElement("div"),i.classList.add("address-suggestions"),this.componentElement.appendChild(i));let e,o=((n,s)=>(...a)=>{clearTimeout(e),e=setTimeout(()=>n.apply(this,a),s)})(n=>{let s=n.target.value.trim();if(console.log(`\u{1F50D} wc-google-address: Input value="${s}", length=${s.length}`),s.length<3){this._hideSuggestions(i);return}console.log(`\u{1F4E1} wc-google-address: Fetching suggestions for "${s}"`),this._fetchSuggestions(s,i)},300);this.formElement.addEventListener("input",o),console.log("\u2705 wc-google-address: Input event listener attached to",this.formElement),this.formElement.addEventListener("keydown",n=>{let s=i.querySelectorAll(".address-suggestion-item");if(s.length===0)return;let a=Array.from(s).findIndex(r=>r.classList.contains("highlighted"));switch(n.key){case"ArrowDown":n.preventDefault();let r=a<s.length-1?a+1:0;this._highlightSuggestion(s,r);break;case"ArrowUp":n.preventDefault();let l=a>0?a-1:s.length-1;this._highlightSuggestion(s,l);break;case"Enter":if(a>=0){n.preventDefault();let c=s[a].dataset.placeId;console.log(`\u2328\uFE0F wc-google-address: Enter key pressed on suggestion index ${a}, placeId=${c}`),this._selectPlace(c),this._hideSuggestions(i)}break;case"Escape":n.preventDefault(),this._hideSuggestions(i);break}}),document.addEventListener("click",n=>{this.contains(n.target)||this._hideSuggestions(i)}),this.formElement.addEventListener("blur",()=>{setTimeout(()=>{this.querySelector(".address-suggestions:hover")||this._hideSuggestions(i)},200)})}_fetchSuggestions(i,e){if(!this.autocompleteService){console.error("\u274C wc-google-address: autocompleteService not initialized!");return}let t={input:i,sessionToken:this.sessionToken},o=this.getAttribute("countries");o&&(t.componentRestrictions={country:o.split(",").map(s=>s.trim())});let n=this.getAttribute("types");n&&(t.types=n.split(",").map(s=>s.trim())),console.log("\u{1F4E4} wc-google-address: Sending request to Google Places API:",t),this.autocompleteService.getPlacePredictions(t,(s,a)=>{if(console.log(`\u{1F4E5} wc-google-address: Received response - status=${a}, predictions=`,s),a!==google.maps.places.PlacesServiceStatus.OK||!s){console.warn(`\u26A0\uFE0F wc-google-address: No predictions (status=${a})`),this._hideSuggestions(e);return}console.log(`\u2705 wc-google-address: Displaying ${s.length} suggestions`),this._displaySuggestions(s,e)})}_displaySuggestions(i,e){e.innerHTML="",e.classList.remove("hidden"),i.forEach(t=>{let o=document.createElement("div");o.classList.add("address-suggestion-item"),o.textContent=t.description,o.dataset.placeId=t.place_id,o.addEventListener("mousedown",n=>{n.preventDefault(),n.stopPropagation(),console.log(`\u{1F446} wc-google-address: Mousedown on suggestion: ${t.description}, placeId=${t.place_id}`),this._selectPlace(t.place_id),this._hideSuggestions(e)}),e.appendChild(o)})}_hideSuggestions(i){i.classList.add("hidden"),i.innerHTML=""}_highlightSuggestion(i,e){i.forEach(t=>t.classList.remove("highlighted")),i[e]&&(i[e].classList.add("highlighted"),i[e].scrollIntoView({block:"nearest",behavior:"smooth"}))}_selectPlace(i){if(console.log(`\u{1F50D} wc-google-address: _selectPlace called with placeId=${i}`),!this.placesService){console.error("\u274C wc-google-address: placesService not initialized!");return}let e=this.getAttribute("fields")||"address_components,formatted_address,geometry,name";console.log(`\u{1F4CB} wc-google-address: Requesting fields: ${e}`);let t={placeId:i,fields:e.split(",").map(o=>o.trim()),sessionToken:this.sessionToken};console.log("\u{1F4E4} wc-google-address: Fetching place details..."),this.placesService.getDetails(t,(o,n)=>{if(console.log(`\u{1F4E5} wc-google-address: getDetails response - status=${n}`,o),n!==google.maps.places.PlacesServiceStatus.OK||!o){console.error("\u274C wc-google-address: Failed to get place details",n);return}this.sessionToken=new google.maps.places.AutocompleteSessionToken,console.log("\u2705 wc-google-address: Processing place result..."),this._processPlaceResult(o)})}_processPlaceResult(i){let e=this._parseAddressComponents(i);this.formElement&&(this.formElement.value=e.street),this.selectedPlace=e,this._broadcastAddressChange(e);let t=this.getAttribute("target-map");t&&this._updateMap(t,e),this.formElement&&this.formElement.dispatchEvent(new Event("change",{bubbles:!0}))}_parseAddressComponents(i){let e=i.address_components||[],t=i.geometry?.location,o={addressGroup:this.getAttribute("address-group")||"address",street:"",apt_suite:"",city:"",state:"",postal_code:"",county:"",country:"",lat:t?t.lat():null,lng:t?t.lng():null,formatted_address:i.formatted_address||"",place_id:i.place_id||""},n="",s="";return e.forEach(a=>{let r=a.types;r.includes("street_number")&&(n=a.long_name),r.includes("route")&&(s=a.long_name),r.includes("locality")&&(o.city=a.long_name),r.includes("administrative_area_level_1")&&(o.state=a.short_name),r.includes("administrative_area_level_2")&&(o.county=a.long_name),r.includes("postal_code")&&(o.postal_code=a.long_name),r.includes("country")&&(o.country=a.short_name)}),o.street=[n,s].filter(Boolean).join(" "),o}_broadcastAddressChange(i){let e="google-address:change";console.log(`\u{1F4CD} wc-google-address: Broadcasting ${e} with data:`,i);let t=new CustomEvent(e,{detail:i,bubbles:!0,composed:!0});document.dispatchEvent(t),window.wc?.EventHub&&(wc.EventHub.broadcast(e,[],i),console.log("\u{1F4E1} wc-google-address: Also broadcast via EventHub"))}_updateMap(i,e){if(!e.lat||!e.lng)return;let t=document.getElementById(i);if(!t||t.tagName.toLowerCase()!=="wc-google-map"){console.warn(`wc-google-address: Map element with id "${i}" not found`);return}t.setAttribute("lat",e.lat),t.setAttribute("lng",e.lng),t.setAttribute("address",e.formatted_address)}_handleAttributeChange(i,e){if(this.eventAttributes.includes(i)){if(this.formElement&&e){let t=new Function("event",`
          const element = event.target;
          const value = element.value;
          with (element) {
            ${e}
          }
        `),o=i.substring(2);this.formElement.addEventListener(o,t)}return}if(this.passThruAttributes.includes(i)&&this.formElement?.setAttribute(i,e),this.passThruEmptyAttributes.includes(i)&&this.formElement?.setAttribute(i,""),this.ignoreAttributes.includes(i),i==="tooltip"||i==="tooltip-position"){this._createTooltipElement();return}if(i==="lbl-class"){let t=this.getAttribute("name");this.querySelector(`label[for="${t}"]`)?.classList.add(e)}i==="elt-class"&&e.split(" ").forEach(o=>{o&&this.formElement?.classList.add(o.trim())}),i==="api-key"&&this._loadGooglePlacesAPI(e).then(()=>{this._initializeAutocomplete()})}_render(){let i=this.getAttribute("name")||"address",e=this.getAttribute("lbl-label")||"",t=this.getAttribute("placeholder")||"Start typing an address...",o=this.getAttribute("value")||"";if(this.componentElement.innerHTML="",e){let s=document.createElement("label");s.setAttribute("for",i),s.textContent=e,this.componentElement.appendChild(s)}this.formElement=document.createElement("input"),this.formElement.setAttribute("type","text"),this.formElement.setAttribute("name",i),this.formElement.setAttribute("id",i),this.formElement.setAttribute("class","form-control"),this.formElement.setAttribute("placeholder",t),this.formElement.setAttribute("autocomplete","off"),o&&(this.formElement.value=o),this.componentElement.appendChild(this.formElement);let n=document.createElement("span");n.classList.add("icon"),n.innerHTML=`
    ...
    `.trim(),this.componentElement.appendChild(n),this.labelElement=this.componentElement.querySelector("label")}_applyStyle(){let i=`
      wc-google-address {
        display: block;
      }
