function We(a){return a.tagName.includes("-")}function Ae(){return"xxxx-xxxx-xxxx-xxxx".replace(/[x]/g,()=>(Math.random()*16|0).toString(16))}function k(a){return new Promise((n,e)=>{if(document.querySelector(`link[rel="stylesheet"][href="${a}"]`)){n();return}let t=document.createElement("link");t.rel="stylesheet",t.href=a,t.onload=()=>n(),t.onerror=i=>e(i),document.head.appendChild(t);let o=setInterval(()=>{getComputedStyle(document.body).getPropertyValue("display")&&(clearInterval(o),n())},50)})}function S(a){return new Promise((n,e)=>{if(document.querySelector(`script[src="${a}"]`)){n();return}let t=document.createElement("script");t.src=a,t.onload=n,t.onerror=e,document.head.appendChild(t)})}function _(a,n){return new Promise((e,t)=>{if(document.querySelector(`script[src="${a}"]`)){if(n&&window[n])e();else{let i=setInterval(()=>{window[n]&&(clearInterval(i),e())},50)}return}let o=document.createElement("script");o.src=a,o.onload=()=>{if(n&&!window[n]){let i=setInterval(()=>{window[n]&&(clearInterval(i),e())},50)}else e()},o.onerror=i=>{t(i)},document.head.appendChild(o)})}function A(a,n){return new Promise((e,t)=>{if(document.querySelector(`style#${a}`)){e();return}let o=document.createElement("style");o.id=a,o.textContent=n.trim(),o.onload=e,o.onerror=t,document.head.appendChild(o)})}function Be(a){return new Promise((n,e)=>{if(document.querySelector(`link[href="${a}"]`)){n();return}let t=document.createElement("link");t.rel="stylesheet",t.href=a,t.onload=n,t.onerror=e,document.head.appendChild(t)})}function He(a,n){if(a.matches&&a.matches(n))return a;let e=a.querySelector(n);if(e)return e;let t=a.querySelectorAll("*");for(let o of t)if(o.shadowRoot){let i=this.locator(o.shadowRoot,n);if(i)return i}}function je(a,n){let e=[];a.matches&&a.matches(n)&&e.push(a),e.push(...a.querySelectorAll(n));let t=a.querySelectorAll("*");for(let o of t)o.shadowRoot&&e.push(...this.locatorAll(o.shadowRoot,n));return e}function Pe(a,n=3e3,e=100){return new Promise((t,o)=>{let i=Date.now(),s=()=>{let r=document.querySelector(a);r&&r.offsetParent!==null?t(r):Date.now()-i>n?o(new Error(`Timeout: Selector "${a}" not found or not visible after ${n}ms`)):setTimeout(s,e)};s()})}function $e(a,n){let e=!1;return e=wc.linksLoaded[a]&&wc.scriptsLoaded[n],e}function Re(a=[],n=[],e=5e3,t=100){return new Promise((o,i)=>{let s=Date.now(),r=Array.isArray(a)?a:[a],l=Array.isArray(n)?n:[n],c=()=>{let d=r.length===0||r.every(p=>window.wc?.scriptsLoaded?.[p]===!0),h=l.length===0||l.every(p=>window.wc?.linksLoaded?.[p]===!0);d&&h?o():Date.now()-s>e?i(new Error(`Timeout: Dependencies not available after ${e}ms. Scripts: ${JSON.stringify(r)}, Links: ${JSON.stringify(l)}`)):setTimeout(c,t)};c()})}function Le(a=[],n=3e3){return new Promise((e,t)=>{let o=Date.now(),i=Array.isArray(a)?a:[a],s=()=>{i.every(l=>document.querySelector(l)!==null)?e():Date.now()-o>n?t(new Error(`Timeout: Not all selectors available after ${n}ms. Missing selectors: ${JSON.stringify(i)}`)):requestAnimationFrame(s)};s()})}function Oe(a,n,e=3e3){return new Promise((t,o)=>{let i=Date.now(),s=()=>{a[n]?t():Date.now()-i>e?o(new Error(`Timeout: ${e}ms. Propery: ${n} not available on element.`)):requestAnimationFrame(s)};s()})}async function P(a){return new Promise(n=>setTimeout(n,a))}function Te(a){document.querySelector(a).classList.add("hidden")}function Ie(a){document.querySelector(a).classList.remove("hidden")}function Me(a,n){Te(a),Ie(n)}async function ze(a,n,e=3e3,t=500){await Le([a,n],e),await P(t),Me(a,n)}function Fe(a,n,e){try{fetch(a,{method:"GET"}).then(t=>t.text()).then(t=>{n&&n(t)})}catch(t){e&&e(t)}}function Ne(a){if(a){let n={animation:150,draggable:".preview-draggable",onEnd:function(e){let t={e,event:"onEnd",item:e.item,from:e.from,to:e.to,oldIndex:e.oldIndex,newIndex:e.newIndex};wc?.EventHub?.broadcast("sortable:on-end","","",t)}};if(typeof Sortable<"u"){let e=new Sortable(a,n);wc.EventHub.events[a]=e}}}function Ue(a){wc?.EventHub?.events[a].destroy()}function Je(a,n,e,t){let o=2;n=n-o,e=e-o;let i=t.editor,s=i.getValue(),r=new RegExp(`<wc-form[^>]*id=["']${a}["'][^>]*>([\\s\\S]*?)<\\/wc-form>`),l=s.match(r);if(l){let c=l[1],d=/<div[^>]*class=["'][^"']*preview-draggable[^"']*["'][^>]*>[\s\S]*?<\/div>/g,h=c.match(d)||[];if(h.length===0)return;if(n>=0&&n<h.length&&e>=0&&e<h.length){let b=h.splice(n,1)[0];h.splice(e,0,b)}let p=c.replace(d,()=>h.shift()),u=s.replace(c,p);i.setValue(u)}}function Ge(a){let n=-1;return a&&(n=document.querySelectorAll(a).length),n}function Ye(a,n){let e=document.querySelector(a);e&&(n?e.classList.add("htmx-request"):e.classList.remove("htmx-request"))}function Ke(a,n){let t=a.detail.elt.closest("form"),o=t.querySelector(n);if(console.log("-->Attempting to process JSON for selector: ",n,t),o)try{let r=function(l,c=""){for(let d in l)if(Object.prototype.hasOwnProperty.call(l,d)){let h=l[d],p=c?`${c}.${d}`:d;if(h!==null&&typeof h=="object"&&!Array.isArray(h))r(h,p);else if(Array.isArray(h))h.forEach((u,b)=>{if(typeof u=="object"&&u!==null)r(u,`${p}[${b}]`);else{let g=document.createElement("input");g.type="hidden",g.name=`${p}[${b}]`,g.value=u,g.setAttribute("data-json-field","true"),t.appendChild(g),console.log("-->Appending array primitive:",g)}});else{let u=document.createElement("input");u.type="hidden",u.name=p,u.value=h,u.setAttribute("data-json-field","true"),t.appendChild(u),console.log("-->Appending primitive:",u)}}};t.querySelectorAll('input[data-json-field="true"]').forEach(l=>l.remove());let s=JSON.parse(o.value);console.log("-->JSON contents: ",s),r(s,"json_data"),console.log("-->Processing complete for selector: ",n,t)}catch(i){console.error("Error parsing JSON:",i)}}function qe(a,n){if(a==null)return!1;if("const"in n)return a===n.const;if("enum"in n)return Array.isArray(n.enum)&&n.enum.includes(a);if("minimum"in n){let e=typeof a=="number"?a:parseFloat(a);if(isNaN(e)||e<n.minimum)return!1}if("maximum"in n){let e=typeof a=="number"?a:parseFloat(a);if(isNaN(e)||e>n.maximum)return!1}if("minLength"in n&&String(a).length<n.minLength||"maxLength"in n&&String(a).length>n.maxLength)return!1;if("pattern"in n){let e=new RegExp(n.pattern);if(typeof a!="string"||!e.test(a))return!1}return!0}function De(a,n,e){let t="";if(a?(t=`[data-id="${a}"]`,n&&(t+=` ${n}`)):n&&(t=n),!t)return;let o=document.querySelector(t);if(o)return e&&e in o?o[e]:o.type==="checkbox"?o.checked:o.value}function R(a){let{effect:n,condition:e,tgtDataId:t,tgtSelector:o,tgtProperty:i}=a,{scope:s,schema:r,srcDataId:l,srcSelector:c,srcProperty:d,property:h}=e,p=De(l,c,d);if(p==null)return;let u=!1;r&&(u=qe(p,r));let b="";t?(b=`[data-id="${t}"]`,o&&(b+=` ${o}`)):o&&(b=o);let g=document.querySelector(b);if(g)switch(n){case"COPY":g[i]=p;break;case"COPY-TOLOWER":g[i]=p.toString().toLowerCase();break;case"COPY-TOLOWER-UNDERSCORE":g[i]=p.toString().toLowerCase().replaceAll(" ","_");break;case"HIDE":g.style.display=u?"none":"";break;case"SHOW":g.style.display=u?"":"none";break;case"DISABLE":g.disabled=u;break;case"ENABLE":g.disabled=!u;break;case"REQUIRE":g.required=!u;break;case"UN-REQUIRE":g.required=u;break;default:console.warn("Unknown rule effect:",n)}}function Ze(a){Array.from(new Set(a.map(e=>e.condition.srcDataId))).forEach(e=>{document.querySelectorAll(`[data-id="${e}"]`).forEach(t=>{let o=Array.from(a).filter(i=>i.condition.srcDataId==e);t.addEventListener("change",()=>{o.forEach(R)}),t.addEventListener("input",()=>{o.forEach(R)})})}),a.forEach(R)}function Ve(a){let n=[];function e(t){!t||typeof t!="object"||(t.rules&&n.push(...t.rules),Array.isArray(t.elements)&&t.elements.forEach(e))}return a.forEach(e),n}function Xe(a){let n=[];function e(t){let o=t.label||"",i=t.scope||"",s=i?`${o} (${i})`:o,r={dataId:t["data-id"],label:s};n.push(r),t.elements&&Array.isArray(t.elements)&&t.elements.forEach(l=>e(l))}return a.forEach(t=>e(t)),n}var m=class extends HTMLElement{constructor(){super(),this._wcId=Ae(),this.loadCSS=k.bind(this),this.loadScript=S.bind(this),this.loadLibrary=_.bind(this),this.loadStyle=A.bind(this),this.childComponent=null,this.childComponentSelector="",this._pendingAttributes={},this._isConnected=!1,this.componentElement=null,this.formElement=null}get wcId(){return this._wcId}connectedCallback(){this.childComponentSelector?(console.log("connectedCallback:waiting for ",this.childComponentSelector," to be loaded..."),this._waitForChildren(this.childComponentSelector).then(()=>{this._connectedCallback()})):this._connectedCallback()}_connectedCallback(){this._render(),this.dataset.wcId=this.wcId,this.childComponentName?this._waitForChild(()=>this[this.childComponentName]).then(()=>{this._isConnected=!0,this._applyPendingAttributes()}):(this._isConnected=!0,this._applyPendingAttributes())}disconnectedCallback(){}attributeChangedCallback(n,e,t){this._isConnected?this._handleAttributeChange(n,t,e):this._pendingAttributes[n]=t}_applyPendingAttributes(){Object.keys(this._pendingAttributes).forEach(n=>{let e=this._pendingAttributes[n];this._handleAttributeChange(n,e,null)}),this._pendingAttributes={}}_handleAttributeChange(n,e,t){if(n==="name")this._handleNameToIdLinkage(e);else if(n==="elt-class"){let o=this.querySelector("[form-element]");o&&o.setAttribute("class",e)}else n==="class"?e&&e.replace("contents","").split(" ").forEach(s=>{s&&(this.componentElement.classList.add(s),this.classList.remove(s))}):this.componentElement.setAttribute(n,e)}_handleNameToIdLinkage(n){n&&this.formElement&&!this.formElement.hasAttribute("id")&&(this.formElement.setAttribute("id",n),this.formElement.setAttribute("name",n),this.removeAttribute("name"))}_render(){this.classList.add("contents"),console.log("wc-base-component:_render")}async _waitForChild(n){return new Promise(e=>{let t=setInterval(()=>{n()&&(clearInterval(t),e())},50)})}async _waitForChildren(n){let e=Array.from(this.querySelectorAll(n));await Promise.all(e.map(t=>new Promise(o=>{t.isConnected?o():t.addEventListener("connected",o,{once:!0})})))}_applyStyle(){}_wireEvents(){}_unWireEvents(){}};var q=class extends m{static formAssociated=!0;constructor(){super(),this._internals=this.attachInternals(),this._value=""}get value(){return this._isCheckbox()?this.checked:this._value}set value(n){this._isCheckbox()?this.checked=n:(this._value=n,this._internals.setFormValue(this._value))}get required(){return this.hasAttribute("required")}set required(n){n?this.setAttribute("required",""):this.removeAttribute("required")}get checked(){return this.formElement?.checked||!1}set checked(n){this._isCheckbox()&&(this.formElement.checked=n,this._internals.setFormValue(n?"bool:True":"bool:False"))}get validity(){return this._internals.validity}get validationMessage(){return this._internals.validationMessage}get willValidate(){return this._internals.willValidate}checkValidity(){return this._internals.checkValidity()}reportValidity(){return this._internals.reportValidity()}_handleValidation(){let n="";if(n==="span")if(this.formElement?.validity.valid)this.componentElement.querySelector(".error-message")?.remove();else{let e=document.createElement("span");e.classList.add("error-message"),e.textContent=this.formElement?.validationMessage,this.componentElement.appendChild(e)}else if(n==="tooltip")if(this.formElement?.validity.valid)this.formElement?.removeAttribute("data-error"),this.formElement?.setAttribute("title",this.formElement?.getAttribute("data-has-title")),this.formElement?.removeAttribute("data-has-title");else{let e=this.formElement?.validationMessage;this.formElement?.setAttribute("data-error",e),this.formElement?.setAttribute("data-has-title",this.formElement?.getAttribute("title")||""),this.formElement?.setAttribute("title","")}this._internals.setValidity(this.formElement?.validity,this.formElement?.validationMessage)}connectedCallback(){super.connectedCallback(),this.formElement=this.querySelector("input, select, textarea"),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(n,e){n==="value"?this._isCheckbox()?this.checked=e!==null&&e!=="false"&&e!=="bool:False":(this.formElement&&(this.formElement?.setAttribute("value",e),"value"in this.formElement&&(this.formElement.value=e)),this.value=e):super._handleAttributeChange(n,e)}_handleInputChange(n){let{target:e}=n;if(this._isCheckbox()?(e.checked?this.formElement.value="bool:True":this.formElement.value="bool:False",this.checked=e.checked):this.value=e.value,this._isRange()){let t=this.querySelector("label"),o=this.getAttribute("lbl-label")||"";t&&o&&(t.textContent=`${o} (${e.value})`)}this._handleValidation()}_isCheckbox(){return this.formElement?.type==="checkbox"}_isRange(){return this.formElement?.type==="range"}_wireEvents(){super._wireEvents(),this.formElement&&(this.formElement.addEventListener("input",this._handleInputChange.bind(this)),this.formElement.addEventListener("change",this._handleInputChange.bind(this)))}_unWireEvents(){super._unWireEvents(),this.formElement&&(this.formElement.removeEventListener("input",this._handleInputChange.bind(this)),this.formElement.removeEventListener("change",this._handleInputChange.bind(this)))}};var O=class extends m{static get observedAttributes(){return["id","class","items","allow-many"]}constructor(){super(),this._items=[];let n=this.querySelector(".wc-accordion");n?this.componentElement=n:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-accordion"),this.appendChild(this.componentElement)),console.log("ctor:wc-accordion")}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents(),console.log("connectedCallback:wc-accordion")}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(n,e){n==="items"?(typeof e=="string"&&(this._items=JSON.parse(e)),this.removeAttribute("items")):n==="allow-many"||super._handleAttributeChange(n,e)}_render(){super._render();let n=this.querySelectorAll(".wc-accordion > *");n.length>0?(this.componentElement.innerHTML="",n.forEach(e=>this.componentElement.appendChild(e))):(this._moveDeclarativeOptions(),this.componentElement.innerHTML="",this._items.forEach(e=>{let t=this._createHeader(e.label,e.selected);this.componentElement.appendChild(t);let o=this._createPanel(e.content);this.componentElement.appendChild(o)})),this._setActive(),typeof htmx<"u"&&htmx.process(this),console.log("_render:wc-accordion")}_createHeader(n,e){let t=this.hasAttribute("allow-many"),o=document.createElement("button");return o.classList.add("accordion-header"),t?o.setAttribute("_",`on click
      ...
      `),e&&o.classList.add("active"),o.textContent=n,o}_createPanel(n){let e=document.createElement("div");e.classList.add("accordion-panel");let t=document.createElement("p");return t.innerHTML=n,e.appendChild(t),e}_moveDeclarativeOptions(){let n=this.querySelectorAll("option");n.length>0&&(this._items=[]),n.forEach(e=>{let t={label:e.value,content:e.innerHTML.trim(),selected:e.hasAttribute("selected")||!1};this._items.push(t)}),Array.from(n).forEach(e=>e.remove())}_setActive(){setTimeout(()=>{this.querySelectorAll(".wc-accordion .accordion-header.active").forEach(e=>{let t=e.nextElementSibling;t.style.maxHeight=t.scrollHeight+"px"})},50)}_applyStyle(){let n=`
      wc-accordion {
        display: contents;
      }
