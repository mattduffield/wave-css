function Ie(a){return a.tagName.includes("-")}function Ce(){return"xxxx-xxxx-xxxx-xxxx".replace(/[x]/g,()=>(Math.random()*16|0).toString(16))}function k(a){return new Promise((o,e)=>{if(document.querySelector(`link[rel="stylesheet"][href="${a}"]`)){o();return}let t=document.createElement("link");t.rel="stylesheet",t.href=a,t.onload=()=>o(),t.onerror=i=>e(i),document.head.appendChild(t);let n=setInterval(()=>{getComputedStyle(document.body).getPropertyValue("display")&&(clearInterval(n),o())},50)})}function _(a){return new Promise((o,e)=>{if(document.querySelector(`script[src="${a}"]`)){o();return}let t=document.createElement("script");t.src=a,t.onload=o,t.onerror=e,document.head.appendChild(t)})}function S(a,o){return new Promise((e,t)=>{if(document.querySelector(`script[src="${a}"]`)){if(o&&window[o])e();else{let i=setInterval(()=>{window[o]&&(clearInterval(i),e())},50)}return}let n=document.createElement("script");n.src=a,n.onload=()=>{if(o&&!window[o]){let i=setInterval(()=>{window[o]&&(clearInterval(i),e())},50)}else e()},n.onerror=i=>{t(i)},document.head.appendChild(n)})}function A(a,o){return new Promise((e,t)=>{if(document.querySelector(`style#${a}`)){e();return}let n=document.createElement("style");n.id=a,n.textContent=o.trim(),n.onload=e,n.onerror=t,document.head.appendChild(n)})}function Me(a){return new Promise((o,e)=>{if(document.querySelector(`link[href="${a}"]`)){o();return}let t=document.createElement("link");t.rel="stylesheet",t.href=a,t.onload=o,t.onerror=e,document.head.appendChild(t)})}function qe(a,o){if(a.matches&&a.matches(o))return a;let e=a.querySelector(o);if(e)return e;let t=a.querySelectorAll("*");for(let n of t)if(n.shadowRoot){let i=this.locator(n.shadowRoot,o);if(i)return i}}function De(a,o){let e=[];a.matches&&a.matches(o)&&e.push(a),e.push(...a.querySelectorAll(o));let t=a.querySelectorAll("*");for(let n of t)n.shadowRoot&&e.push(...this.locatorAll(n.shadowRoot,o));return e}function We(a,o=3e3,e=100){return new Promise((t,n)=>{let i=Date.now(),s=()=>{let l=document.querySelector(a);l&&l.offsetParent!==null?t(l):Date.now()-i>o?n(new Error(`Timeout: Selector "${a}" not found or not visible after ${o}ms`)):setTimeout(s,e)};s()})}function He(a,o){let e=!1;return e=wc.linksLoaded[a]&&wc.scriptsLoaded[o],e}function Be(a=[],o=[],e=5e3,t=100){return new Promise((n,i)=>{let s=Date.now(),l=Array.isArray(a)?a:[a],r=Array.isArray(o)?o:[o],c=()=>{let d=l.length===0||l.every(p=>window.wc?.scriptsLoaded?.[p]===!0),u=r.length===0||r.every(p=>window.wc?.linksLoaded?.[p]===!0);d&&u?n():Date.now()-s>e?i(new Error(`Timeout: Dependencies not available after ${e}ms. Scripts: ${JSON.stringify(l)}, Links: ${JSON.stringify(r)}`)):setTimeout(c,t)};c()})}function ke(a=[],o=3e3){return new Promise((e,t)=>{let n=Date.now(),i=Array.isArray(a)?a:[a],s=()=>{i.every(r=>document.querySelector(r)!==null)?e():Date.now()-n>o?t(new Error(`Timeout: Not all selectors available after ${o}ms. Missing selectors: ${JSON.stringify(i)}`)):requestAnimationFrame(s)};s()})}function je(a,o,e=3e3){return new Promise((t,n)=>{let i=Date.now(),s=()=>{a[o]?t():Date.now()-i>e?n(new Error(`Timeout: ${e}ms. Propery: ${o} not available on element.`)):requestAnimationFrame(s)};s()})}async function P(a){return new Promise(o=>setTimeout(o,a))}function _e(a){document.querySelector(a).classList.add("hidden")}function Se(a){document.querySelector(a).classList.remove("hidden")}function Ae(a,o){_e(a),Se(o)}async function Pe(a,o,e=3e3,t=500){await ke([a,o],e),await P(t),Ae(a,o)}function Re(a,o,e){try{fetch(a,{method:"GET"}).then(t=>t.text()).then(t=>{o&&o(t)})}catch(t){e&&e(t)}}function $e(a){if(a){let o={animation:150,draggable:".preview-draggable",onEnd:function(e){let t={e,event:"onEnd",item:e.item,from:e.from,to:e.to,oldIndex:e.oldIndex,newIndex:e.newIndex};wc?.EventHub?.broadcast("sortable:on-end","","",t)}};if(typeof Sortable<"u"){let e=new Sortable(a,o);wc.EventHub.events[a]=e}}}function Oe(a){wc?.EventHub?.events[a].destroy()}function ze(a,o,e,t){let n=2;o=o-n,e=e-n;let i=t.editor,s=i.getValue(),l=new RegExp(`<wc-form[^>]*id=["']${a}["'][^>]*>([\\s\\S]*?)<\\/wc-form>`),r=s.match(l);if(r){let c=r[1],d=/<div[^>]*class=["'][^"']*preview-draggable[^"']*["'][^>]*>[\s\S]*?<\/div>/g,u=c.match(d)||[];if(u.length===0)return;if(o>=0&&o<u.length&&e>=0&&e<u.length){let b=u.splice(o,1)[0];u.splice(e,0,b)}let p=c.replace(d,()=>u.shift()),h=s.replace(c,p);i.setValue(h)}}function Fe(a){let o=-1;return a&&(o=document.querySelectorAll(a).length),o}function Ne(a,o){let e=document.querySelector(a);e&&(o?e.classList.add("htmx-request"):e.classList.remove("htmx-request"))}function Ue(a,o){let t=a.detail.elt.closest("form"),n=t.querySelector(o);if(console.log("-->Attempting to process JSON for selector: ",o,t),n)try{let l=function(r,c=""){for(let d in r)if(Object.prototype.hasOwnProperty.call(r,d)){let u=r[d],p=c?`${c}.${d}`:d;if(u!==null&&typeof u=="object"&&!Array.isArray(u))l(u,p);else if(Array.isArray(u))u.forEach((h,b)=>{if(typeof h=="object"&&h!==null)l(h,`${p}[${b}]`);else{let g=document.createElement("input");g.type="hidden",g.name=`${p}[${b}]`,g.value=h,g.setAttribute("data-json-field","true"),t.appendChild(g),console.log("-->Appending array primitive:",g)}});else{let h=document.createElement("input");h.type="hidden",h.name=p,h.value=u,h.setAttribute("data-json-field","true"),t.appendChild(h),console.log("-->Appending primitive:",h)}}};t.querySelectorAll('input[data-json-field="true"]').forEach(r=>r.remove());let s=JSON.parse(n.value);console.log("-->JSON contents: ",s),l(s,"json_data"),console.log("-->Processing complete for selector: ",o,t)}catch(i){console.error("Error parsing JSON:",i)}}function Le(a,o){if(a==null)return!1;if("const"in o)return a===o.const;if("enum"in o)return Array.isArray(o.enum)&&o.enum.includes(a);if("minimum"in o){let e=typeof a=="number"?a:parseFloat(a);if(isNaN(e)||e<o.minimum)return!1}if("maximum"in o){let e=typeof a=="number"?a:parseFloat(a);if(isNaN(e)||e>o.maximum)return!1}if("minLength"in o&&String(a).length<o.minLength||"maxLength"in o&&String(a).length>o.maxLength)return!1;if("pattern"in o){let e=new RegExp(o.pattern);if(typeof a!="string"||!e.test(a))return!1}return!0}function Te(a,o,e){let t="";if(a?(t=`[data-id="${a}"]`,o&&(t+=` ${o}`)):o&&(t=o),!t)return;let n=document.querySelector(t);if(n)return e&&e in n?n[e]:n.type==="checkbox"?n.checked:n.value}function $(a){let{effect:o,condition:e,tgtDataId:t,tgtSelector:n,tgtProperty:i}=a,{scope:s,schema:l,srcDataId:r,srcSelector:c,srcProperty:d,property:u}=e,p=Te(r,c,d);if(p==null)return;let h=!1;l&&(h=Le(p,l));let b="";t?(b=`[data-id="${t}"]`,n&&(b+=` ${n}`)):n&&(b=n);let g=document.querySelector(b);if(g)switch(o){case"COPY":g[i]=p;break;case"COPY-TOLOWER":g[i]=p.toString().toLowerCase();break;case"COPY-TOLOWER-UNDERSCORE":g[i]=p.toString().toLowerCase().replaceAll(" ","_");break;case"HIDE":g.style.display=h?"none":"";break;case"SHOW":g.style.display=h?"":"none";break;case"DISABLE":g.disabled=h;break;case"ENABLE":g.disabled=!h;break;case"REQUIRE":g.required=!h;break;case"UN-REQUIRE":g.required=h;break;default:console.warn("Unknown rule effect:",o)}}function Je(a){Array.from(new Set(a.map(e=>e.condition.srcDataId))).forEach(e=>{document.querySelectorAll(`[data-id="${e}"]`).forEach(t=>{let n=Array.from(a).filter(i=>i.condition.srcDataId==e);t.addEventListener("change",()=>{n.forEach($)}),t.addEventListener("input",()=>{n.forEach($)})})}),a.forEach($)}function Ge(a){let o=[];function e(t){!t||typeof t!="object"||(t.rules&&o.push(...t.rules),Array.isArray(t.elements)&&t.elements.forEach(e))}return a.forEach(e),o}function Ve(a){let o=[];function e(t){let n=t.label||"",i=t.scope||"",s=i?`${n} (${i})`:n,l={dataId:t["data-id"],label:s};o.push(l),t.elements&&Array.isArray(t.elements)&&t.elements.forEach(r=>e(r))}return a.forEach(t=>e(t)),o}var m=class extends HTMLElement{constructor(){super(),this._wcId=Ce(),this.loadCSS=k.bind(this),this.loadScript=_.bind(this),this.loadLibrary=S.bind(this),this.loadStyle=A.bind(this),this.childComponent=null,this.childComponentSelector="",this._pendingAttributes={},this._isConnected=!1,this.componentElement=null,this.formElement=null}get wcId(){return this._wcId}connectedCallback(){this.childComponentSelector?(console.log("connectedCallback:waiting for ",this.childComponentSelector," to be loaded..."),this._waitForChildren(this.childComponentSelector).then(()=>{this._connectedCallback()})):this._connectedCallback()}_connectedCallback(){this._render(),this.dataset.wcId=this.wcId,this.childComponentName?this._waitForChild(()=>this[this.childComponentName]).then(()=>{this._isConnected=!0,this._applyPendingAttributes()}):(this._isConnected=!0,this._applyPendingAttributes())}disconnectedCallback(){}attributeChangedCallback(o,e,t){this._isConnected?this._handleAttributeChange(o,t,e):this._pendingAttributes[o]=t}_applyPendingAttributes(){Object.keys(this._pendingAttributes).forEach(o=>{let e=this._pendingAttributes[o];this._handleAttributeChange(o,e,null)}),this._pendingAttributes={}}_handleAttributeChange(o,e,t){if(o==="name")this._handleNameToIdLinkage(e);else if(o==="elt-class"){let n=this.querySelector("[form-element]");n&&n.setAttribute("class",e)}else o==="class"?e&&e.replace("contents","").split(" ").forEach(s=>{s&&(this.componentElement.classList.add(s),this.classList.remove(s))}):this.componentElement.setAttribute(o,e)}_handleNameToIdLinkage(o){o&&this.formElement&&!this.formElement.hasAttribute("id")&&(this.formElement.setAttribute("id",o),this.formElement.setAttribute("name",o),this.removeAttribute("name"))}_render(){this.classList.add("contents"),console.log("wc-base-component:_render")}async _waitForChild(o){return new Promise(e=>{let t=setInterval(()=>{o()&&(clearInterval(t),e())},50)})}async _waitForChildren(o){let e=Array.from(this.querySelectorAll(o));await Promise.all(e.map(t=>new Promise(n=>{t.isConnected?n():t.addEventListener("connected",n,{once:!0})})))}_applyStyle(){}_wireEvents(){}_unWireEvents(){}};var q=class extends m{static formAssociated=!0;constructor(){super(),this._internals=this.attachInternals(),this._value=""}get value(){return this._isCheckbox()?this.checked:this._value}set value(o){this._isCheckbox()?this.checked=o:(this._value=o,this._internals.setFormValue(this._value))}get required(){return this.hasAttribute("required")}set required(o){o?this.setAttribute("required",""):this.removeAttribute("required")}get checked(){return this.formElement?.checked||!1}set checked(o){this._isCheckbox()&&(this.formElement.checked=o,this._internals.setFormValue(o?"bool:True":"bool:False"))}get validity(){return this._internals.validity}get validationMessage(){return this._internals.validationMessage}get willValidate(){return this._internals.willValidate}checkValidity(){return this._internals.checkValidity()}reportValidity(){return this._internals.reportValidity()}_handleValidation(){let o="";if(o==="span")if(this.formElement?.validity.valid)this.componentElement.querySelector(".error-message")?.remove();else{let e=document.createElement("span");e.classList.add("error-message"),e.textContent=this.formElement?.validationMessage,this.componentElement.appendChild(e)}else if(o==="tooltip")if(this.formElement?.validity.valid)this.formElement?.removeAttribute("data-error"),this.formElement?.setAttribute("title",this.formElement?.getAttribute("data-has-title")),this.formElement?.removeAttribute("data-has-title");else{let e=this.formElement?.validationMessage;this.formElement?.setAttribute("data-error",e),this.formElement?.setAttribute("data-has-title",this.formElement?.getAttribute("title")||""),this.formElement?.setAttribute("title","")}this._internals.setValidity(this.formElement?.validity,this.formElement?.validationMessage)}connectedCallback(){super.connectedCallback(),this.formElement=this.querySelector("input, select, textarea"),this._wireEvents()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(o,e){o==="value"?this._isCheckbox()?this.checked=e!==null&&e!=="false"&&e!=="bool:False":(this.formElement&&(this.formElement?.setAttribute("value",e),"value"in this.formElement&&(this.formElement.value=e)),this.value=e):super._handleAttributeChange(o,e)}_handleInputChange(o){let{target:e}=o;if(this._isCheckbox()?(e.checked?this.formElement.value="bool:True":this.formElement.value="bool:False",this.checked=e.checked):this.value=e.value,this._isRange()){let t=this.querySelector("label"),n=this.getAttribute("lbl-label")||"";t&&n&&(t.textContent=`${n} (${e.value})`)}this._handleValidation()}_isCheckbox(){return this.formElement?.type==="checkbox"}_isRange(){return this.formElement?.type==="range"}_wireEvents(){super._wireEvents(),this.formElement&&(this.formElement.addEventListener("input",this._handleInputChange.bind(this)),this.formElement.addEventListener("change",this._handleInputChange.bind(this)))}_unWireEvents(){super._unWireEvents(),this.formElement&&(this.formElement.removeEventListener("input",this._handleInputChange.bind(this)),this.formElement.removeEventListener("change",this._handleInputChange.bind(this)))}};if(!customElements.get("wc-accordion")){class a extends m{static get observedAttributes(){return["id","class","items","allow-many"]}constructor(){super(),this._items=[];let e=this.querySelector(".wc-accordion");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this.componentElement.classList.add("wc-accordion"),this.appendChild(this.componentElement)),console.log("ctor:wc-accordion")}async connectedCallback(){super.connectedCallback(),this._applyStyle(),this._wireEvents(),console.log("connectedCallback:wc-accordion",this._items)}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"?(typeof t=="string"&&(this._items=JSON.parse(t)),this.removeAttribute("items")):e==="allow-many"||super._handleAttributeChange(e,t)}_render(){super._render();let e=this.querySelectorAll(".wc-accordion > *");e.length>0?(this.componentElement.innerHTML="",e.forEach(t=>this.componentElement.appendChild(t))):(this._moveDeclarativeOptions(),this.componentElement.innerHTML="",this._items.forEach(t=>{let n=this._createHeader(t.label,t.selected);this.componentElement.appendChild(n);let i=this._createPanel(t.content);this.componentElement.appendChild(i)})),this._setActive(),typeof htmx<"u"&&htmx.process(this),console.log("_render:wc-accordion")}_createHeader(e,t){let n=this.hasAttribute("allow-many"),i=document.createElement("button");return i.classList.add("accordion-header"),t&&i.classList.add("accordion-active"),n?i.setAttribute("_",`on click
    ...
    `.trim();this.loadStyle("wc-background-image-style",o)}_unWireEvents(){super._unWireEvents()}};customElements.define("wc-background-image",O);if(!customElements.get("wc-breadcrumb-item")){class a extends m{static get observedAttributes(){return["id","class"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb-item")}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"||super._handleAttributeChange(e,t)}_createElement(){this.componentElement.id="breadcrumb-item",this.componentElement.className="wc-breadcrumb-item flex flex-row px-2 gap-4",this.componentElement.innerHTML=`
      ...
      `.trim()}_unWireEvents(){super._unWireEvents()}}customElements.define("wc-breadcrumb-item",a)}if(!customElements.get("wc-breadcrumb")){class a extends m{static get observedAttributes(){return["id","class","doc-title"]}constructor(){super();let e=this.querySelector(".wc-breadcrumb");e?this.componentElement=e:(this.componentElement=document.createElement("div"),this._createElement(),this.appendChild(this.componentElement)),setTimeout(()=>{let t=[],n=this.getAttribute("doc-title")||"",i=this.querySelectorAll("wc-breadcrumb-item");Array.from(i).forEach(l=>{let r=l.getAttribute("label");r&&t.push(r)});let s=t.join(" > ");s&&(n?document.title=s+" - "+n:document.title=s)},250)}async connectedCallback(){super.connectedCallback(),this._applyStyle()}disconnectedCallback(){super.disconnectedCallback(),this._unWireEvents()}_handleAttributeChange(e,t){e==="items"||super._handleAttributeChange(e,t)}_getBreadcrumbItems(){let e=[{label:"",link:"/v/home"},{label:"Screens",link:"/v/screen_list/list"},{label:"screen",link:""}],t=[],n=this.querySelectorAll("wc-breadcrumb-item");return Array.from(n).forEach(i=>{let s=i.getAttribute("label")||"",l=i.getAttribute("link")||"";t.push({label:s,link:l})}),t}_createElement(){let e=[],t=this._getBreadcrumbItems();t.forEach((i,s)=>{s==0?e.push(`
            <a href="${i.link}"
              hx-get="${i.link}"
              hx-target="#viewport"
              hx-swap="innerHTML transition:true"
