...
@layer wc.classes {
  ...
  .swatch-bg-color-1 { background-color: var(--swatch-1); }
...
@layer wc.external {
  ...
  @keyframes ldio-qjspg5uvdp {
    0% { transform: rotate(0) }
    100% { transform: rotate(360deg) }
  }
  .ldio-qjspg5uvdp div { box-sizing: border-box!important }
  .ldio-qjspg5uvdp > div {
    position: absolute;
    width: 144px;
    height: 144px;
    ...
    animation: ldio-qjspg5uvdp 1s linear infinite;
  }

  .ldio-qjspg5uvdp > div:nth-child(2), .ldio-qjspg5uvdp > div:nth-child(4) {
    width: 108px;
    height: 108px;
    top: 46px;
    left: 46px;
    animation: ldio-qjspg5uvdp 1s linear infinite reverse;
  }
  .ldio-qjspg5uvdp > div:nth-child(2) {
    border-color: transparent var(--secondary-bg-color) transparent var(--secondary-bg-color);
  }
  .ldio-qjspg5uvdp > div:nth-child(3) { border-color: transparent }
  .ldio-qjspg5uvdp > div:nth-child(3) div {
    position: absolute;
    width: 100%;
    height: 100%;
    transform: rotate(45deg);
  }
  .ldio-qjspg5uvdp > div:nth-child(3) div:before, .ldio-qjspg5uvdp > div:nth-child(3) div:after { 
    content: "";
    display: block;
    position: absolute;
    width: 16px;
    ...
    border-radius: 50%;
    box-shadow: 0 128px 0 0 var(--primary-bg-color);
  }
  .ldio-qjspg5uvdp > div:nth-child(3) div:after {
    left: -16px;
    top: 48px;
    box-shadow: 128px 0 0 0 var(--primary-bg-color);
  }

  .ldio-qjspg5uvdp > div:nth-child(4) { border-color: transparent; }
  .ldio-qjspg5uvdp > div:nth-child(4) div {
    position: absolute;
    width: 100%;
    height: 100%;
    transform: rotate(45deg);
  }
  .ldio-qjspg5uvdp > div:nth-child(4) div:before, .ldio-qjspg5uvdp > div:nth-child(4) div:after {
    content: "";
    display: block;
    position: absolute;
    width: 16px;
    ...
    border-radius: 50%;
    box-shadow: 0 92px 0 0 var(--secondary-bg-color);
  }
  .ldio-qjspg5uvdp > div:nth-child(4) div:after {
    left: -16px;
    top: 30px;
    box-shadow: 92px 0 0 0 var(--secondary-bg-color);
  }
  .loadingio-spinner-double-ring-v30pdg208rd {
    width: 200px;
    height: 200px;
  ...
  .ldio-qjspg5uvdp div { box-sizing: content-box; }
}
...
@layer wc.usage {
  ...
  .swatch:nth-of-type(11) { background: var(--swatch-11); }
  .swatch:nth-of-type(12) { background: var(--swatch-12); }
}
...
@layer wc.ui {
  ...
  select:focus {
    outline: transparent;
    border-color: var(--component-focus-border-color);
    border: 1px solid var(--component-focus-border-color);
    box-shadow: 0 0 4px var(--component-focus-ring-color);
  }
  input:disabled,
  textarea:disabled,
  select:disabled {
    background: var(--component-disabled-bg-color);
  ...
  input[type="radio"]:checked {
    ...
    border: 2px solid var(--radio-checked-border);
  }
  ...
  input[type="range"]:focus::-webkit-slider-thumb {
    box-shadow: 0 0 6px var(--component-focus-ring-color);
  }
